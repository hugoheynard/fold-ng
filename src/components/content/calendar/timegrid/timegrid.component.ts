...
import type { FoldCalendarDate, FoldWeekday } from "../core/date";
import { foldToMinutes, type FoldCalendarTime } from "../core/time";
import {
  foldBuildTimeGrid,
  type FoldCalendarBlock,
  type FoldTimeGridColumn,
} from "../core/timegrid";
import type { FoldCalendarBand, FoldCalendarEvent } from "../core/types";
...
@Component({
  ...
  styleUrl: "./timegrid.component.scss",
  hostDirectives: [
    {

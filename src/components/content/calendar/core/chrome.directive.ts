...
import { FoldCalendarEventDirective } from "./event.directive";
import {
  foldFormatDate,
  foldFormatRange,
  foldFormatTime,
...
import { FOLD_CALENDAR_LABELS, type FoldCalendarLabels } from "./labels";
import { foldLocaleWeekInfo } from "./locale";

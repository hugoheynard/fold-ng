            ...
            lead: [
              {
                kind: "text",
                value:
                  "Le scrim d'un dialogue FLOUTE, sur écran étroit seulement.",
              },
            ],
            rest: [
              {
                kind: "text",
                value:
                  "Affaire de proportion, pas de goût : sur une grande fenêtre le dialogue couvre un quart de la surface, et l'assombrissement suffit à dire lequel des deux plans compte. Sur un téléphone il en couvre la quasi-totalité, et les deux centimètres de contenu qui dépassent se lisent comme une page encore atteignable. Le flou tranche : ce qui est derrière est ",
              },
              {
                kind: "strong",
                value: "suspendu",
              ...
              {
                kind: "text",
                value: ", pas seulement plus sombre. ",
              },
              {
                kind: "code",
                value: "@media",
              ...
              {
                kind: "text",
                value: " — le dock d'un dialogue est ",
              },
              {
                kind: "code",
                value: "fixed",
              },
              {
                kind: "text",
                value:
                  ", donc il a la taille de la fenêtre, et un élément ne peut jamais répondre à sa propre requête de conteneur.",
              },
            ],
            breaking: false,
          },
        ...
        items: [
          {
            lead: [
              ...
              {
                kind: "strong",
                value: "Le dialogue centré ne l'était pas.",
              },
              {
                kind: "text",
                value: " ",
              ...
              {
                kind: "text",
                value: " — mais la règle de base du dock porte ",
              },
              {
                kind: "code",
              ...
              {
                kind: "text",
                value: ", pour coller une feuille latérale à son bord, et ",
              },
              {
                kind: "code",
                value: "place-items",
              },
              {
                kind: "text",
                value:
                  " ne la remet pas : elle règle la place de l'élément DANS sa piste, pas celle de la piste dans la grille. Le dialogue restait donc plaqué au bord droit d'un dock pourtant large comme la fenêtre. ",
              },
              {
                kind: "code",
              ...
              {
                kind: "text",
                value: " par-dessus. Et le cas qui le tient lit la ",
              },
              {
                kind: "strong",
                value: "feuille compilée",
              },
              {
                kind: "text",
                value:
                  " : jsdom n'applique aucun style de composant, donc mesurer un rectangle serait passé sur un dialogue décentré.",
              },
            ],
            rest: [],
            breaking: false,
            ...
            rest: [
              {
                kind: "text",
                value:
                  "— la colonne tient des NOMBRES, et deux choses suivent : chiffres tabulaires et alignement à droite. C'est la même chose dite deux fois, d'où un drapeau et non deux propriétés — des chiffres proportionnels alignés à droite ne s'alignent toujours pas sous eux-mêmes, et des chiffres tabulaires en drapeau à gauche perdent leur raison d'être. Une colonne de montants en chiffres proportionnels oblige l'œil à lire chaque ligne au lieu de balayer la colonne — ce qui est la seule raison de mettre des nombres dans un tableau. L'en-tête suit sans qu'on le lui dise ; un ",
              },
              {
                kind: "code",
                value: "align",
              ...
              {
                kind: "text",
                value: " écrit à la main gagne toujours.",
              },
            ],
            breaking: false,
          },
        ...
        items: [
          {
            lead: [
              {
                kind: "code",
                value: "FoldTableColumn.cellClass",
              },
              {
                kind: "text",
                value: " dit enfin où sa classe atterrit",
              },
            ],
            rest: [
              {
              ...
              },
              {
                kind: "text",
                value:
                  " de la table, qui porte l'encapsulation de la TABLE. Les styles de composant du consommateur ne l'atteignent donc jamais — seule une classe globale y fait quelque chose. Pour habiller une cellule depuis sa propre feuille de style, il faut projeter un ",
              },
              {
                kind: "code",
              ...
              },
              {
                kind: "text",
                value:
                  " : ce qu'il rend appartient au consommateur, attribut compris.",
              },
            ],
            breaking: false,
          },
        ...
        items: [
          {
            lead: [
              {
                kind: "code",
                value: "--fold-data-table-detail-padding",
              },
              {
                kind: "text",
                value: " n'avait aucun effet en vue tableau.",
              },
            ],
            rest: [
              {
                kind: "text",
                value: "La règle qui peint la rangée du tiroir portait aussi ",
              },
              {
                kind: "code",
                value: "padding: 0",
              ...
              {
                kind: "text",
                value: ", et comme elle est plus spécifique que ",
              },
              {
                kind: "code",
                value: ".folddt-detail",
              },
              {
                kind: "text",
                value:
                  ", elle gagnait : le tiroir restait plat quoi que l'appelant demande. Le jeton ne fonctionnait qu'en vue carte, là où cette règle ne s'applique pas. Le zéro s'y était mis pour neutraliser le rembourrage de cellule — qui n'existe pas ici : la cellule du tiroir porte ",
              },
              {
                kind: "code",
                value: "folddt-detail",
        ...
        items: [
          {
            lead: [
              {
                kind: "text",
                value: "Les trois surfaces du corps de ",
              },
              {
                kind: "code",
                value: "fold-data-table",
            ...
            rest: [
              ...
              {
                kind: "code",
                value: "--fold-data-table-row-hover-bg",
              },
              {
                kind: "text",
                value: ", ",
              ...
              {
                kind: "code",
                value: "--fold-data-table-detail-bg",
              },
              {
                kind: "text",
                value:
                  ". Elles vont ensemble : une table dessinée sur du papier veut que l'interaction CREUSE une rangée, une table posée sur la page veut qu'elle la LÈVE. Le sens dépend de la façon dont le papier de l'app est étagé, et l'app est seule à le savoir — mieux vaut qu'elle le dise que de la voir batailler contre la cascade depuis l'extérieur. Le défaut de ",
              },
              {
                kind: "code",
                value: "row-bg",
              },
              {
                kind: "text",
                value:
                  " est l'absence de fond : la table prend la couleur de ce sur quoi on l'a posée, ce qui est exactement ce qu'une table dans une carte doit faire.",
              },
            ],
            breaking: false,
          },
            ...
            rest: [
              {
                kind: "text",
                value:
                  "— le rembourrage du tiroir se thème. L'air d'un tiroir appartient à ce qu'on y projette : une fiche clé/valeur en veut, une rangée d'actions n'en veut pas, et seul l'appelant sait ce qu'il a mis dedans.",
              },
            ],
            breaking: false,
          },
            ...
            rest: [
              {
                kind: "text",
                value:
                  "— la ligne posée SERRÉE sous le titre : les faits qui identifient la page (une référence, une famille, un compte), pas de la prose. C'est un autre registre que ",
              },
              {
                kind: "code",
                value: "[description]",
              },
              {
                kind: "text",
                value:
                  ", et c'est toute la raison d'être du créneau : une ligne de faits poussée dans la description se lit avec l'espacement d'un paragraphe — et l'espacement d'un paragraphe est une promesse de paragraphe. Les deux cohabitent : les faits serrés, la prose avec sa propre respiration en dessous.",
              },
            ],
            breaking: false,
          },
            ...
            rest: [
              {
                kind: "text",
                value:
                  "— l'en-tête se ferme sur un filet. Éteint par défaut : sur une page dont le corps est une pile de cartes, le rythme de page sépare déjà, et le filet n'ajouterait que de l'encre. On l'allume quand le corps arrive au ras de l'en-tête — un formulaire, un tableau, des sections sans surface propre — là où l'en-tête se lirait sinon comme la première ligne du contenu.",
              },
            ],
            breaking: false,
          },
        ...
        items: [
          {
            ...
            rest: [
              {
                kind: "code",
                value: "fold-panel-body",
              },
              {
                kind: "text",
                value:
                  " laid its children out as a flex column, where every child may shrink and a child whose ",
              },
              {
                kind: "code",
                value: "overflow",
              ...
              {
                kind: "text",
                value: " has an automatic minimum size of ",
              },
              {
                kind: "strong",
                value: "zero",
              ...
              },
              {
                kind: "text",
                value:
                  " clips its overflow to keep its dividers flush with its rounded corners, so in a full panel it was measured at ",
              },
              {
                kind: "strong",
                value: "2px",
              },
              {
                kind: "text",
                value:
                  " — its two borders — with the destructive action, its heading and its explanation all erased. The box reported barely any overflow, so there was nothing to scroll to either: the panel looked finished and was not. The body is now a single-column grid with ",
              },
              {
                kind: "code",
              ...
              },
              {
                kind: "text",
                value:
                  ": rows are sized by their content and the box overflows, which is what a scrolling column is for. Every child is protected, not only the ones we thought of. ",
              },
              {
                kind: "code",
                value: "fold-danger-zone",
              },
              {
                kind: "text",
                value:
                  " also asks for its content-based minimum back explicitly, so it survives a hand-rolled flex column too.",
              },
            ],
            breaking: false,
          },
        ...
        items: [
          {
            lead: [
              ...
              {
                kind: "text",
                value: " — the scrolling middle of an imperative panel.",
              },
            ],
            rest: [
              {
                kind: "text",
                value: "The chrome renders a ",
              },
              {
                kind: "code",
                value: ".panel-body",
              ...
              },
              {
                kind: "text",
                value:
                  " panel is mounted bare and owns its own header/body/footer. Every consumer therefore had to rediscover the same three rules; in one consuming app, eleven panels out of twenty had copied the block, and the nine that had not were quietly broken. ",
              },
              {
                kind: "code",
                value: "flex: 1 1 auto",
              ...
              {
                kind: "text",
                value: " takes what the header and footer leave, ",
              },
              {
                kind: "code",
              ...
              },
              {
                kind: "text",
                value:
                  " scrolls the rest, and — the one hand-rolled copies miss — ",
              },
              {
                kind: "strong",
                value: "`min-height: 0`",
              ...
              {
                kind: "text",
                value: ". A flex item's default minimum height is ",
              },
              {
                kind: "code",
                value: "min-content",
              },
              {
                kind: "text",
                value:
                  ", so without it a tall child _grows the box_ instead of scrolling, pushing the footer past the panel's bottom edge where ",
              },
              {
                kind: "code",
              ...
              },
              {
                kind: "text",
                value:
                  " clips it away. It also lays its children out in a column with the standard gap.",
              },
            ],
            breaking: false,
          },
        ...
        items: [
          {
            lead: [
              {
                kind: "text",
                value: "A component panel's footer is now actually pinned.",
              },
            ],
            rest: [
              {
              ...
              },
              {
                kind: "text",
                value:
                  ' documented that it "stays pinned while the body scrolls" thanks to ',
              },
              {
                kind: "code",
                value: "flex: none",
              },
              {
                kind: "text",
                value:
                  " — true for a template panel, false for a component one. The mounted component's host element was a ",
              },
              {
                kind: "strong",
                value: "single",
              },
              {
                kind: "text",
                value:
                  " flex child of the panel column, so the footer was a grandchild and its ",
              },
              {
                kind: "code",
                value: "flex: none",
              },
              {
                kind: "text",
                value:
                  " applied to nothing: it scrolled away with the body, then ",
              },
              {
                kind: "code",
                value: "overflow: hidden",
              },
              {
                kind: "text",
                value:
                  " clipped it. The panel outlet now mounts the component with ",
              },
              {
                kind: "code",
              ...
              },
              {
                kind: "text",
                value:
                  ", so its header, body and footer become the column's real children and the chrome's layout reaches them as documented. ⚠️ ",
              },
              {
                kind: "strong",
                value: "A box that isn't there paints nothing.",
              },
              {
                kind: "text",
                value: " A panel component that draws on its own ",
              },
              {
                kind: "code",
                value: ":host",
              },
              {
                kind: "text",
                value:
                  " — background, border, padding — must move that onto an element inside its template. Layout-only ",
              },
              {
                kind: "code",
                value: ":host",
              ...
              {
                kind: "text",
                value: " rules (the common case: ",
              },
              {
                kind: "code",
                value: "display: flex; flex-direction: column; height: 100%",
              },
              {
                kind: "text",
                value:
                  ") simply become redundant and can be deleted in favour of ",
              },
              {
                kind: "code",
                value: "fold-panel-body",
          ...
          },
          {
            lead: [
              {
                kind: "text",
                value: "A tab bar no longer inherits the consumer's leading.",
              },
            ],
            rest: [
              {
              ...
              },
              {
                kind: "text",
                value:
                  ", so the label's line box was sized by whatever the host app had on an ancestor. An app with a comfortable body leading gave that 10px label a 16–26px box: a ",
              },
              {
                kind: "code",
                value: "compact",
              },
              {
                kind: "text",
                value:
                  " bar that should stand ~32px tall stood ~42px, and read as a slab rather than a row of tabs. The consumer cannot fix this from outside — tuning padding fights an inflation that is not theirs, and ",
              },
              {
                kind: "code",
                value: ".tab-bar-item",
              ...
              {
                kind: "text",
                value: " lives inside our template. The item now sets ",
              },
              {
                kind: "code",
                value: "line-height: 1",
              ...
              },
              {
                kind: "text",
                value:
                  " already did for the same reason; the tab bar had simply been left out. Affects ",
              },
              {
                kind: "code",
                value: "fold-tabs",
              ...
              },
              {
                kind: "text",
                value:
                  "). Bars in apps that already had a tight leading are unchanged.",
              },
            ],
            breaking: false,
          },
        ...
        items: [
          {
            lead: [
              {
                kind: "code",
                value: "FoldCustomIcons",
              },
              {
                kind: "text",
                value:
                  " is now exported, so a consumer can actually augment it.",
              },
            ],
            rest: [
              {
                kind: "text",
                value: "0.11.0 shipped the interface ",
              },
              {
                kind: "strong",
                value: "declared but not exported",
              },
              {
                kind: "text",
                value: ": in the flattened ",
              },
              {
                kind: "code",
                value: ".d.ts",
              ...
              {
                kind: "text",
                value: " it was module-local, so a consumer's ",
              },
              {
                kind: "code",
                value:
                  'declare module "fold-ng" { interface FoldCustomIcons { … } }',
              },
              {
                kind: "text",
                value:
                  " created a second, unrelated interface. It compiled, it merged with nothing, and ",
              },
              {
                kind: "code",
                value: 'icon="my-logo"',
              },
              {
                kind: "text",
                value:
                  " still failed — the headline extensibility of 0.11.0 did not work from outside the repo. Caught by the first real consumer, within the hour. In-repo the gallery augments the ",
              },
              {
                kind: "strong",
                value: "source file",
              ...
              {
                kind: "text",
                value: " path, which is why its own ",
              },
              {
                kind: "code",
                value: "demo-sparkle",
              ...
              {
                kind: "text",
                value: " worked and the gap stayed invisible. ",
              },
              {
                kind: "code",
              ...
              },
              {
                kind: "text",
                value:
                  " could not catch it either: it snapshots _exported_ symbols, and this one wasn't.",
              },
            ],
            breaking: false,
          },
        ...
        items: [
          {
            lead: [
              ...
              {
                kind: "text",
                value: " hands its content a zero gutter, at every width.",
              },
            ],
            rest: [
              {
                kind: "text",
                value:
                  "The bar is that column's header: it spans the layout's full width, so a gutter under it insets the cards _relative to the menu that names them_ and the two stop reading as one column — a desktop misalignment as much as a mobile one, where it also costs room there isn't. The gutter belongs to the PAGE; a nav layout's body is the inside of a column the page has already inset. Handed down as ",
              },
              {
                kind: "code",
        ...
        items: [
          ...
          },
          {
            lead: [
              ...
              {
                kind: "text",
                value: " + the shell scroll registry — scroll-system Slice B.",
              },
            ],
            rest: [
              {
                kind: "text",
                value: "The one opt-in of the scroll model (",
              },
              {
                kind: "code",
                value: "docs/scroll.md",
              ...
              },
              {
                kind: "text",
                value:
                  " owning the page scroll, a layout that needs an independently-scrolling area (a split list/detail, a data-table body, a sticky sidebar, a panel body) marks it with ",
              },
              {
                kind: "code",
                value: "[foldScrollRegion]",
              ...
              {
                kind: "text",
                value: ". The directive sets the three foot-guns (",
              },
              {
                kind: "code",
                value: "overflow",
              ...
              {
                kind: "text",
                value: ") and the thin house scrollbar, and takes an axis (",
              },
              {
                kind: "code",
                value: "block",
              ...
              {
                kind: "strong",
                value: "registers with the new `ScrollRegionRegistry`",
              },
              {
                kind: "text",
                value:
                  ", which the shell also feeds with its own content scroll box; the panel host freezes the registry when a modal opens, so the page stops scrolling behind the overlay even though the scroll owner is an inner box, not ",
              },
              {
                kind: "code",
                value: "document.body",
              ...
              {
                kind: "text",
                value: ". Freezing toggles a ",
              },
              {
                kind: "code",
                value: ".fold-scroll-frozen",
              },
              {
                kind: "text",
                value: " class (",
              ...
              },
              {
                kind: "text",
                value:
                  "), never an inline write, so a region's own overflow is never clobbered. Registry injection is optional, so the directive is a useful bounded scroll box even without a shell. Gallery ",
              },
              {
                kind: "code",
                value: "/scroll-region",
              },
              {
                kind: "text",
                value:
                  "; 19 specs. (Migrating the data-table / panel bodies onto it is deferred — they already scroll correctly; the win there is registry coordination, not the overflow.)",
              },
            ],
            breaking: false,
          },
...
export const PUBLISHED_VERSION = "0.27.2";

import{ai as d,a2 as c,aj as l,ɵ as p,F as m,Y as f,d as t,B as _,Z as i,f as s,g as u,D as a,j as g,m as v,L as h}from"./index-pDSvq2wI.js";const C=[[["","summary",""]],"*"],b=["[summary]","*"];class r{open=d(!1);panelId=c(l).next("fold-disclosure");toggle(){this.open.update(o=>!o)}static ɵfac=function(e){return new(e||r)};static ɵcmp=p({type:r,selectors:[["fold-disclosure"]],hostVars:2,hostBindings:function(e,n){e&2&&h("is-open",n.open())},inputs:{open:[1,"open"]},outputs:{open:"openChange"},exportAs:["foldDisclosure"],ngContentSelectors:b,decls:8,vars:4,consts:[["type","button",1,"disc-summary",3,"click"],[1,"disc-label"],["name","chevron-down","size","sm",1,"disc-chevron"],["role","region",1,"disc-panel",3,"id"],[1,"disc-panel-clip"],[1,"disc-panel-content"]],template:function(e,n){e&1&&(f(C),t(0,"button",0),_("click",function(){return n.toggle()}),t(1,"span",1),i(2),s(),u(3,"fold-icon",2),s(),t(4,"div",3)(5,"div",4)(6,"div",5),i(7,1),s()()()),e&2&&(a("aria-expanded",n.open())("aria-controls",n.panelId),g(4),v("id",n.panelId),a("aria-hidden",!n.open()))},dependencies:[m],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: block;

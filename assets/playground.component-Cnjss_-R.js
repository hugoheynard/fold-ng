import{w as g,s as _,S as T,au as R,aU as j,ai as $,aV as q,y as X,J as F,aE as Q,aW as V,x as d,al as P,am as M,ɵ as Y,b as G,K as J,d as i,g as w,M as O,f as a,H as k,B as u,e as l,j as r,I as H,m as h,C as m,k as v,l as B,aX as K,aY as U,A as S,aS as I,aZ as L,i as Z,q as c,O as C,o as nn,P as N,z as D,D as y,E as b}from"./index-UW4on9BG.js";import{FoldButtonComponent as en}from"./button.component-D0o4QjSk.js";import{FoldElementTitleComponent as tn}from"./element-title.component-BKp6imRK.js";import{FoldPageSectionComponent as on}from"./page-section.component-BEl6f7vu.js";const E='style, link[rel="stylesheet"]';function A(p,e){if(!(e instanceof HTMLLinkElement))return e.cloneNode(!0);const n=p.createElement("link");n.rel="stylesheet",n.href=e.href;for(const t of["media","integrity","crossorigin","referrerpolicy"]){const o=e.getAttribute(t);o!==null&&n.setAttribute(t,o)}return n}class f{source=g.required();themeHost=g(null);contentHeight=_(0);host=T(R).nativeElement;cleanups=[];mounted=!1;constructor(){j(()=>this.mount()),T($).onDestroy(()=>{for(const e of this.cleanups)e()})}mount(){if(this.mounted)return;const e=this.host.contentDocument,n=this.source();if(!e||!e.body){this.host.addEventListener("load",()=>this.mount(),{once:!0});return}this.mounted=!0,e.documentElement.style.background="transparent",e.body.style.margin="0",e.body.style.background="transparent",this.mirrorStyles(e),this.mirrorSprite(e),this.mirrorTheme(e),this.applyBaseTypography(e),e.body.appendChild(n),this.observeHeight(e,n)}mirrorStyles(e){for(const t of Array.from(document.head.querySelectorAll(E)))e.head.appendChild(A(e,t));const n=new MutationObserver(t=>{for(const o of t)for(const s of Array.from(o.addedNodes))s instanceof Element&&s.matches(E)&&e.head.appendChild(A(e,s))});n.observe(document.head,{childList:!0}),this.cleanups.push(()=>n.disconnect())}mirrorSprite(e){const n=document.getElementById(q);if(!n)return;const t=n.cloneNode(!0);e.body.appendChild(t);const o=new MutationObserver(s=>{for(const x of s)for(const z of Array.from(x.addedNodes))z instanceof Element&&t.appendChild(z.cloneNode(!0))});o.observe(n,{childList:!0}),this.cleanups.push(()=>o.disconnect())}applyBaseTypography(e){const n=this.themeHost();e.body.style.fontFamily=n?getComputedStyle(n).fontFamily:"system-ui, -apple-system, sans-serif",e.body.style.color="var(--fold-color-text)"}mirrorTheme(e){const n=this.themeHost();if(!n)return;const t=e.documentElement,o=()=>{const x=n.getAttribute("data-theme");x===null?t.removeAttribute("data-theme"):t.setAttribute("data-theme",x)};o();const s=new MutationObserver(o);s.observe(n,{attributes:!0,attributeFilter:["data-theme"]}),this.cleanups.push(()=>s.disconnect())}observeHeight(e,n){if(typeof ResizeObserver>"u")return;const t=()=>this.contentHeight.set(n.scrollHeight),o=new ResizeObserver(t);o.observe(n),o.observe(e.body),t(),this.cleanups.push(()=>o.disconnect())}static ɵfac=function(n){return new(n||f)};static ɵdir=X({type:f,selectors:[["iframe","devPreviewFrame",""]],inputs:{source:[1,"source"],themeHost:[1,"themeHost"]}})}const rn=["vpFrame"],an=[[["","params",""]],[["","preview-actions",""]],"*"],sn=["[params]","[preview-actions]","*"],pn=(p,e)=>e.id;function ln(p,e){if(p&1){const n=S();i(0,"button",33),u("click",function(){const o=y(n).$implicit,s=c(2);return b(s.setViewport(o.w))}),I(),i(1,"svg",26),w(2,"path",27),a(),L(),i(3,"span",28),l(4),a(),i(5,"span",34),l(6),a()()}if(p&2){const n=e.$implicit,t=c(2);m("is-on",t.activeViewport()===n.id),h("title",n.label+" — "+n.w+"px"),C("aria-pressed",t.activeViewport()===n.id),r(2),C("d",n.d),r(2),v(n.label),r(2),v(n.w)}}function cn(p,e){if(p&1){const n=S();i(0,"div",10)(1,"div",24)(2,"button",25),u("click",function(){y(n);const o=c();return b(o.setViewport(null))}),I(),i(3,"svg",26),w(4,"path",27),a(),L(),i(5,"span",28),l(6,"Fluid"),a()(),Z(7,ln,7,7,"button",29,pn),a(),i(9,"div",30)(10,"input",31,2),u("input",function(){y(n);const o=N(11),s=c();return b(s.onSlider(o.valueAsNumber))}),a(),i(12,"span",32),l(13),a()()()}if(p&2){const n=c();r(2),m("is-on",n.activeViewport()==="fluid"),C("aria-pressed",n.activeViewport()==="fluid"),r(2),C("d",n.fluidIcon),r(3),nn(n.viewports),r(3),h("min",n.VP_MIN)("max",n.VP_MAX)("value",n.sliderValue()),r(3),v(n.vpWidth()===null?"Fluid":n.vpWidth()+" px")}}function dn(p,e){if(p&1&&(i(0,"div",35),w(1,"iframe",36),a()),p&2){const n=c(),t=N(18);D("width",n.stageWidth())("height",n.stageHeight(),"px"),m("is-device",n.vpWidth()!==null),r(),D("width",n.iframeWidth())("height",n.contentHeight(),"px")("transform",n.iframeTransform()),h("source",t)("themeHost",n.themeHostEl)}}function gn(p,e){if(p&1){const n=S();i(0,"div",17)(1,"div",37)(2,"span",21),l(3),a(),i(4,"div",38)(5,"button",22),u("click",function(){y(n);const o=c();return b(o.copy())}),l(6),a(),i(7,"button",39),u("click",function(){y(n);const o=c();return b(o.toggleCode())}),l(8," Close "),a()()(),i(9,"pre",40)(10,"code"),l(11),a()()()}if(p&2){const n=c();r(3),v(n.lang()),r(2),h("icon",n.copied()?"check-circle":"copy"),r(),B(" ",n.copied()?"Copied":"Copy"," "),r(5),v(n.code())}}class W{code=g("");lang=g("html");stage=g(!1,{transform:F});responsive=g(!0,{transform:F});initialWidth=g(null);copied=_(!1);codeOpen=_(!1);viewports=[{id:"desktop",label:"Desktop",w:1280,d:"M21 2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h7c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H3V4h18v12z"},{id:"tablet",label:"Tablet",w:768,d:"M18.5 0h-14C3.12 0 2 1.12 2 2.5v19C2 22.88 3.12 24 4.5 24h14c1.38 0 2.5-1.12 2.5-2.5v-19C21 1.12 19.88 0 18.5 0zm-7 23c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM19 20H4V3h15v17z"},{id:"mobile",label:"Mobile",w:375,d:"M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"}];fluidIcon="M6.99 11 3 15l3.99 4v-3H14v-2H6.99v-3zM21 9l-3.99-4v3H10v2h7.01v3L21 9z";VP_MIN=320;VP_MAX=1440;vpWidth=Q(()=>this.initialWidth());vpFrame=V("vpFrame");frameWidth=_(0);fitWidth=_(0);activeViewport=d(()=>{const e=this.vpWidth();return e===null?"fluid":this.viewports.find(n=>n.w===e)?.id??"custom"});previewFrame=V(f);themeHostEl=typeof document>"u"?null:document.querySelector("gallery-shell");vpScale=d(()=>{const e=this.vpWidth();if(e===null)return 1;const n=this.fitWidth(),t=this.frameWidth(),o=n>0&&t>0?Math.min(n,t):n||t;return o===0?1:Math.min(1,o/e)});contentHeight=d(()=>this.previewFrame()?.contentHeight()??0);iframeWidth=d(()=>{const e=this.vpWidth();return e===null?"100%":`${e}px`});iframeTransform=d(()=>{const e=this.vpScale();return e===1?"none":`scale(${e})`});stageWidth=d(()=>{const e=this.vpWidth();return e===null?"100%":`${e*this.vpScale()}px`});stageHeight=d(()=>this.contentHeight()*this.vpScale());sliderValue=d(()=>this.vpWidth()??this.VP_MAX);constructor(){P(e=>{const n=this.vpFrame()?.nativeElement;if(!n||typeof ResizeObserver>"u")return;const t=new ResizeObserver(o=>{const s=o[0];s&&this.frameWidth.set(s.contentRect.width)});t.observe(n),e(()=>{t.disconnect()})}),P(()=>{this.vpWidth();const e=M(()=>this.frameWidth());e>0&&M(()=>this.fitWidth.set(e))}),P(()=>{const e=this.frameWidth();M(()=>{e>0&&this.fitWidth()===0&&this.fitWidth.set(e)})})}setViewport(e){this.vpWidth.set(e)}onSlider(e){this.vpWidth.set(e)}copy(){navigator.clipboard.writeText(this.code()).then(()=>{this.copied.set(!0),setTimeout(()=>this.copied.set(!1),1500)})}toggleCode(){this.codeOpen.update(e=>!e)}static ɵfac=function(n){return new(n||W)};static ɵcmp=Y({type:W,selectors:[["dev-playground"]],viewQuery:function(n,t){n&1&&K(t.vpFrame,rn,5)(t.previewFrame,f,5),n&2&&U(2)},hostVars:2,hostBindings:function(n,t){n&2&&m("pg-stage",t.stage())},inputs:{code:[1,"code"],lang:[1,"lang"],stage:[1,"stage"],responsive:[1,"responsive"],initialWidth:[1,"initialWidth"]},ngContentSelectors:sn,decls:31,vars:12,consts:[["vpFrame",""],["vpSrc",""],["slider",""],["title","Playground","icon","play"],[1,"pg-row"],["padding","none","separators","both","raisedBands","both",1,"pg-panel","pg-params"],["cardHeader","","variant","title","icon","sliders","title","Settings"],[1,"pg-body","pg-params-body"],["padding","none","separators","both","raisedBands","both",1,"pg-panel","pg-preview"],["cardHeader","","variant","title","icon","eye","title","Preview"],["titleAction","",1,"pg-vp"],["foldButton","","titleAction","","size","sm","emphasis","outline","intent","neutral",1,"pg-code-toggle",3,"click","icon"],["cardHeader","",1,"pg-head-actions"],[1,"pg-body","pg-preview-body"],[1,"pg-vp-frame"],[1,"pg-vp-stage",3,"is-device","width","height"],[1,"pg-vp-src"],[1,"pg-code-overlay"],["surface","sunken","padding","none","separators","both","raisedBands","both",1,"pg-panel","pg-code"],["cardHeader","","variant","title","icon","code","title","Code"],["titleAction","",1,"pg-code-actions"],[1,"pg-lang"],["foldButton","","size","sm","emphasis","outline","intent","neutral",3,"click","icon"],[1,"pg-body","pg-pre"],["role","group","aria-label","Preview width",1,"pg-vp-devices"],["type","button","title","Fluid — fills the frame",1,"pg-vp-btn",3,"click"],["viewBox","0 0 24 24","aria-hidden","true",1,"pg-vp-ic"],["fill","currentColor"],[1,"pg-vp-name"],["type","button",1,"pg-vp-btn",3,"title","is-on"],[1,"pg-vp-slider"],["type","range","step","1","aria-label","Custom preview width",3,"input","min","max","value"],[1,"pg-vp-readout"],["type","button",1,"pg-vp-btn",3,"click","title"],[1,"pg-vp-px"],[1,"pg-vp-stage"],["title","Preview","devPreviewFrame","",1,"pg-vp-iframe",3,"source","themeHost"],[1,"pg-code-overlay-top"],[1,"pg-code-overlay-actions"],["foldButton","","size","sm","emphasis","outline","intent","neutral","icon","close",3,"click"],[1,"pg-pre","pg-code-overlay-pre"]],template:function(n,t){n&1&&(J(an),i(0,"fold-page-section",3)(1,"div",4)(2,"fold-card",5),w(3,"fold-element-title",6),i(4,"div",7),O(5),a()(),i(6,"fold-card",8)(7,"fold-element-title",9),k(8,cn,14,8,"div",10),i(9,"button",11),u("click",function(){return t.toggleCode()}),l(10," Code "),a()(),i(11,"div",12),O(12,1),a(),i(13,"div",13)(14,"div",14,0),k(16,dn,2,14,"div",15),i(17,"div",16,1),O(19,2),a()(),k(20,gn,12,4,"div",17),a()(),i(21,"fold-card",18)(22,"fold-element-title",19)(23,"div",20)(24,"span",21),l(25),a(),i(26,"button",22),u("click",function(){return t.copy()}),l(27),a()()(),i(28,"pre",23)(29,"code"),l(30),a()()()()()),n&2&&(r(8),H(t.responsive()?8:-1),r(),h("icon",t.codeOpen()?"close":"code"),r(4),m("is-responsive",t.responsive()),r(3),H(t.responsive()?16:-1),r(),m("is-hosted",t.responsive()),r(3),H(t.codeOpen()?20:-1),r(5),v(t.lang()),r(),h("icon",t.copied()?"check-circle":"copy"),r(),B(" ",t.copied()?"Copied":"Copy"," "),r(3),v(t.code()))},dependencies:[en,tn,G,on,f],styles:[`[_nghost-%COMP%] {
  display: block;

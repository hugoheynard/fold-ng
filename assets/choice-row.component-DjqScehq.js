import{u as c,as as v,ɵ as g,y as r,i as h,z as a,L as d,D as _,j as i,o as y,E as C,ao as b,N as x,q as s,O as w,e as p,w as O,k as u,x as P}from"./index-CSZ3oRcG.js";const M=(n,t)=>t.key;function k(n,t){if(n&1&&(r(0,"span",3),p(1),a()),n&2){const o=s().$implicit;i(),u(o.count)}}function F(n,t){if(n&1){const o=C();r(0,"button",2),b("click",function(){const f=x(o).$implicit,m=s();return w(m.selected.emit(f.key))}),r(1,"span"),p(2),a(),O(3,k,2,1,"span",3),a()}if(n&2){const o=t.$implicit,e=s();d("is-active",e.activeKey()===o.key),_("aria-pressed",e.activeKey()===o.key),i(2),u(o.label),i(),P(o.count!==void 0?3:-1)}}class l{options=c.required();activeKey=c.required();layout=c("segmented");ariaLabel=c("");selected=v();static ɵfac=function(o){return new(o||l)};static ɵcmp=g({type:l,selectors:[["fold-choice-row"]],inputs:{options:[1,"options"],activeKey:[1,"activeKey"],layout:[1,"layout"],ariaLabel:[1,"ariaLabel"]},outputs:{selected:"selected"},decls:3,vars:5,consts:[["role","group",1,"choice-row"],["type","button",1,"choice",3,"is-active"],["type","button",1,"choice",3,"click"],[1,"choice-count"]],template:function(o,e){o&1&&(r(0,"div",0),h(1,F,4,5,"button",1,M),a()),o&2&&(d("segmented",e.layout()==="segmented")("chips",e.layout()==="chips"),_("aria-label",e.ariaLabel()||null),i(),y(e.options()))},styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: block;
}

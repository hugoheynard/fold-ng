import{s as d,A as O,ɵ as P,c as h,d as t,e,f as n,g as k,i as v,T as f,B as _,h as z,j as s,m as u,U as V,o as b,L as p,k as x,n as F,E as y,q as g,l as w,N as C,O as T,r as L}from"./index-B61aGEid.js";import{K as M}from"./kind-badge.component-C4lxCjuu.js";import{C as S}from"./composed-of.component-_E5BtZAg.js";import{D as B}from"./playground.component-_evYVhPB.js";import{FoldViewToggleComponent as $}from"./view-toggle.component-BIj-Bb0L.js";import"./button.component-DnXTvHLY.js";import"./element-title.component-AM7WL348.js";import"./page-section.component-oWq3djiM.js";import"./slider.component-DXcA4CGe.js";import"./input-value-DCGlOvqF.js";const I=()=>["icons"];function E(c,a){if(c&1){const i=y();t(0,"button",10),_("click",function(){const r=C(i).$implicit,l=g();return T(l.size.set(r))}),e(1),n()}if(c&2){const i=a.$implicit,o=g();p("is-on",o.size()===i),s(),w(" ",i," ")}}function W(c,a){if(c&1){const i=y();t(0,"button",10),_("click",function(){const r=C(i).$implicit,l=g();return T(l.active.set(r))}),e(1),n()}if(c&2){const i=a.$implicit,o=g();p("is-on",o.active()===i),s(),w(" ",i," ")}}class m{view=d("cards");size=d("md");iconOnly=d(!1);active=d("solid");sizes=["sm","md"];actives=["solid","accent","raised"];options=[{value:"cards",label:"Cards",icon:"grid",ariaLabel:"Cards"},{value:"table",label:"Table",icon:"list",ariaLabel:"Table"}];code=O(()=>{const a=['ariaLabel="View"','[options]="options"'];return this.size()!=="md"&&a.push(`size="${this.size()}"`),this.active()!=="solid"&&a.push(`activeStyle="${this.active()}"`),this.iconOnly()&&a.push("iconOnly"),a.push('[(value)]="view"'),["<fold-view-toggle",...a.map(i=>`  ${i}`),"/>"].join(`

import{x as g,s as _,T as S,ad as N,ap as R,aq as j,ar as q,z as $,K as z,ah as Q,as as V,y as c,a0 as P,a1 as M,ɵ as X,b as G,L as J,d as i,g as w,N as O,f as a,I as k,C as u,e as l,j as r,J as H,m as f,D as m,k as v,l as B,at as K,au as Y,B as T,ak as L,av as I,i as U,q as d,P as C,o as Z,Q as nn,A as D,E as y,H as b}from"./index-Ci6yhgBI.js";import{FoldButtonComponent as en}from"./button.component-DMBE20VB.js";import{FoldElementTitleComponent as tn}from"./element-title.component-CGnuUH0f.js";import{FoldPageSectionComponent as on}from"./page-section.component-BArtEj3s.js";import{FoldSliderComponent as rn}from"./slider.component-CcQuXEuq.js";const E='style, link[rel="stylesheet"]';function A(p,e){if(!(e instanceof HTMLLinkElement))return e.cloneNode(!0);const n=p.createElement("link");n.rel="stylesheet",n.href=e.href;for(const t of["media","integrity","crossorigin","referrerpolicy"]){const o=e.getAttribute(t);o!==null&&n.setAttribute(t,o)}return n}class h{source=g.required();themeHost=g(null);contentHeight=_(0);host=S(N).nativeElement;cleanups=[];mounted=!1;constructor(){R(()=>this.mount()),S(j).onDestroy(()=>{for(const e of this.cleanups)e()})}mount(){if(this.mounted)return;const e=this.host.contentDocument,n=this.source();if(!e||!e.body){this.host.addEventListener("load",()=>this.mount(),{once:!0});return}this.mounted=!0,e.documentElement.style.background="transparent",e.body.style.margin="0",e.body.style.background="transparent",this.mirrorStyles(e),this.mirrorSprite(e),this.mirrorTheme(e),this.applyBaseTypography(e),e.body.appendChild(n),this.observeHeight(e,n)}mirrorStyles(e){for(const t of Array.from(document.head.querySelectorAll(E)))e.head.appendChild(A(e,t));const n=new MutationObserver(t=>{for(const o of t)for(const s of Array.from(o.addedNodes))s instanceof Element&&s.matches(E)&&e.head.appendChild(A(e,s))});n.observe(document.head,{childList:!0}),this.cleanups.push(()=>n.disconnect())}mirrorSprite(e){const n=document.getElementById(q);if(!n)return;const t=n.cloneNode(!0);e.body.appendChild(t);const o=new MutationObserver(s=>{for(const x of s)for(const F of Array.from(x.addedNodes))F instanceof Element&&t.appendChild(F.cloneNode(!0))});o.observe(n,{childList:!0}),this.cleanups.push(()=>o.disconnect())}applyBaseTypography(e){const n=this.themeHost();e.body.style.fontFamily=n?getComputedStyle(n).fontFamily:"system-ui, -apple-system, sans-serif",e.body.style.color="var(--fold-color-text)"}mirrorTheme(e){const n=this.themeHost();if(!n)return;const t=e.documentElement,o=()=>{const x=n.getAttribute("data-theme");x===null?t.removeAttribute("data-theme"):t.setAttribute("data-theme",x)};o();const s=new MutationObserver(o);s.observe(n,{attributes:!0,attributeFilter:["data-theme"]}),this.cleanups.push(()=>s.disconnect())}observeHeight(e,n){if(typeof ResizeObserver>"u")return;const t=()=>this.contentHeight.set(n.scrollHeight),o=new ResizeObserver(t);o.observe(n),o.observe(e.body),t(),this.cleanups.push(()=>o.disconnect())}static ɵfac=function(n){return new(n||h)};static ɵdir=$({type:h,selectors:[["iframe","devPreviewFrame",""]],inputs:{source:[1,"source"],themeHost:[1,"themeHost"]}})}const an=["vpFrame"],sn=[[["","params",""]],[["","preview-actions",""]],"*"],pn=["[params]","[preview-actions]","*"],ln=(p,e)=>e.id;function dn(p,e){if(p&1){const n=T();i(0,"button",32),u("click",function(){const o=y(n).$implicit,s=d(2);return b(s.setViewport(o.w))}),L(),i(1,"svg",25),w(2,"path",26),a(),I(),i(3,"span",27),l(4),a(),i(5,"span",33),l(6),a()()}if(p&2){const n=e.$implicit,t=d(2);m("is-on",t.activeViewport()===n.id),f("title",n.label+" — "+n.w+"px"),C("aria-pressed",t.activeViewport()===n.id),r(2),C("d",n.d),r(2),v(n.label),r(2),v(n.w)}}function cn(p,e){if(p&1){const n=T();i(0,"div",9)(1,"div",23)(2,"button",24),u("click",function(){y(n);const o=d();return b(o.setViewport(null))}),L(),i(3,"svg",25),w(4,"path",26),a(),I(),i(5,"span",27),l(6,"Fluid"),a()(),U(7,dn,7,7,"button",28,ln),a(),i(9,"div",29)(10,"fold-slider",30),u("valueChange",function(o){y(n);const s=d();return b(s.onSlider(o))}),a(),i(11,"span",31),l(12),a()()()}if(p&2){const n=d();r(2),m("is-on",n.activeViewport()==="fluid"),C("aria-pressed",n.activeViewport()==="fluid"),r(2),C("d",n.fluidIcon),r(3),Z(n.viewports),r(3),f("min",n.VP_MIN)("max",n.VP_MAX)("step",1)("showValue",!1)("value",n.sliderValue()),r(2),v(n.vpWidth()===null?"Fluid":n.vpWidth()+" px")}}function gn(p,e){if(p&1&&(i(0,"div",34),w(1,"iframe",35),a()),p&2){const n=d(),t=nn(18);D("width",n.stageWidth())("height",n.stageHeight(),"px"),m("is-device",n.vpWidth()!==null),r(),D("width",n.iframeWidth())("height",n.contentHeight(),"px")("transform",n.iframeTransform()),f("source",t)("themeHost",n.themeHostEl)}}function un(p,e){if(p&1){const n=T();i(0,"div",16)(1,"div",36)(2,"span",20),l(3),a(),i(4,"div",37)(5,"button",21),u("click",function(){y(n);const o=d();return b(o.copy())}),l(6),a(),i(7,"button",38),u("click",function(){y(n);const o=d();return b(o.toggleCode())}),l(8," Close "),a()()(),i(9,"pre",39)(10,"code"),l(11),a()()()}if(p&2){const n=d();r(3),v(n.lang()),r(2),f("icon",n.copied()?"check-circle":"copy"),r(),B(" ",n.copied()?"Copied":"Copy"," "),r(5),v(n.code())}}class W{code=g("");lang=g("html");stage=g(!1,{transform:z});responsive=g(!0,{transform:z});initialWidth=g(null);copied=_(!1);codeOpen=_(!1);viewports=[{id:"desktop",label:"Desktop",w:1280,d:"M21 2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h7c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H3V4h18v12z"},{id:"tablet",label:"Tablet",w:768,d:"M18.5 0h-14C3.12 0 2 1.12 2 2.5v19C2 22.88 3.12 24 4.5 24h14c1.38 0 2.5-1.12 2.5-2.5v-19C21 1.12 19.88 0 18.5 0zm-7 23c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM19 20H4V3h15v17z"},{id:"mobile",label:"Mobile",w:375,d:"M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"}];fluidIcon="M6.99 11 3 15l3.99 4v-3H14v-2H6.99v-3zM21 9l-3.99-4v3H10v2h7.01v3L21 9z";VP_MIN=320;VP_MAX=1440;vpWidth=Q(()=>this.initialWidth());vpFrame=V("vpFrame");frameWidth=_(0);fitWidth=_(0);activeViewport=c(()=>{const e=this.vpWidth();return e===null?"fluid":this.viewports.find(n=>n.w===e)?.id??"custom"});previewFrame=V(h);themeHostEl=typeof document>"u"?null:document.querySelector("gallery-shell");vpScale=c(()=>{const e=this.vpWidth();if(e===null)return 1;const n=this.fitWidth(),t=this.frameWidth(),o=n>0&&t>0?Math.min(n,t):n||t;return o===0?1:Math.min(1,o/e)});contentHeight=c(()=>this.previewFrame()?.contentHeight()??0);iframeWidth=c(()=>{const e=this.vpWidth();return e===null?"100%":`${e}px`});iframeTransform=c(()=>{const e=this.vpScale();return e===1?"none":`scale(${e})`});stageWidth=c(()=>{const e=this.vpWidth();return e===null?"100%":`${e*this.vpScale()}px`});stageHeight=c(()=>this.contentHeight()*this.vpScale());sliderValue=c(()=>this.vpWidth()??this.VP_MAX);constructor(){P(e=>{const n=this.vpFrame()?.nativeElement;if(!n||typeof ResizeObserver>"u")return;const t=new ResizeObserver(o=>{const s=o[0];s&&this.frameWidth.set(s.contentRect.width)});t.observe(n),e(()=>{t.disconnect()})}),P(()=>{this.vpWidth();const e=M(()=>this.frameWidth());e>0&&M(()=>this.fitWidth.set(e))}),P(()=>{const e=this.frameWidth();M(()=>{e>0&&this.fitWidth()===0&&this.fitWidth.set(e)})})}setViewport(e){this.vpWidth.set(e)}onSlider(e){this.vpWidth.set(e)}copy(){navigator.clipboard.writeText(this.code()).then(()=>{this.copied.set(!0),setTimeout(()=>this.copied.set(!1),1500)})}toggleCode(){this.codeOpen.update(e=>!e)}static ɵfac=function(n){return new(n||W)};static ɵcmp=X({type:W,selectors:[["dev-playground"]],viewQuery:function(n,t){n&1&&K(t.vpFrame,an,5)(t.previewFrame,h,5),n&2&&Y(2)},hostVars:2,hostBindings:function(n,t){n&2&&m("pg-stage",t.stage())},inputs:{code:[1,"code"],lang:[1,"lang"],stage:[1,"stage"],responsive:[1,"responsive"],initialWidth:[1,"initialWidth"]},ngContentSelectors:pn,decls:31,vars:12,consts:[["vpFrame",""],["vpSrc",""],["title","Playground","icon","play"],[1,"pg-row"],["padding","none","separators","both","raisedBands","both",1,"pg-panel","pg-params"],["cardHeader","","variant","title","icon","sliders","title","Settings"],[1,"pg-body","pg-params-body"],["padding","none","separators","both","raisedBands","both",1,"pg-panel","pg-preview"],["cardHeader","","variant","title","icon","eye","title","Preview"],["titleAction","",1,"pg-vp"],["foldButton","","titleAction","","size","sm","emphasis","outline","intent","neutral",1,"pg-code-toggle",3,"click","icon"],["cardHeader","",1,"pg-head-actions"],[1,"pg-body","pg-preview-body"],[1,"pg-vp-frame"],[1,"pg-vp-stage",3,"is-device","width","height"],[1,"pg-vp-src"],[1,"pg-code-overlay"],["surface","sunken","padding","none","separators","both","raisedBands","both",1,"pg-panel","pg-code"],["cardHeader","","variant","title","icon","code","title","Code"],["titleAction","",1,"pg-code-actions"],[1,"pg-lang"],["foldButton","","size","sm","emphasis","outline","intent","neutral",3,"click","icon"],[1,"pg-body","pg-pre"],["role","group","aria-label","Preview width",1,"pg-vp-devices"],["type","button","title","Fluid — fills the frame",1,"pg-vp-btn",3,"click"],["viewBox","0 0 24 24","aria-hidden","true",1,"pg-vp-ic"],["fill","currentColor"],[1,"pg-vp-name"],["type","button",1,"pg-vp-btn",3,"title","is-on"],[1,"pg-vp-slider"],["ariaLabel","Custom preview width",3,"valueChange","min","max","step","showValue","value"],[1,"pg-vp-readout"],["type","button",1,"pg-vp-btn",3,"click","title"],[1,"pg-vp-px"],[1,"pg-vp-stage"],["title","Preview","devPreviewFrame","",1,"pg-vp-iframe",3,"source","themeHost"],[1,"pg-code-overlay-top"],[1,"pg-code-overlay-actions"],["foldButton","","size","sm","emphasis","outline","intent","neutral","icon","close",3,"click"],[1,"pg-pre","pg-code-overlay-pre"]],template:function(n,t){n&1&&(J(sn),i(0,"fold-page-section",2)(1,"div",3)(2,"fold-card",4),w(3,"fold-element-title",5),i(4,"div",6),O(5),a()(),i(6,"fold-card",7)(7,"fold-element-title",8),k(8,cn,13,10,"div",9),i(9,"button",10),u("click",function(){return t.toggleCode()}),l(10," Code "),a()(),i(11,"div",11),O(12,1),a(),i(13,"div",12)(14,"div",13,0),k(16,gn,2,14,"div",14),i(17,"div",15,1),O(19,2),a()(),k(20,un,12,4,"div",16),a()(),i(21,"fold-card",17)(22,"fold-element-title",18)(23,"div",19)(24,"span",20),l(25),a(),i(26,"button",21),u("click",function(){return t.copy()}),l(27),a()()(),i(28,"pre",22)(29,"code"),l(30),a()()()()()),n&2&&(r(8),H(t.responsive()?8:-1),r(),f("icon",t.codeOpen()?"close":"code"),r(4),m("is-responsive",t.responsive()),r(3),H(t.responsive()?16:-1),r(),m("is-hosted",t.responsive()),r(3),H(t.codeOpen()?20:-1),r(5),v(t.lang()),r(),f("icon",t.copied()?"check-circle":"copy"),r(),B(" ",t.copied()?"Copied":"Copy"," "),r(3),v(t.code()))},dependencies:[en,tn,G,on,rn,h],styles:[`[_nghost-%COMP%] {
  display: block;

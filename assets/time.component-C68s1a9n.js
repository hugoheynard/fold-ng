import{ag as a,u as e,a0 as i,X as c,ah as p,A as s,ɵ as g,d as m,B as _,f as b,m as l,j as f,D as C,aj as h}from"./index-F5cuq_px.js";import{FoldInputBaseComponent as M}from"./input-base.component-4hwGqGOj.js";import{r as O}from"./input-value-DCGlOvqF.js";import"./label.component-BCfg6XDt.js";class r{value=a("");disabled=e(!1);touched=a(!1);errors=e([]);min=e(void 0);max=e(void 0);step=e(void 0);size=e("md");variant=e("default");label=e();required=e(!1,{transform:i});optional=e(!1,{transform:i});optionalLabel=e("optional");hint=e();readOnly=e(!1);inputId=c(p).next("fold-time");errorMessage=s(()=>{if(!this.touched())return;const t=this.errors()[0];return t?t.message??t.kind:void 0});describedBy=s(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);onInputChange(t){this.value.set(O(t))}onBlur(){this.touched.set(!0)}static ɵfac=function(o){return new(o||r)};static ɵcmp=g({type:r,selectors:[["fold-time"]],hostVars:2,hostBindings:function(o,n){o&2&&h(n.size()+" "+n.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],min:[1,"min"],max:[1,"max"],step:[1,"step"],size:[1,"size"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],hint:[1,"hint"],readOnly:[1,"readOnly"]},outputs:{value:"valueChange",touched:"touchedChange"},decls:2,vars:17,consts:[[3,"label","for","required","optional","optionalLabel","hint","error"],["type","time",1,"date",3,"input","blur","id","value"]],template:function(o,n){o&1&&(m(0,"fold-input-base",0)(1,"input",1),_("input",function(u){return n.onInputChange(u)})("blur",function(){return n.onBlur()}),b()()),o&2&&(l("label",n.label())("for",n.inputId)("required",n.required())("optional",n.optional())("optionalLabel",n.optionalLabel())("hint",n.hint())("error",n.errorMessage()),f(),l("id",n.inputId)("value",n.value()),C("min",n.min())("max",n.max())("step",n.step())("readonly",n.readOnly()||null)("disabled",n.disabled()||null)("required",n.required()||null)("aria-invalid",n.errorMessage()?!0:null)("aria-describedby",n.describedBy()))},dependencies:[M],styles:[`@charset "UTF-8";

import{ag as d,u as t,a0 as c,X as m,ah as b,A as u,ɵ as f,F as h,a1 as C,d as _,B as M,w as O,a2 as P,f as a,g as v,m as p,j as l,D as y,x,aj as w,e as k,k as z}from"./index-F5cuq_px.js";import{FoldInputBaseComponent as F}from"./input-base.component-4hwGqGOj.js";import{r as I}from"./input-value-DCGlOvqF.js";import"./label.component-BCfg6XDt.js";const q=["*"];function B(i,e){i&1&&(_(0,"option",3),k(1),a()),i&2&&(l(),z(e))}class s{value=d("");disabled=t(!1);touched=d(!1);errors=t([]);size=t("md");variant=t("default");label=t();required=t(!1,{transform:c});optional=t(!1,{transform:c});optionalLabel=t("optional");hint=t();placeholder=t();inputId=m(b).next("fold-select");errorMessage=u(()=>{if(!this.touched())return;const e=this.errors()[0];return e?e.message??e.kind:void 0});describedBy=u(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);onChange(e){this.value.set(I(e))}onBlur(){this.touched.set(!0)}static ɵfac=function(o){return new(o||s)};static ɵcmp=f({type:s,selectors:[["fold-select"]],hostVars:2,hostBindings:function(o,n){o&2&&w(n.size()+" "+n.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],size:[1,"size"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],hint:[1,"hint"],placeholder:[1,"placeholder"]},outputs:{value:"valueChange",touched:"touchedChange"},ngContentSelectors:q,decls:6,vars:14,consts:[[3,"label","for","required","optional","optionalLabel","hint","error"],[1,"sel-wrap"],[1,"sel",3,"change","blur","id","disabled","value"],["value","","disabled","","hidden",""],["name","chevron-down","size","sm","aria-hidden","true",1,"sel-caret"]],template:function(o,n){if(o&1&&(C(),_(0,"fold-input-base",0)(1,"div",1)(2,"select",2),M("change",function(g){return n.onChange(g)})("blur",function(){return n.onBlur()}),O(3,B,2,1,"option",3),P(4),a(),v(5,"fold-icon",4),a()()),o&2){let r;p("label",n.label())("for",n.inputId)("required",n.required())("optional",n.optional())("optionalLabel",n.optionalLabel())("hint",n.hint())("error",n.errorMessage()),l(2),p("id",n.inputId)("disabled",n.disabled())("value",n.value()),y("required",n.required()||null)("aria-invalid",n.errorMessage()?!0:null)("aria-describedby",n.describedBy()),l(),x((r=n.placeholder())?3:-1,r)}},dependencies:[F,h],styles:[`@charset "UTF-8";
...
}`]})}export{s as FoldSelectComponent};

...
}`]})}function j(l,r){if(l&1&&d(0,"fold-spinner",1),l&2){const o=v();c("size",o.iconSize())}}function W(l,r){if(l&1&&d(0,"fold-icon",2),l&2){const o=v();c("name",o.icon())("size",o.iconSize())}}class f{icon=a.required();shape=a("square");size=a("md");tone=a("ghost");active=w(!1);disabled=a(!1,{transform:u});loading=a(!1,{transform:u});tooltip=a();type=a("button");toggled=M();iconSize=P(()=>{switch(this.size()){case"xs":return"xs";case"sm":return"sm";case"md":return"sm";case"lg":return"md"}});onClick(r){this.disabled()||this.loading()||(this.active.update(o=>!o),this.toggled.emit(r))}static ɵfac=function(o){return new(o||f)};static ɵcmp=h({type:f,selectors:[["fold-toggle-icon"]],hostVars:5,hostBindings:function(o,n){o&2&&g("data-shape",n.shape())("data-size",n.size())("data-tone",n.tone())("data-active",n.active()?"":null)("data-loading",n.loading()?"":null)},inputs:{icon:[1,"icon"],shape:[1,"shape"],size:[1,"size"],tone:[1,"tone"],active:[1,"active"],disabled:[1,"disabled"],loading:[1,"loading"],tooltip:[1,"tooltip"],type:[1,"type"]},outputs:{active:"activeChange",toggled:"toggled"},decls:3,vars:7,consts:[[3,"click","type","disabled"],["aria-hidden","true",3,"size"],[3,"name","size"]],template:function(o,n){o&1&&(t(0,"button",0),k("click",function(s){return n.onClick(s)}),x(1,j,1,1,"fold-spinner",1)(2,W,1,2,"fold-icon",2),e()),o&2&&(c("type",n.type())("disabled",n.disabled()||n.loading()),g("title",n.tooltip()||null)("aria-label",n.tooltip()||null)("aria-pressed",n.active()?"true":"false")("aria-busy",n.loading()?"true":null),b(),T(n.loading()?1:2))},dependencies:[O,B],styles:[`[_nghost-%COMP%] {
  display: inline-flex;
}
[data-size=xs][_nghost-%COMP%] {
  --bi-size: 22px;

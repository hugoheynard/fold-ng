import{ab as M,u as i,W as m,a1 as I,ac as F,N as a,a7 as N,ɵ as S,F as z,ao as D,d as c,A as b,w as f,T as x,f as p,m as d,j as l,H as B,x as g,Z as w,ae as y,S as q,U as v,q as u,V as P,g as R,e as L,k as A,$ as O,at as T,aI as k,as as h,I as V}from"./index-Dx8_Baf4.js";import{F as j}from"./repeat-press.directive-BMuon3g6.js";import{FoldInputBaseComponent as U}from"./input-base.component-C7j42D3T.js";import{r as E}from"./input-value-Co_u-z_8.js";import"./label.component-CJpB0smF.js";function H(o){if(!Number.isFinite(o))return 0;const n=o.toString(),e=n.indexOf("e-");if(e!==-1){const s=n.slice(0,e),r=s.indexOf("."),_=r===-1?0:s.length-r-1;return Number(n.slice(e+2))+_}const t=n.indexOf(".");return t===-1?0:n.length-t-1}function W(o,n){const e=n.min??0;return e+Math.round((o-e)/n.step)*n.step}function $(o,n){const e=n.decimals??H(n.step),t=Math.min(100,Math.max(0,e));return Number(o.toFixed(t))}function G(o,n){let e=o;return n.min!==void 0&&(e=Math.max(n.min,e)),n.max!==void 0&&(e=Math.min(n.max,e)),e}function Y(o,n){const e=n.snapToStep?W(o,n):o;return G($(e,n),n)}function Z(o){if(o.max===void 0)return!0;const n=(o.max-(o.min??0))/o.step;return Math.abs(n-Math.round(n))<1e-9}const J=(o,n)=>({dir:o,size:"sm",cls:"ni-btn ni-dec",off:n}),K=o=>({dir:1,size:"xs",cls:"ni-stack-btn ni-inc",off:o}),Q=(o,n)=>({dir:o,size:"xs",cls:"ni-stack-btn ni-dec",off:n}),X=o=>({dir:1,size:"sm",cls:"ni-btn ni-inc",off:o});function nn(o,n){if(o&1){const e=q();c(0,"button",7),x("foldRepeatPress",function(){const s=v(e).dir,r=u();return P(r.stepBy(s))})("click",function(s){const r=v(e).dir,_=u();return P(_.onButtonClick(r,s))}),R(1,"fold-icon",8),p()}if(o&2){const e=n.dir,t=n.size,s=n.cls,r=n.off,_=u();y(s),d("disabled",r)("foldRepeatPressDisabled",r),w("aria-label",e===1?"Increment":"Decrement"),l(),d("name",_.iconFor(e))("size",t)}}function tn(o,n){o&1&&h(0)}function en(o,n){if(o&1&&b(0,tn,1,0,"ng-container",9),o&2){const e=u(),t=O(2);d("ngTemplateOutlet",t)("ngTemplateOutletContext",k(2,J,-1,e.decDisabled()))}}function on(o,n){if(o&1&&(c(0,"span",5),L(1),p()),o&2){const e=u();l(),A(e.step())}}function rn(o,n){o&1&&h(0)}function sn(o,n){o&1&&h(0)}function an(o,n){if(o&1&&(c(0,"span",6),b(1,rn,1,0,"ng-container",9)(2,sn,1,0,"ng-container",9),p()),o&2){const e=u(),t=O(2);l(),d("ngTemplateOutlet",t)("ngTemplateOutletContext",T(4,K,e.incDisabled())),l(),d("ngTemplateOutlet",t)("ngTemplateOutletContext",k(6,Q,-1,e.decDisabled()))}}function ln(o,n){o&1&&h(0)}function dn(o,n){if(o&1&&b(0,ln,1,0,"ng-container",9),o&2){const e=u(),t=O(2);d("ngTemplateOutlet",t)("ngTemplateOutletContext",T(2,X,e.incDisabled()))}}class C{value=M(null);disabled=i(!1);touched=M(!1);errors=i([]);size=i("md");align=i("start");variant=i("default");label=i();required=i(!1,{transform:m});optional=i(!1,{transform:m});optionalLabel=i("optional");hint=i();placeholder=i("");readOnly=i(!1);min=i(void 0);max=i(void 0);step=i(void 0);spinner=i("plusminus");controls=i("inside");showStep=i(!1,{transform:m});snapToStep=i(!1,{transform:m});decimals=i(void 0);integer=i(!1,{transform:m});inputId=I(F).next("fold-number-input");effectiveStep=a(()=>this.step()??1);maxDecimals=a(()=>this.integer()?0:this.decimals());constraints=a(()=>({step:this.effectiveStep(),min:this.min(),max:this.max(),decimals:this.maxDecimals(),snapToStep:this.snapToStep()}));nativeStep=a(()=>this.step()??(this.integer()?1:void 0));atMin=a(()=>{const n=this.min(),e=this.value();return n!==void 0&&e!==null&&e<=n});atMax=a(()=>{const n=this.max(),e=this.value();return n!==void 0&&e!==null&&e>=n});hasControls=a(()=>this.spinner()!=="none");frozen=a(()=>this.disabled()||this.readOnly());incDisabled=a(()=>this.frozen()||this.atMax());decDisabled=a(()=>this.frozen()||this.atMin());errorMessage=a(()=>{if(!this.touched())return;const n=this.errors()[0];return n?n.message??n.kind:void 0});describedBy=a(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);constructor(){N(()=>{this.snapToStep()&&!Z(this.constraints())&&this.warnStepMisaligned()})}onInputChange(n){const e=E(n);if(e===""){this.value.set(null);return}const t=Number(e);this.value.set(Number.isNaN(t)?null:t)}onBlur(){this.touched.set(!0);const n=this.value();n===null||!Number.isFinite(n)||(this.snapToStep()||this.maxDecimals()!==void 0)&&this.value.set(this.settle(n))}onButtonClick(n,e){e.detail===0&&this.stepBy(n)}onArrow(n,e){e.preventDefault(),this.stepBy(n)}onWheel(n){n.target instanceof HTMLElement&&n.target.blur()}iconFor(n){return this.spinner()==="arrows"?n===1?"chevron-up":"chevron-down":n===1?"plus":"minus"}stepBy(n){if(this.disabled()||this.readOnly())return;const e=(this.value()??0)+n*this.effectiveStep();this.value.set(this.settle(e)),this.touched.set(!0)}settle(n){return Y(n,this.constraints())}warnStepMisaligned(){}static ɵfac=function(e){return new(e||C)};static ɵcmp=S({type:C,selectors:[["fold-number-input"]],hostVars:2,hostBindings:function(e,t){e&2&&y(t.size()+" "+t.align()+" "+t.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],size:[1,"size"],align:[1,"align"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],hint:[1,"hint"],placeholder:[1,"placeholder"],readOnly:[1,"readOnly"],min:[1,"min"],max:[1,"max"],step:[1,"step"],spinner:[1,"spinner"],controls:[1,"controls"],showStep:[1,"showStep"],snapToStep:[1,"snapToStep"],decimals:[1,"decimals"],integer:[1,"integer"]},outputs:{value:"valueChange",touched:"touchedChange"},decls:10,vars:26,consts:[["stepBtn",""],[3,"label","for","required","optional","optionalLabel","hint","error"],[1,"ni-field"],[1,"ni-box"],["type","number",3,"input","blur","keydown.arrowUp","keydown.arrowDown","wheel","id","value"],["aria-hidden","true",1,"ni-step"],[1,"ni-stack"],["type","button","tabindex","-1","aria-hidden","true","foldRepeatPress","",3,"foldRepeatPress","click","disabled","foldRepeatPressDisabled"],[3,"name","size"],[4,"ngTemplateOutlet","ngTemplateOutletContext"]],template:function(e,t){e&1&&(c(0,"fold-input-base",1),b(1,nn,2,7,"ng-template",null,0,V),c(3,"div",2),f(4,en,1,5,"ng-container"),c(5,"div",3)(6,"input",4),x("input",function(r){return t.onInputChange(r)})("blur",function(){return t.onBlur()})("keydown.arrowUp",function(r){return t.onArrow(1,r)})("keydown.arrowDown",function(r){return t.onArrow(-1,r)})("wheel",function(r){return t.onWheel(r)}),p(),f(7,on,2,1,"span",5),f(8,an,3,9,"span",6),p(),f(9,dn,1,4,"ng-container"),p()()),e&2&&(d("label",t.label())("for",t.inputId)("required",t.required())("optional",t.optional())("optionalLabel",t.optionalLabel())("hint",t.hint())("error",t.errorMessage()),l(3),B("ni-inside",t.controls()==="inside")("ni-outside",t.controls()==="outside"),l(),g(t.hasControls()&&t.controls()==="outside"?4:-1),l(2),d("id",t.inputId)("value",t.value()),w("min",t.min())("max",t.max())("step",t.nativeStep())("placeholder",t.placeholder())("readonly",t.readOnly()||null)("disabled",t.disabled()||null)("required",t.required()||null)("aria-invalid",t.errorMessage()?!0:null)("aria-describedby",t.describedBy()),l(),g(t.showStep()&&t.step()!=null?7:-1),l(),g(t.hasControls()&&t.controls()==="inside"?8:-1),l(),g(t.hasControls()&&t.controls()==="outside"?9:-1))},dependencies:[U,z,j,D],styles:[`

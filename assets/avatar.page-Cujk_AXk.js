import{u as z,b7 as B,v as I,C as b,ɵ as L,i as f,bb as q,K as x,o as h,j as s,L as P,z as C,d as i,g as v,f as n,q as l,E as U,m,e as c,y as E,l as k,s as u,Q as N,c as K,F as j,H as g,A as w,G as y,h as S,n as $,k as A,I as p,J as _,r as M}from"./index-CheKRm5v.js";import{K as V}from"./kind-badge.component-CUehdKqc.js";import{D as R}from"./playground.component-f1vabdNM.js";import{F as O,a as W}from"./avatar.component-DzAcY9ZB.js";import{F as H}from"./page-section.component-BEVmrNeh.js";import{F as G}from"./nav-layout.component-CAB8DzC1.js";import{F as J}from"./view-nav.component-C-6Zx6Ro.js";import{F as Q}from"./avatar-detail.component-zX4Dmv_v.js";import{F as X}from"./slider.component-CsNrcCvZ.js";import"./button.component-lldnsmRG.js";import"./spinner.component-DPVRVwus.js";import"./tokens.catalog-DF_6rd51.js";import"./element-title.component-DxaCe8rP.js";import"./nav-layout.context-BCfFVc2u.js";import"./input-value-Co_u-z_8.js";function Y(t,a){if(t&1&&(i(0,"span",2),v(1,"fold-avatar",3),n()),t&2){const e=a.$implicit,o=a.$index,r=l();U("z-index",r.z(o)),s(),m("name",e.name)("imageUrl",e.imageUrl)("colorSeed",e.colorSeed)("size",r.size())("square",r.square())("variant",e.variant??"solid")("muted",e.muted??!1)("ring",e.ring??"none")("ringStyle",e.ringStyle??"solid")}}function Z(t,a){if(t&1&&(i(0,"span",1),c(1),n()),t&2){const e=l();E("title",e.overflow()+" more"),s(),k("+",e.overflow())}}class T{avatars=z.required();limit=z(0,{transform:B});top=z("first");size=z("md");square=z(!1,{transform:I});visible=b(()=>{const a=this.limit(),e=this.avatars();return a>0&&e.length>a?e.slice(0,a):e});overflow=b(()=>this.avatars().length-this.visible().length);z(a){const e=this.visible().length;return this.top()==="first"?e-a:a+1}static ɵfac=function(e){return new(e||T)};static ɵcmp=L({type:T,selectors:[["fold-avatar-list"]],hostVars:8,hostBindings:function(e,o){e&2&&C("size-sm",o.size()==="sm")("size-md",o.size()==="md")("size-lg",o.size()==="lg")("is-square",o.square())},inputs:{avatars:[1,"avatars"],limit:[1,"limit"],top:[1,"top"],size:[1,"size"],square:[1,"square"]},decls:3,vars:1,consts:[[1,"al-item",3,"z-index"],[1,"al-more"],[1,"al-item"],[3,"name","imageUrl","colorSeed","size","square","variant","muted","ring","ringStyle"]],template:function(e,o){e&1&&(f(0,Y,2,11,"span",0,q),x(2,Z,2,2,"span",1)),e&2&&(h(o.visible()),s(2),P(o.overflow()>0?2:-1))},dependencies:[O],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: inline-flex;
  align-items: center;

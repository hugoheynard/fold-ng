import{u as i,a0 as s,ap as c,a4 as f,ɵ as p,F as m,a1 as _,d,B as u,w as b,a2 as g,f as v,L as C,m as l,j as P,x as w,a8 as y,a9 as M,g as O}from"./index-BnABeB3j.js";const h=["btn"],x=["*"];function k(r,t){r&1&&O(0,"fold-icon",2),r&2&&l("name",t)}class a{disabled=i(!1,{transform:s});tone=i("default");icon=i();selected=c();btn=f("btn");get button(){return this.btn()?.nativeElement}focus(){this.btn()?.nativeElement.focus()}onClick(){this.disabled()||this.selected.emit()}static ɵfac=function(n){return new(n||a)};static ɵcmp=p({type:a,selectors:[["fold-dropdown-item"]],viewQuery:function(n,e){n&1&&y(e.btn,h,5),n&2&&M()},inputs:{disabled:[1,"disabled"],tone:[1,"tone"],icon:[1,"icon"]},outputs:{selected:"selected"},ngContentSelectors:x,decls:5,vars:4,consts:[["btn",""],["type","button","role","menuitem","tabindex","-1",1,"fdrop-item",3,"click","disabled"],["size","sm",1,"fdrop-item-icon",3,"name"],[1,"fdrop-item-label"]],template:function(n,e){if(n&1&&(_(),d(0,"button",1,0),u("click",function(){return e.onClick()}),b(2,k,1,1,"fold-icon",2),d(3,"span",3),g(4),v()()),n&2){let o;C("is-danger",e.tone()==="danger"),l("disabled",e.disabled()),P(2),w((o=e.icon())?2:-1,o)}},dependencies:[m],styles:[`[_nghost-%COMP%] {
  display: contents;
}

import{s as d,N as v,ɵ as P,R as k,c as x,a0 as C,b as T,a as B,d as t,g as _,e,f as n,T as p,w as u,h as L,j as a,m as h,L as A,H as c,x as g,n as F,Q as b,l as w,S as I,q as y,U as z,V as M,r as D}from"./index-DChvdols.js";import{D as R}from"./playground.component-DMiDfXiu.js";import{K as S}from"./kind-badge.component-B3lvqtL0.js";import{C as j}from"./composed-of.component-CvaM_m_R.js";import{FoldPageSectionComponent as N}from"./page-section.component-BcolPAny.js";import{F as V}from"./avatar.component-0x6Npsao.js";import{FoldButtonComponent as W}from"./button.component-DT9BwyiP.js";import{FoldCalloutComponent as E}from"./callout.component-TlgNKvej.js";import{FoldSliderComponent as H}from"./slider.component-Bt2ECN00.js";import"./element-title.component-DYH-EdbU.js";import"./spinner.component-m01_q-mA.js";import"./tokens.catalog-DF_6rd51.js";import"./input-value-Co_u-z_8.js";const K=()=>["icons"];function O(l,i){if(l&1){const s=I();t(0,"button",12),p("click",function(){z(s);const r=y();return M(r.showIcon.set(!r.showIcon()))}),e(1," icon "),n()}if(l&2){const s=y();c("is-on",s.showIcon())}}function U(l,i){l&1&&(t(0,"span",21),_(1,"fold-avatar",30),t(2,"span",31),e(3,"Acme Records "),t(4,"span",32),e(5,"· Workspace"),n()()())}function Y(l,i){l&1&&_(0,"fold-badge",22)}function q(l,i){l&1&&(t(0,"p",3),e(1,"Your company subscription and payment methods."),n())}function G(l,i){l&1&&(t(0,"button",23),e(1,"Export"),n())}function Q(l,i){l&1&&(t(0,"fold-page-section",26)(1,"fold-card",33)(2,"p",25),e(3," Bleed band — spans the layout edge-to-edge. It cancels "),t(4,"code"),e(5,"--fold-page-gutter"),n(),e(6," exactly (the same token the page pads with), so it stays flush against the dashed guides as you drag the slider. "),n()()())}class m{headerMode=d("title");showIcon=d(!0);showBadge=d(!1);showDesc=d(!0);showActions=d(!0);showBleed=d(!0);gutter=d(32);code=v(()=>{const i=[];if(this.headerMode()==="custom")i.push("<fold-page-layout>",'  <span pageTitle><fold-avatar name="Acme Records" size="sm" /> Acme Records</span>');else{const s=this.showIcon()?' icon="grid"':"";i.push(`<fold-page-layout${s} title="Billing">`)}return this.showBadge()&&i.push('  <fold-badge titleBadge content="Pro" variant="accent" />'),this.showDesc()&&i.push("  <p description>Your company subscription and payments.</p>"),this.showActions()&&i.push("  <button pageActions>Export</button>"),i.push('  <fold-page-section title="Payment methods">…</fold-page-section>'),this.showBleed()&&i.push("  <fold-page-section bleed>… edge-to-edge band …</fold-page-section>"),i.push('  <fold-page-section title="Invoices">…</fold-page-section>',"</fold-page-layout>"),i.join(`

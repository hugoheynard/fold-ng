import{s as d,B as v,ɵ as P,R as k,c as x,U as T,b as B,a as C,d as t,g as _,e,f as n,G as p,L as u,h as L,j as a,m as f,x as c,M as g,n as A,D as b,l as w,E as F,z as y,H as I,I as z,q as M}from"./index-Cs4RAhvM.js";import{D}from"./playground.component-UFtK8TZO.js";import{K as R}from"./kind-badge.component-DZ_qXGAu.js";import{F as j}from"./page-section.component-DUoYd75p.js";import{F as S}from"./avatar.component-Bgb_bddP.js";import{F as E}from"./button.component-DZwOUveU.js";import{F as W}from"./callout.component-VYj88C4s.js";import{F as N}from"./slider.component-DgCynd41.js";import"./element-title.component-C89KOlmP.js";import"./spinner.component-D8RT4Oy3.js";import"./tokens.catalog-DF_6rd51.js";import"./input-value-Co_u-z_8.js";function V(l,i){if(l&1){const s=F();t(0,"button",11),p("click",function(){I(s);const r=y();return z(r.showIcon.set(!r.showIcon()))}),e(1," icon "),n()}if(l&2){const s=y();c("is-on",s.showIcon())}}function G(l,i){l&1&&(t(0,"span",20),_(1,"fold-avatar",29),t(2,"span",30),e(3,"Acme Records "),t(4,"span",31),e(5,"· Workspace"),n()()())}function H(l,i){l&1&&_(0,"fold-badge",21)}function K(l,i){l&1&&(t(0,"p",2),e(1,"Your company subscription and payment methods."),n())}function U(l,i){l&1&&(t(0,"button",22),e(1,"Export"),n())}function Y(l,i){l&1&&(t(0,"fold-page-section",25)(1,"fold-card",32)(2,"p",24),e(3," Bleed band — spans the layout edge-to-edge. It cancels "),t(4,"code"),e(5,"--fold-page-gutter"),n(),e(6," exactly (the same token the page pads with), so it stays flush against the dashed guides as you drag the slider. "),n()()())}class m{headerMode=d("title");showIcon=d(!0);showBadge=d(!1);showDesc=d(!0);showActions=d(!0);showBleed=d(!0);gutter=d(32);code=v(()=>{const i=[];if(this.headerMode()==="custom")i.push("<fold-page-layout>",'  <span pageTitle><fold-avatar name="Acme Records" size="sm" /> Acme Records</span>');else{const s=this.showIcon()?' icon="grid"':"";i.push(`<fold-page-layout${s} title="Billing">`)}return this.showBadge()&&i.push('  <fold-badge titleBadge content="Pro" variant="accent" />'),this.showDesc()&&i.push("  <p description>Your company subscription and payments.</p>"),this.showActions()&&i.push("  <button pageActions>Export</button>"),i.push('  <fold-page-section title="Payment methods">…</fold-page-section>'),this.showBleed()&&i.push("  <fold-page-section bleed>… edge-to-edge band …</fold-page-section>"),i.push('  <fold-page-section title="Invoices">…</fold-page-section>',"</fold-page-layout>"),i.join(`

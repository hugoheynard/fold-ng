import{s as m,N as P,aB as V,a7 as q,ɵ as Q,c as K,bs as N,bt as U,bw as D,F as Z,d as r,g as M,T as d,e as a,f as l,w as y,i as h,K as F,j as s,m as v,L as G,H as b,x as w,o as k,k as C,aC as J,ar as W,q as c,S as x,l as S,v as j,Z as X,Q as H,U as _,V as f,$ as L}from"./index-CkL4IWB-.js";import{a as Y}from"./tokens.catalog-DF_6rd51.js";import{K as ee}from"./kind-badge.component-DbDfsiI-.js";import{C as oe}from"./composed-of.component-B7Ir9qTv.js";import{FoldContextCardComponent as ne}from"./context-card.component-Bzbw03Ig.js";import"./element-title.component-C8eHUCwK.js";function $(i,n){return{prop:Y(i),desc:n,kind:"color"}}function z(i,n){return{prop:`--fold-radius-${i}`,desc:n,kind:"radius"}}function te(i,n,e){const o={...i},t=e.trim();return t?o[n]=t:delete o[n],o}function ie(i,n){const e=Object.entries(n);if(e.length===0)return"/* adjust a token on the left to see the CSS here */";const o=[`${i} {`];for(const[t,u]of e)o.push(`  ${t}: ${u};`);return o.push("}"),o.join(`

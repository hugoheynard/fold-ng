import{u as t,v as l,ɵ as C,M,e as s,K as b,N as O,y as c,j as a,l as f,L as m,q as _,w as q,x as L,g as I,m as g,d as v,f as P,_ as y,Q as w,U as F,C as x,H as z,av as k}from"./index-CheKRm5v.js";import{r as B}from"./input-value-Co_u-z_8.js";function T(r,o){r&1&&(M(0,"span",0),s(1,"*"),O())}function j(r,o){if(r&1&&(M(0,"span",1),s(1),O()),r&2){const e=_();a(),f("(",e.optionalLabel(),")")}}class p{text=t.required();for=t();required=t(!1,{transform:l});optional=t(!1,{transform:l});optionalLabel=t("optional");static ɵfac=function(e){return new(e||p)};static ɵcmp=C({type:p,selectors:[["fold-label"]],inputs:{text:[1,"text"],for:[1,"for"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"]},decls:4,vars:3,consts:[["aria-hidden","true",1,"req"],[1,"opt"]],template:function(e,n){e&1&&(M(0,"label"),s(1),b(2,T,2,0,"span",0)(3,j,2,1,"span",1),O()),e&2&&(c("for",n.for()),a(),f("",n.text()," "),a(),m(n.required()?2:n.optional()?3:-1))},styles:[`[_nghost-%COMP%] {
  display: block;
}
...
}`]})}const E=["*"];function S(r,o){if(r&1&&I(0,"fold-label",0),r&2){const e=_();g("text",o)("for",e.for())("required",e.required())("optional",e.optional())("optionalLabel",e.optionalLabel())}}function H(r,o){if(r&1&&(v(0,"p",1),s(1),P()),r&2){const e=_();c("id",e.for()?e.for()+"-error":null),a(),f(" ",o," ")}}function V(r,o){if(r&1&&(v(0,"p",2),s(1),P()),r&2){const e=_();c("id",e.for()?e.for()+"-hint":null),a(),f(" ",o," ")}}class u{label=t();for=t();required=t(!1,{transform:l});optional=t(!1,{transform:l});optionalLabel=t("optional");hint=t();error=t();static ɵfac=function(e){return new(e||u)};static ɵcmp=C({type:u,selectors:[["fold-input-base"]],inputs:{label:[1,"label"],for:[1,"for"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],hint:[1,"hint"],error:[1,"error"]},ngContentSelectors:E,decls:4,vars:2,consts:[[3,"text","for","required","optional","optionalLabel"],["role","alert",1,"ib-msg","ib-error"],[1,"ib-msg","ib-hint"]],template:function(e,n){if(e&1&&(q(),b(0,S,1,5,"fold-label",0),L(1),b(2,H,2,2,"p",1)(3,V,2,2,"p",2)),e&2){let d,i;m((d=n.label())?0:-1,d),a(2),m((i=n.error())?2:(i=n.hint())?3:-1,i)}},dependencies:[p],styles:[`[_nghost-%COMP%] {
  display: flex;
...
.ib-error[_ngcontent-%COMP%] {
  color: var(--fold-color-alert-text);
}`]})}class h{value=y("");disabled=t(!1);touched=y(!1);errors=t([]);type=t("text");size=t("md");align=t("start");variant=t("default");label=t();required=t(!1,{transform:l});optional=t(!1,{transform:l});optionalLabel=t("optional");hint=t();placeholder=t("");readOnly=t(!1);autofocus=t(!1);autocomplete=t(null);inputId=w(F).next("fold-input");errorMessage=x(()=>{if(!this.touched())return;const o=this.errors()[0];return o?o.message??o.kind:void 0});describedBy=x(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);onInputChange(o){this.value.set(B(o))}onBlur(){this.touched.set(!0)}static ɵfac=function(e){return new(e||h)};static ɵcmp=C({type:h,selectors:[["fold-input"]],hostVars:2,hostBindings:function(e,n){e&2&&k(n.size()+" "+n.align()+" "+n.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],type:[1,"type"],size:[1,"size"],align:[1,"align"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],hint:[1,"hint"],placeholder:[1,"placeholder"],readOnly:[1,"readOnly"],autofocus:[1,"autofocus"],autocomplete:[1,"autocomplete"]},outputs:{value:"valueChange",touched:"touchedChange"},decls:2,vars:17,consts:[[3,"label","for","required","optional","optionalLabel","hint","error"],[3,"input","blur","id","value"]],template:function(e,n){e&1&&(v(0,"fold-input-base",0)(1,"input",1),z("input",function(i){return n.onInputChange(i)})("blur",function(){return n.onBlur()}),P()()),e&2&&(g("label",n.label())("for",n.inputId)("required",n.required())("optional",n.optional())("optionalLabel",n.optionalLabel())("hint",n.hint())("error",n.errorMessage()),a(),g("id",n.inputId)("value",n.value()),c("type",n.type())("placeholder",n.placeholder())("readonly",n.readOnly()||null)("disabled",n.disabled()||null)("required",n.required()||null)("aria-invalid",n.errorMessage()?!0:null)("aria-describedby",n.describedBy())("autocomplete",n.autocomplete()))},dependencies:[u],styles:[`[_nghost-%COMP%] {
  display: block;
}

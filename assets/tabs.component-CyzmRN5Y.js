import{u as r,W as x,am as y,a1 as _,N as h,ac as w,aK as k,ɵ as F,F as T,a as z,d as s,T as m,i as K,f as d,H as v,Z as C,j as l,o as A,aC as S,ar as $,S as B,w as p,e as u,q as c,m as g,x as f,k as O,g as P,U as I,V as j}from"./index-DChvdols.js";import{F as D}from"./nav-layout.context-C76YqwGQ.js";const V=["tabBtn"],q=(o,e)=>e.key;function U(o,e){o&1&&P(0,"fold-icon",4),o&2&&g("name",e)}function E(o,e){if(o&1&&(s(0,"span",5),u(1),d()),o&2){const t=c().$implicit;l(),O(t.label.charAt(0))}}function L(o,e){if(o&1&&P(0,"fold-badge",7),o&2){const t=c().$implicit,n=c();g("content",t.badge+"")("variant",n.activeKey()===t.key?"accent":"neutral")}}function Q(o,e){if(o&1){const t=B();s(0,"button",3,0),m("click",function(){const a=I(t).$implicit,i=c();return j(i.select(a.key))}),p(2,U,1,1,"fold-icon",4)(3,E,2,1,"span",5),s(4,"span",6),u(5),d(),p(6,L,1,2,"fold-badge",7),d()}if(o&2){let t;const n=e.$implicit,a=c();v("is-active",a.activeKey()===n.key),g("id",a.tabId(n.key))("tabindex",a.activeKey()===n.key?0:-1),C("aria-selected",a.activeKey()===n.key)("aria-controls",a.panelId(n.key)),l(2),f((t=n.icon)?2:a.collapsed()?3:-1,t),l(3),O(n.label),l(),f(n.badge!==void 0&&n.badge!==null?6:-1)}}class b{tabs=r.required();activeKey=r.required();activeStyle=r("underline");direction=r("auto");size=r("compact");collapsed=r(!1,{transform:x});background=r("surface");tabChange=y();layout=_(D,{optional:!0});resolvedDirection=h(()=>{const e=this.direction();return e!=="auto"?e:this.layout?.stacked()?"horizontal":"vertical"});uid=_(w).next("fold-tabs");tabButtons=k("tabBtn");tabId(e){return`${this.uid}-tab-${e}`}panelId(e){return`${this.uid}-panel-${e}`}select(e){this.tabChange.emit(e)}onKeydown(e){const t=this.tabs().map(M=>M.key);if(t.length===0)return;const n=t.indexOf(this.activeKey());let a;switch(e.key){case"ArrowRight":case"ArrowDown":a=(n+1)%t.length;break;case"ArrowLeft":case"ArrowUp":a=(n-1+t.length)%t.length;break;case"Home":a=0;break;case"End":a=t.length-1;break;default:return}e.preventDefault();const i=t[a];i!==void 0&&(this.tabChange.emit(i),this.tabButtons()[a]?.nativeElement.focus())}static ɵfac=function(t){return new(t||b)};static ɵcmp=F({type:b,selectors:[["fold-tabs"]],viewQuery:function(t,n){t&1&&S(n.tabButtons,V,5),t&2&&$()},inputs:{tabs:[1,"tabs"],activeKey:[1,"activeKey"],activeStyle:[1,"activeStyle"],direction:[1,"direction"],size:[1,"size"],collapsed:[1,"collapsed"],background:[1,"background"]},outputs:{tabChange:"tabChange"},exportAs:["foldTabs"],decls:3,vars:13,consts:[["tabBtn",""],["role","tablist",1,"tab-bar",3,"keydown"],["type","button","role","tab",1,"tab-bar-item",3,"id","is-active","tabindex"],["type","button","role","tab",1,"tab-bar-item",3,"click","id","tabindex"],["size","sm",1,"tab-bar-icon",3,"name"],["aria-hidden","true",1,"tab-bar-icon","tab-bar-initial"],[1,"tab-bar-label"],[1,"tab-bar-badge",3,"content","variant"]],template:function(t,n){t&1&&(s(0,"div",1),m("keydown",function(i){return n.onKeydown(i)}),K(1,Q,7,9,"button",2,q),d()),t&2&&(v("style-underline",n.activeStyle()==="underline")("style-fill",n.activeStyle()==="fill")("dir-vertical",n.resolvedDirection()==="vertical")("size-comfortable",n.size()==="comfortable")("is-collapsed",n.collapsed())("bg-surface",n.background()==="surface"),C("aria-orientation",n.resolvedDirection()==="vertical"?"vertical":"horizontal"),l(),A(n.tabs()))},dependencies:[T,z],styles:[`@charset "UTF-8";

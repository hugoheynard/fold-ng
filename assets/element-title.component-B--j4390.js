import{x as t,y as g,ɵ as v,F as u,L as C,I as p,d as r,e as m,f as a,N as x,J as _,j as l,P as b,k as f,D as y,g as h,q as P,m as M}from"./index-BvVl1tCV.js";const O=[[["","titleAction",""]]],T=["[titleAction]"];function w(i,o){if(i&1&&(r(0,"span",0),h(1,"fold-icon",6),a()),i&2){const e=P();l(),M("name",o)("size",e.iconSize())}}function z(i,o){i&1&&(r(0,"span",5),m(1),a()),i&2&&(l(),f(o))}class s{icon=t();iconTone=t("neutral");title=t.required();subtitle=t();variant=t("eyebrow");level=t(2);headingId=t();iconSize=g(()=>this.variant()==="title"?"md":"sm");static ɵfac=function(e){return new(e||s)};static ɵcmp=v({type:s,selectors:[["fold-element-title"]],hostVars:8,hostBindings:function(e,n){e&2&&y("v-bar",n.variant()==="bar")("v-title",n.variant()==="title")("it-primary",n.iconTone()==="primary")("it-faded",n.iconTone()==="faded")},inputs:{icon:[1,"icon"],iconTone:[1,"iconTone"],title:[1,"title"],subtitle:[1,"subtitle"],variant:[1,"variant"],level:[1,"level"],headingId:[1,"headingId"]},ngContentSelectors:T,decls:8,vars:5,consts:[[1,"et-icon"],[1,"et-main"],[1,"et-row"],["role","heading",1,"et-label"],[1,"et-action"],[1,"et-sub"],[3,"name","size"]],template:function(e,n){if(e&1&&(C(O),p(0,w,2,2,"span",0),r(1,"span",1)(2,"span",2)(3,"span",3),m(4),a(),r(5,"span",4),x(6),a()(),p(7,z,2,1,"span",5),a()),e&2){let c,d;_((c=n.icon())?0:-1,c),l(3),b("id",n.headingId())("aria-level",n.level()),l(),f(n.title()),l(3),_((d=n.subtitle())?7:-1,d)}},dependencies:[u],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: flex;
  align-items: center;
  gap: 12px;

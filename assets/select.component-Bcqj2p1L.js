import{ag as d,u as e,a0 as c,X as f,ah as b,A as u,ɵ as m,F as h,a1 as C,d as _,B as M,w as O,a2 as P,f as a,g as v,m as p,j as i,D as y,x,aj as w,e as k,k as z}from"./index-DB23AmO7.js";import{FoldInputBaseComponent as L}from"./input-base.component-Cm3vywKc.js";import{r as F}from"./input-value-DCGlOvqF.js";import"./info.component-BUVMv2cZ.js";import"./popover.component-WHkbzmc2.js";import"./popover-trigger.directive-CMRPTX57.js";import"./label.component-AT5ZoIs3.js";const I=["*"];function q(s,t){s&1&&(_(0,"option",3),k(1),a()),s&2&&(i(),z(t))}class l{value=d("");disabled=e(!1);touched=d(!1);errors=e([]);size=e("md");variant=e("default");label=e();required=e(!1,{transform:c});optional=e(!1,{transform:c});optionalLabel=e("optional");info=e();infoLabel=e("More information");hint=e();placeholder=e();inputId=f(b).next("fold-select");errorMessage=u(()=>{if(!this.touched())return;const t=this.errors()[0];return t?t.message??t.kind:void 0});describedBy=u(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);onChange(t){this.value.set(F(t))}onBlur(){this.touched.set(!0)}static ɵfac=function(o){return new(o||l)};static ɵcmp=m({type:l,selectors:[["fold-select"]],hostVars:2,hostBindings:function(o,n){o&2&&w(n.size()+" "+n.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],size:[1,"size"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],info:[1,"info"],infoLabel:[1,"infoLabel"],hint:[1,"hint"],placeholder:[1,"placeholder"]},outputs:{value:"valueChange",touched:"touchedChange"},ngContentSelectors:I,decls:6,vars:16,consts:[[3,"label","for","required","optional","optionalLabel","info","infoLabel","hint","error"],[1,"sel-wrap"],[1,"sel",3,"change","blur","id","disabled","value"],["value","","disabled","","hidden",""],["name","chevron-down","size","sm","aria-hidden","true",1,"sel-caret"]],template:function(o,n){if(o&1&&(C(),_(0,"fold-input-base",0)(1,"div",1)(2,"select",2),M("change",function(g){return n.onChange(g)})("blur",function(){return n.onBlur()}),O(3,q,2,1,"option",3),P(4),a(),v(5,"fold-icon",4),a()()),o&2){let r;p("label",n.label())("for",n.inputId)("required",n.required())("optional",n.optional())("optionalLabel",n.optionalLabel())("info",n.info())("infoLabel",n.infoLabel())("hint",n.hint())("error",n.errorMessage()),i(2),p("id",n.inputId)("disabled",n.disabled())("value",n.value()),y("required",n.required()||null)("aria-invalid",n.errorMessage()?!0:null)("aria-describedby",n.describedBy()),i(),x((r=n.placeholder())?3:-1,r)}},dependencies:[L,h],styles:[`@charset "UTF-8";

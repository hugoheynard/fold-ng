import{x as e,y as r,ɵ as s,M as d,e as l,O as c,P as u,j as i,k as f}from"./index-89CG8o_m.js";class o{status=e.required();label=e("");normalizedStatus=r(()=>{const t=this.status();return t==="connected"?"active":t==="error"?"suspended":t==="not_connected"?"coming-soon":t});static ɵfac=function(n){return new(n||o)};static ɵcmp=s({type:o,selectors:[["fold-status-badge"]],inputs:{status:[1,"status"],label:[1,"label"]},decls:2,vars:2,consts:[[1,"badge"]],template:function(n,a){n&1&&(d(0,"span",0),l(1),c()),n&2&&(u("data-status",a.normalizedStatus()),i(),f(a.label()||a.status()))},styles:[`@charset "UTF-8";

import{s as c,A as _,ɵ as T,c as C,E as L,d as n,e,f as t,g as P,B as s,i as v,T as y,j as i,m as r,U as $,L as p,o as w,l as F,k as I,N as f,a3 as h,O as k}from"./index-DlGy65Dl.js";import{K as S}from"./kind-badge.component-VOhnntRN.js";import{C as V}from"./composed-of.component-DNlflmzI.js";import{D as B}from"./playground.component-CA9FErek.js";import{FoldPageSectionComponent as j}from"./page-section.component-Dk0xPX3a.js";import{FoldLinkComponent as D}from"./link.component-BLZcPMm2.js";import"./button.component-DYB0JDdo.js";import"./element-title.component-Bi-Qgtxn.js";import"./slider.component-dAcJRwW9.js";import"./input-value-DCGlOvqF.js";const E=()=>["icons"];function H(g,a){if(g&1&&(n(0,"option",14),e(1),t()),g&2){const l=a.$implicit;r("value",l),i(),I(l)}}function N(g,a){if(g&1&&(n(0,"option",14),e(1),t()),g&2){const l=a.$implicit;r("value",l),i(),I(l)}}class b{demoHref="https://fold.sh3pherd.dev/docs";leadingIcons=["none","arrow-back","company","contracts","download","folder-open","globe","mail"];trailingIcons=["none","chevron-right","arrow-right","globe","download"];label=c("View the organisation");tone=c("accent");mode=c("button");leadingIcon=c("company");trailingIcon=c("chevron-right");disabled=c(!1);leading=_(()=>this.leadingIcon()==="none"?void 0:this.leadingIcon());trailing=_(()=>this.trailingIcon()==="none"?void 0:this.trailingIcon());linkCode=_(()=>{const a=[];this.tone()!=="accent"&&a.push(`tone="${this.tone()}"`),this.leading()&&a.push(`icon="${this.leading()}"`),this.trailing()&&a.push(`trailingIcon="${this.trailing()}"`),this.mode()==="anchor"?a.push(`href="${this.demoHref}"`):(a.push('(clicked)="onClick()"'),this.disabled()&&a.push('[disabled]="true"'));const l=a.length>0?["<fold-link",...a.map(u=>`  ${u}`),">"].join(`

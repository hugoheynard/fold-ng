import{ag as a,u as e,aF as p,a0 as l,X as c,ah as g,A as s,ɵ as _,d as b,B as f,f as m,m as i,j as h,D as C,aj as M}from"./index-F5cuq_px.js";import{FoldInputBaseComponent as O}from"./input-base.component-4hwGqGOj.js";import{r as P}from"./input-value-DCGlOvqF.js";import"./label.component-BCfg6XDt.js";class r{value=a("");disabled=e(!1);touched=a(!1);errors=e([]);rows=e(3,{transform:p});size=e("md");variant=e("default");label=e();required=e(!1,{transform:l});optional=e(!1,{transform:l});optionalLabel=e("optional");hint=e();placeholder=e("");readOnly=e(!1);inputId=c(g).next("fold-textarea");errorMessage=s(()=>{if(!this.touched())return;const t=this.errors()[0];return t?t.message??t.kind:void 0});describedBy=s(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);onInputChange(t){this.value.set(P(t))}onBlur(){this.touched.set(!0)}static ɵfac=function(o){return new(o||r)};static ɵcmp=_({type:r,selectors:[["fold-textarea"]],hostVars:2,hostBindings:function(o,n){o&2&&M(n.size()+" "+n.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],rows:[1,"rows"],size:[1,"size"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],hint:[1,"hint"],placeholder:[1,"placeholder"],readOnly:[1,"readOnly"]},outputs:{value:"valueChange",touched:"touchedChange"},decls:2,vars:16,consts:[[3,"label","for","required","optional","optionalLabel","hint","error"],[3,"input","blur","id","value"]],template:function(o,n){o&1&&(b(0,"fold-input-base",0)(1,"textarea",1),f("input",function(u){return n.onInputChange(u)})("blur",function(){return n.onBlur()}),m()()),o&2&&(i("label",n.label())("for",n.inputId)("required",n.required())("optional",n.optional())("optionalLabel",n.optionalLabel())("hint",n.hint())("error",n.errorMessage()),h(),i("id",n.inputId)("value",n.value()),C("rows",n.rows())("placeholder",n.placeholder())("readonly",n.readOnly()||null)("disabled",n.disabled()||null)("required",n.required()||null)("aria-invalid",n.errorMessage()?!0:null)("aria-describedby",n.describedBy()))},dependencies:[O],styles:[`@charset "UTF-8";

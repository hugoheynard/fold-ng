const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/home.page-ju9Ha26S.js","assets/aside-layout.component-BJCgkNA8.js","assets/avatar-detail.component-czOb3ai6.js","assets/disclosure.component-QmduDLim.js","assets/button.component-BDGNacMK.js","assets/spinner.component-1OwcU9YF.js","assets/tokens.catalog-DF_6rd51.js","assets/callout.component-BkIxkK-P.js","assets/hero-section.component-CrFBJ1E2.js","assets/page-section.component-xyIc1sNl.js","assets/element-title.component-BJbdLGww.js","assets/hero-card.page-BO2I8qYC.js","assets/kind-badge.component-B1sofT1E.js","assets/sticky-column.page-CZrOKzmh.js","assets/playground.component-DOMSqzUD.js","assets/slider.component-DQXTNgby.js","assets/input-value-Co_u-z_8.js","assets/aside-layout.page-Bldb59Av.js","assets/tab-layout.page-DFcxAEq1.js","assets/tab-layout.component-DDLwu_bz.js","assets/tab-nav.component-Bnkr_j3K.js","assets/page-layout.page-BtHWfpZa.js","assets/tab-nav.page-er5Zf-JG.js","assets/tab-panel.component-DTosfYxQ.js","assets/page-section.page-CI-eMImC.js","assets/hero-section.page-CDnDNdRv.js","assets/card.page-C7zv7vLy.js","assets/button.page-H54GsqEi.js","assets/button-icon.page-BynGlE5l.js","assets/link.page-DXRRuQ1e.js","assets/link.component-BXRzzflH.js","assets/element-title.page-CFouBFR1.js","assets/context-card.page-eIHN3lh0.js","assets/context-card.component-BzJG1AIR.js","assets/badges.page-D3p-3j_C.js","assets/status-badge.component-BNtuEpnJ.js","assets/field.page-BpQqdMUG.js","assets/timeline.page-DM4dCm81.js","assets/form-layout.page-BWrVkkE_.js","assets/input.component-C5r7V7tC.js","assets/choice-row.component-BU0rwFAS.js","assets/dropzone.page-BY9Bl0N_.js","assets/toast.page-C-awkK71.js","assets/callout.page-Ive-et70.js","assets/disclosure.page-CUO9dZHr.js","assets/state.page-BMchweQs.js","assets/icons.page-KmbbFpk0.js","assets/spinner.page-BSt_4NFW.js","assets/repeat-press.page-BEvpk9c7.js","assets/repeat-press.directive-BtouNlCR.js","assets/themes.page-BvJMBiD6.js","assets/form.page-iyErtl3v.js","assets/avatar.page-BlWATORo.js","assets/app-shell.page-D3Hy3H0E.js","assets/menu.page-DaHkslL4.js","assets/nav-launcher.page-CDZ31y1p.js"])))=>i.map(i=>d[i]);
...
}`]})}class At{document=p(Se);locks=0;previousOverflow="";lock(){this.locks===0&&(this.previousOverflow=this.document.body.style.overflow,this.document.body.style.overflow="hidden"),this.locks+=1}unlock(){this.locks!==0&&(this.locks-=1,this.locks===0&&(this.document.body.style.overflow=this.previousOverflow))}get isLocked(){return this.locks>0}static ɵfac=function(t){return new(t||At)};static ɵprov=ne({token:At,factory:At.ɵfac})}class Gt{icon=w.required();label=w.required();variant=w("surface");active=w(!1,{transform:Je});static ɵfac=function(t){return new(t||Gt)};static ɵcmp=le({type:Gt,selectors:[["a","fold-nav-tile",""],["button","fold-nav-tile",""]],hostAttrs:[1,"fold-nav-tile"],hostVars:5,hostBindings:function(t,o){t&2&&(se("aria-current",o.active()?"page":null),ve("is-filled",o.variant()==="filled")("is-active",o.active()))},inputs:{icon:[1,"icon"],label:[1,"label"],variant:[1,"variant"],active:[1,"active"]},decls:3,vars:3,consts:[[1,"nt-icon",3,"name","size"],[1,"nt-label"]],template:function(t,o){t&1&&(N(0,"fold-icon",0),m(1,"span",1),E(2),v()),t&2&&(O("name",o.icon())("size",26),b(2),Fe(o.label()))},dependencies:[$e],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
...
}`]})}const v5=["*"];function b5(e,n){if(e&1){const t=Ae();m(0,"div",0),z("click",function(){re(t);const r=k();return ie(r.close())}),v(),m(1,"div",1)(2,"button",2),z("click",function(){re(t);const r=k();return ie(r.close())}),N(3,"fold-icon",3),v(),m(4,"div",4),oe(5),v()()}if(e&2){const t=k();b(),O("foldFocusTrap",t.open()),se("aria-label",t.label()),b(3),Pn("--nav-cols",t.resolvedCols())}}class yi{open=Qi(!1);label=w("Navigation");columns=w("auto");tiles=$p(Gt);resolvedCols=q(()=>{const n=this.columns();return n!=="auto"?n:this.tiles().length<=4?2:3});scrollLock=p(At);locked=!1;constructor(){bt(()=>{const n=this.open();n&&!this.locked?(this.scrollLock.lock(),this.locked=!0):!n&&this.locked&&(this.scrollLock.unlock(),this.locked=!1)}),p(an).onDestroy(()=>{this.locked&&(this.scrollLock.unlock(),this.locked=!1)})}onEscape(){this.open()&&this.open.set(!1)}close(){this.open.set(!1)}static ɵfac=function(t){return new(t||yi)};static ɵcmp=le({type:yi,selectors:[["fold-nav-launcher"]],contentQueries:function(t,o,r){t&1&&nc(r,o.tiles,Gt,4),t&2&&tc()},hostBindings:function(t,o){t&1&&z("keydown.escape",function(){return o.onEscape()},bl)},inputs:{open:[1,"open"],label:[1,"label"],columns:[1,"columns"]},outputs:{open:"openChange"},ngContentSelectors:v5,decls:1,vars:1,consts:[["aria-hidden","true",1,"nl-scrim",3,"click"],["role","dialog","aria-modal","true","tabindex","-1",1,"nl-dialog",3,"foldFocusTrap"],["type","button","aria-label","Close navigation",1,"nl-close",3,"click"],["name","close","size","md"],[1,"nl-grid"]],template:function(t,o){t&1&&(Bn(),W(0,b5,6,4)),t&2&&Q(o.open()?0:-1)},dependencies:[$t,$e],styles:[`@charset "UTF-8";

import{s as u,A as L,ɵ as C,c as T,b as k,d as e,g as S,e as a,f as t,B as m,h,w as _,j as l,m as p,L as c,n as y,x as g,W,E as b,q as f,N as q,r as x,O as w}from"./index-D0Jqges4.js";import{D as A}from"./playground.component-DvUKdOwi.js";import{K as P}from"./kind-badge.component-DOeZDWfy.js";import{FoldAsideLayoutComponent as E}from"./aside-layout.component-CU_d7ZeT.js";import{FoldSliderComponent as O}from"./slider.component-CrSJ-tjt.js";import"./button.component-CpxmwwTm.js";import"./element-title.component-CJYRIjVW.js";import"./page-section.component-ClR5uC60.js";import"./input-value-DCGlOvqF.js";function R(r,d){if(r&1){const o=b();e(0,"fold-slider",20),h("valueChange",function(s){q(o);const n=f();return x(n.aslRailWidth,s)||(n.aslRailWidth=s),w(s)}),t()}if(r&2){const o=f();p("min",0)("max",360)("step",10)("valueText",o.aslRailWidth()+"px"),y("value",o.aslRailWidth)}}function F(r,d){if(r&1){const o=b();e(0,"fold-slider",21),h("valueChange",function(s){q(o);const n=f();return x(n.aslSideWidth,s)||(n.aslSideWidth=s),w(s)}),t()}if(r&2){const o=f();p("min",0)("max",400)("step",10)("valueText",o.aslSideWidth()+"px"),y("value",o.aslSideWidth)}}function D(r,d){r&1&&(e(0,"fold-card",12)(1,"span",5),a(2,"On this page"),t(),e(3,"nav",22)(4,"a",23),a(5,"Overview"),t(),e(6,"a"),a(7,"Terms"),t(),e(8,"a"),a(9,"Signatures"),t()()())}class v{aslLeft=u(!1);aslEqual=u(!1);aslOffset=u(8);aslRailWidth=u(220);aslSideWidth=u(300);asideLayoutCode=L(()=>{const d=this.aslLeft(),o=this.aslOffset();return[o===24?"<fold-aside-layout>":`<fold-aside-layout [topOffset]="${o}">`,...d?["  <app-timeline asideLeft />"]:[],"  <!-- untagged elements → centre column -->","  <app-header />",'  <fold-page-section title="…">…</fold-page-section>',"  <!-- tag each rail element -->","  <app-history asideRight />","  <app-actions asideRight />","</fold-aside-layout>"].join(`

import{w as c,b0 as g,ɵ as h,L as r,i as v,N as a,C as d,O as _,j as i,o as C,A as b,aQ as y,D as x,q as s,E as w,e as p,H as O,k as u,I as P}from"./index-UW4on9BG.js";const M=(e,t)=>t.key;function k(e,t){if(e&1&&(r(0,"span",3),p(1),a()),e&2){const o=s().$implicit;i(),u(o.count)}}function F(e,t){if(e&1){const o=b();r(0,"button",2),y("click",function(){const f=x(o).$implicit,m=s();return w(m.selected.emit(f.key))}),r(1,"span"),p(2),a(),O(3,k,2,1,"span",3),a()}if(e&2){const o=t.$implicit,n=s();d("is-active",n.activeKey()===o.key),_("aria-pressed",n.activeKey()===o.key),i(2),u(o.label),i(),P(o.count!==void 0?3:-1)}}class l{options=c.required();activeKey=c.required();layout=c("segmented");ariaLabel=c("");selected=g();static ɵfac=function(o){return new(o||l)};static ɵcmp=h({type:l,selectors:[["fold-choice-row"]],inputs:{options:[1,"options"],activeKey:[1,"activeKey"],layout:[1,"layout"],ariaLabel:[1,"ariaLabel"]},outputs:{selected:"selected"},decls:3,vars:5,consts:[["role","group",1,"choice-row"],["type","button",1,"choice",3,"is-active"],["type","button",1,"choice",3,"click"],[1,"choice-count"]],template:function(o,n){o&1&&(r(0,"div",0),v(1,F,4,5,"button",1,M),a()),o&2&&(d("segmented",n.layout()==="segmented")("chips",n.layout()==="chips"),_("aria-label",n.ariaLabel()||null),i(),C(n.options()))},styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: block;
}

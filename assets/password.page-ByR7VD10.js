import{s as u,A as k,ɵ as y,c as x,d as o,e,f as a,g as T,B as c,w as O,j as s,m as f,U as F,L as p,k as v,x as M,E as b,h,i as R,a3 as j,q as _,n as P,o as z,N as m,r as C,O as g}from"./index-CIc5CrZt.js";import{K as N}from"./kind-badge.component-DZaWYdp9.js";import{C as A}from"./composed-of.component-qqpGjP_A.js";import{D as B}from"./playground.component-CAnDTZG2.js";import{FoldPageSectionComponent as E}from"./page-section.component-CjAHqOrD.js";import{FoldPasswordFieldComponent as S}from"./password-field.component-DzknT1fn.js";import"./button.component-DAVw1Tm9.js";import"./element-title.component-CduUJ-L9.js";import"./slider.component-WJl0m6w0.js";import"./input-value-DCGlOvqF.js";import"./input.component-D22s85l2.js";import"./input-base.component-kLtDnmW0.js";import"./info.component-C7l6k129.js";import"./common-labels-yHlYqMcr.js";import"./popover.component-A59XZnem.js";import"./auto-update-_srfpL1Q.js";import"./popover-trigger.directive-bilJHtrn.js";import"./label.component-BngEyOea.js";const V=()=>["form","icons"],I=(d,t)=>t.label;function L(d,t){if(d&1&&(o(0,"span",20),e(1),a()),d&2){const n=t.$implicit;p("is-met",n.met),s(),v(n.label)}}function W(d,t){if(d&1){const n=b();o(0,"fold-password-field",17,0),h("valueChange",function(l){m(n);const i=_();return C(i.value,l)||(i.value=l),g(l)}),c("validChange",function(l){m(n);const i=_();return g(i.valid.set(l))}),o(2,"div",18),R(3,L,2,3,"span",19,I),a()()}if(d&2){const n=j(1),r=_();f("revealable",r.revealable()),P("value",r.value),s(3),z(n.checklist())}}function q(d,t){if(d&1){const n=b();o(0,"fold-password-field",21),h("valueChange",function(l){m(n);const i=_();return C(i.value,l)||(i.value=l),g(l)}),c("validChange",function(l){m(n);const i=_();return g(i.valid.set(l))}),a()}if(d&2){const n=_();f("marker",n.design()==="ticks"?"check":"dot")("revealable",n.revealable()),P("value",n.value)}}class w{value=u("");valid=u(!1);revealable=u(!0);design=u("default");rulesExample=["import { foldRegexRule, type FoldPasswordRule } from 'fold-ng';","","rules: FoldPasswordRule[] = [","  { label: 'At least 12 characters', test: (v) => v.length >= 12 },","  foldRegexRule('A symbol', /[^A-Za-z0-9]/),","  // zod (no dependency added by fold-ng):","  { label: 'Valid', test: (v) => schema.safeParse(v).success },","];"].join(`

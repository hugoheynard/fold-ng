import{ag as p,u as e,a0 as i,X as m,ah as v,A as a,s as C,ɵ as O,F as M,d as g,B as b,f as s,w as P,m as r,j as d,L as y,D as f,x,aj as w,E as I,g as k,q as _,N as L,O as z}from"./index-F5cuq_px.js";import{FoldInputBaseComponent as F}from"./input-base.component-4hwGqGOj.js";import{r as q}from"./input-value-DCGlOvqF.js";import"./label.component-BCfg6XDt.js";function B(c,o){if(c&1){const t=I();g(0,"button",4),b("click",function(){L(t);const l=_();return z(l.toggleReveal())}),k(1,"fold-icon",5),s()}if(c&2){const t=_();r("disabled",t.disabled()||t.readOnly()),f("aria-label",t.revealAria())("aria-pressed",t.revealed()),d(),r("name",t.revealed()?"eye-off":"eye")}}class u{value=p("");disabled=e(!1);touched=p(!1);errors=e([]);type=e("text");revealable=e(!1,{transform:i});revealLabel=e("Show password");hideLabel=e("Hide password");size=e("md");align=e("start");variant=e("default");label=e();required=e(!1,{transform:i});optional=e(!1,{transform:i});optionalLabel=e("optional");hint=e();placeholder=e("");readOnly=e(!1);autofocus=e(!1);autocomplete=e(null);inputId=m(v).next("fold-input");errorMessage=a(()=>{if(!this.touched())return;const o=this.errors()[0];return o?o.message??o.kind:void 0});describedBy=a(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);revealed=C(!1);showReveal=a(()=>this.revealable()&&this.type()==="password");effectiveType=a(()=>this.showReveal()&&this.revealed()?"text":this.type());revealAria=a(()=>this.revealed()?this.hideLabel():this.revealLabel());toggleReveal(){this.revealed.update(o=>!o)}onInputChange(o){this.value.set(q(o))}onBlur(){this.touched.set(!0)}static ɵfac=function(t){return new(t||u)};static ɵcmp=O({type:u,selectors:[["fold-input"]],hostVars:2,hostBindings:function(t,n){t&2&&w(n.size()+" "+n.align()+" "+n.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],type:[1,"type"],revealable:[1,"revealable"],revealLabel:[1,"revealLabel"],hideLabel:[1,"hideLabel"],size:[1,"size"],align:[1,"align"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],hint:[1,"hint"],placeholder:[1,"placeholder"],readOnly:[1,"readOnly"],autofocus:[1,"autofocus"],autocomplete:[1,"autocomplete"]},outputs:{value:"valueChange",touched:"touchedChange"},decls:4,vars:20,consts:[[3,"label","for","required","optional","optionalLabel","hint","error"],[1,"in-field"],[3,"input","blur","id","value"],["type","button",1,"in-reveal",3,"disabled"],["type","button",1,"in-reveal",3,"click","disabled"],["size","sm","aria-hidden","true",3,"name"]],template:function(t,n){t&1&&(g(0,"fold-input-base",0)(1,"div",1)(2,"input",2),b("input",function(h){return n.onInputChange(h)})("blur",function(){return n.onBlur()}),s(),P(3,B,2,4,"button",3),s()()),t&2&&(r("label",n.label())("for",n.inputId)("required",n.required())("optional",n.optional())("optionalLabel",n.optionalLabel())("hint",n.hint())("error",n.errorMessage()),d(2),y("has-reveal",n.showReveal()),r("id",n.inputId)("value",n.value()),f("type",n.effectiveType())("placeholder",n.placeholder())("readonly",n.readOnly()||null)("disabled",n.disabled()||null)("required",n.required()||null)("aria-invalid",n.errorMessage()?!0:null)("aria-describedby",n.describedBy())("autocomplete",n.autocomplete()),d(),x(n.showReveal()?3:-1))},dependencies:[F,M],styles:[`@charset "UTF-8";

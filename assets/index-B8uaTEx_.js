const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/home.page-DxU1ul0M.js","assets/aside-layout.component-D8JMp4sG.js","assets/avatar-detail.component-CvowTX8h.js","assets/disclosure.component-BEEe3gTh.js","assets/button.component-POusVvsd.js","assets/spinner.component-Cl30tpVh.js","assets/tokens.catalog-DF_6rd51.js","assets/callout.component-DqMFvN6J.js","assets/hero-section.component-BGtzRmDe.js","assets/page-section.component-Dx00YMLb.js","assets/element-title.component-CicYmmZ6.js","assets/hero-card.page-CL5nwXXa.js","assets/kind-badge.component-Bu_BWmXE.js","assets/sticky-column.page-Ch1NEQFy.js","assets/playground.component-C8MEFrFB.js","assets/slider.component-CnksK7Of.js","assets/input-value-Co_u-z_8.js","assets/aside-layout.page-scaDxWu2.js","assets/tab-layout.page-DpB03dNM.js","assets/nav-layout.component-BDiIbHIj.js","assets/view-nav.component-B64ftKNQ.js","assets/page-layout.page-DbzJW1zu.js","assets/tab-nav.page-CRr2gFEZ.js","assets/tab-panel.component-Cr7638eW.js","assets/page-section.page-NoFQQ8b6.js","assets/hero-section.page-8uXLSMRg.js","assets/card.page-CDOshx2L.js","assets/button.page-BPc6GHBU.js","assets/button-icon.page-DJ_us-cq.js","assets/link.page-RfK_tkh3.js","assets/link.component-CdPpqDw0.js","assets/element-title.page-5U-kBrkB.js","assets/context-card.page-DfsKgLNT.js","assets/context-card.component-B59SRpDu.js","assets/badges.page-BKFFwu65.js","assets/status-badge.component-CNymxDVK.js","assets/field.page-CFuwUpTM.js","assets/timeline.page-CQokCZty.js","assets/form-layout.page-D4HZPX30.js","assets/input.component-CNgoxpf3.js","assets/choice-row.component-BhHl8Y4W.js","assets/dropzone.page-1CgSIMvZ.js","assets/toast.page-CV2T4XxA.js","assets/callout.page-D5KulPyF.js","assets/disclosure.page-DzJYgO6W.js","assets/state.page-BlMDYTky.js","assets/icons.page-DEXKxyK3.js","assets/spinner.page-C9UT9FYo.js","assets/repeat-press.page-C47vdK4s.js","assets/repeat-press.directive-CE8Lq6Qx.js","assets/themes.page-DZ0YgncS.js","assets/form.page-SIzpwWLS.js","assets/avatar.page-D_2RHYIZ.js","assets/app-shell.page-DqpQV2ce.js","assets/menu.page-BkDKpL3i.js","assets/nav-launcher.page-8TW3a4iv.js"])))=>i.map(i=>d[i]);
...
}`]})}const v5=["*"];function b5(e,n){if(e&1){const t=Ae();m(0,"div",0),z("click",function(){ie(t);const r=k();return se(r.close())}),v(),m(1,"div",1)(2,"button",2),z("click",function(){ie(t);const r=k();return se(r.close())}),N(3,"fold-icon",3),v(),m(4,"div",4),re(5),v()()}if(e&2){const t=k();b(),T("foldFocusTrap",t.open()),J("aria-label",t.label()),b(3),Pn("--nav-cols",t.resolvedCols())}}class yi{open=Qi(!1);label=w("Navigation");columns=w("auto");tiles=$p(Zt);resolvedCols=q(()=>{const n=this.columns();return n!=="auto"?n:this.tiles().length<=4?2:3});scrollLock=p(Pt);locked=!1;constructor(){bt(()=>{const n=this.open();n&&!this.locked?(this.scrollLock.lock(),this.locked=!0):!n&&this.locked&&(this.scrollLock.unlock(),this.locked=!1)}),p(an).onDestroy(()=>{this.locked&&(this.scrollLock.unlock(),this.locked=!1)})}onEscape(){this.open()&&this.open.set(!1)}close(){this.open.set(!1)}static ɵfac=function(t){return new(t||yi)};static ɵcmp=le({type:yi,selectors:[["fold-nav-launcher"]],contentQueries:function(t,o,r){t&1&&nc(r,o.tiles,Zt,4),t&2&&tc()},hostBindings:function(t,o){t&1&&z("keydown.escape",function(){return o.onEscape()},bl)},inputs:{open:[1,"open"],label:[1,"label"],columns:[1,"columns"]},outputs:{open:"openChange"},ngContentSelectors:v5,decls:1,vars:1,consts:[["aria-hidden","true",1,"nl-scrim",3,"click"],["role","dialog","aria-modal","true","tabindex","-1",1,"nl-dialog",3,"foldFocusTrap"],["type","button","aria-label","Close navigation",1,"nl-close",3,"click"],["name","close","size","md"],[1,"nl-grid"]],template:function(t,o){t&1&&(Bn(),W(0,b5,6,4)),t&2&&Q(o.open()?0:-1)},dependencies:[Gt,$e],styles:[`@charset "UTF-8";

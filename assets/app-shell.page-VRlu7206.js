import{s as h,A as H,ɵ as C,c as L,br as A,bs as N,bt as B,bu as O,F as W,bv as E,E as T,d as l,e as a,f as o,g as m,B as s,h as b,i as P,T as z,w as R,$ as g,j as t,m as c,U as D,L as _,n as y,o as F,D as I,l as $,x as j,q as S,N as u,O as f,r as k}from"./index-CSZ3oRcG.js";import{P as q}from"./panel-scope.directive-DQhq97Rn.js";import{T as K}from"./tab-panel.component-Cump41tq.js";import{K as M}from"./kind-badge.component-BERkkNys.js";import{C as V}from"./composed-of.component-CalMr7Ka.js";import{D as U}from"./playground.component-b7J_OrVx.js";import{FoldSliderComponent as x}from"./slider.component-DQdGuBdR.js";import"./view-nav.component-CiSvzia7.js";import"./nav-layout.context-JCWE-5LD.js";import"./button.component-CH64gd7k.js";import"./spinner.component-Bq9pQFBq.js";import"./tokens.catalog-DF_6rd51.js";import"./element-title.component-BAw9ENjv.js";import"./page-section.component-CHZVxBSN.js";import"./input-value-Co_u-z_8.js";const G=()=>["nav-launcher"],J=(v,i)=>i.id;function Q(v,i){if(v&1){const d=T();l(0,"button",32),s("click",function(){const p=u(d).$implicit,r=S();return r.previewNav.set(p.id),f(r.previewNavOpen.set(!1))}),o()}if(v&2){const d=i.$implicit,e=S();c("icon",d.icon)("label",d.label)("active",e.previewNav()===d.id)}}function X(v,i){v&1&&m(0,"div",30)}function Y(v,i){v&1&&(l(0,"div",31),m(1,"fold-icon",33),l(2,"span",34),a(3,"Now playing — Track 03"),o(),l(4,"span",35),a(5,"1:24 / 3:57"),o()())}class w{theme=h("dark");elevatedPrimary=h(!1);elevatedSecondary=h(!1);elevatedHeader=h(!1);shellHeaderLayout=h("inset");shellFooterLayout=h("full");shellFooterBehavior=h("pinned");shellFooter=h(!0);shellRailWidth=h(64);shellHeaderHeight=h(56);setHeaderLayout(i){this.shellHeaderLayout.set(i)}setFooterLayout(i){this.shellFooterLayout.set(i)}setFooterBehavior(i){this.shellFooterBehavior.set(i)}shellCode=H(()=>["<fold-app-shell",`  headerLayout="${this.shellHeaderLayout()}"`,...this.shellFooter()?[`  footerLayout="${this.shellFooterLayout()}"`,`  footerBehavior="${this.shellFooterBehavior()}"`]:[],`  [railWidth]="${this.shellRailWidth()}"`,`  [headerHeight]="${this.shellHeaderHeight()}"`,">",`  <fold-menu railPrimary${this.elevatedPrimary()?" foldElevated":""}>…</fold-menu>`,`  <fold-menu railSecondary${this.elevatedSecondary()?" foldElevated":""}>…</fold-menu>`,`  <header header${this.elevatedHeader()?" foldElevated":""}>…</header>`,"  <!-- untagged content → the main area -->","  <main>…</main>",...this.shellFooter()?["  <app-player footer>…</app-player>"]:["  <!-- no footer → the footer row collapses -->"],"</fold-app-shell>"].join(`

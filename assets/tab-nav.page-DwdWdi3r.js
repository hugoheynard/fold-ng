import{Q as A,S as z,s as u,C as g,ɵ as S,R as F,c as I,F as B,a as L,d as t,e as n,f as e,g as _,H as c,i as m,A as x,K as $,j as l,m as h,z as p,o as f,k as d,E as D,l as w,L as K,G as T,q as v,I as C,J as N}from"./index-CheKRm5v.js";import{K as R}from"./kind-badge.component-CUehdKqc.js";import{D as O}from"./playground.component-f1vabdNM.js";import{T as U}from"./tab-panel.component-CDnuLK5F.js";import{F as V}from"./callout.component-DxZruyg-.js";import{F as E}from"./nav-layout.component-CAB8DzC1.js";import{F as M}from"./view-nav.component-C-6Zx6Ro.js";import"./button.component-lldnsmRG.js";import"./spinner.component-DPVRVwus.js";import"./tokens.catalog-DF_6rd51.js";import"./element-title.component-DxaCe8rP.js";import"./page-section.component-BEVmrNeh.js";import"./nav-layout.context-BCfFVc2u.js";const P=(r,i)=>i.label,j=(r,i)=>i.name,H=(r,i)=>i.text,W=(r,i)=>i.ref;function G(r,i){if(r&1){const a=T();t(0,"button",9),c("click",function(){const s=C(a).$implicit,b=v();return N(b.tnSize.set(s))}),n(1),e()}if(r&2){const a=i.$implicit,o=v();p("is-on",o.tnSize()===a),l(),w(" ",a," ")}}function J(r,i){if(r&1){const a=T();t(0,"button",9),c("click",function(){const s=C(a).$implicit,b=v();return N(b.tnCount.set(s))}),n(1),e()}if(r&2){const a=i.$implicit,o=v();p("is-on",o.tnCount()===a),l(),w(" ",a," ")}}function q(r,i){if(r&1&&(t(0,"div",33)(1,"span",34),n(2),e(),t(3,"span",35),n(4),e()()),r&2){const a=i.$implicit;l(2),d(a.value),l(2),d(a.label)}}function Q(r,i){if(r&1&&(t(0,"div",25),m(1,q,5,2,"div",33,P),e()),r&2){const a=v();l(),f(a.overviewStats)}}function X(r,i){if(r&1&&(t(0,"div",36)(1,"span",37),n(2),e(),t(3,"span",38)(4,"span",39),n(5),e(),t(6,"span",40),n(7),e()(),_(8,"fold-badge",41),e()),r&2){const a=i.$implicit;l(2),d(a.initials),l(3),d(a.name),l(2),d(a.role),l(),h("content",a.status)("variant",a.tone)}}function Y(r,i){if(r&1&&(t(0,"div",26),m(1,X,9,5,"div",36,j),e()),r&2){const a=v();l(),f(a.members)}}function Z(r,i){if(r&1&&(t(0,"div",42)(1,"span",43),n(2),e(),t(3,"span",44),n(4),e()()),r&2){const a=i.$implicit;l(2),d(a.label),l(2),d(a.value)}}function nn(r,i){if(r&1&&(t(0,"div",27),m(1,Z,5,2,"div",42,P),e()),r&2){const a=v();l(),f(a.settingsFields)}}function tn(r,i){if(r&1&&(t(0,"div",45),_(1,"span",46),t(2,"span",38)(3,"span",39),n(4),e(),t(5,"span",40),n(6),e()()()),r&2){const a=i.$implicit;l(4),d(a.text),l(2),d(a.when)}}function en(r,i){if(r&1&&(t(0,"div",28),m(1,tn,7,2,"div",45,H),e()),r&2){const a=v();l(),f(a.activity)}}function an(r,i){if(r&1&&(t(0,"div",47)(1,"span",39),n(2),e(),t(3,"span",40),n(4),e(),t(5,"span",48),n(6),e()()),r&2){const a=i.$implicit;l(2),d(a.ref),l(2),d(a.date),l(2),d(a.amount)}}function on(r,i){if(r&1&&(t(0,"div",29),m(1,an,7,3,"div",47,W),e()),r&2){const a=v();l(),f(a.invoices)}}class k{panelHost=A(z);tabCounts=[2,3,5];tabSizes=["compact","comfortable"];tnStyle=u("underline");tnDirection=u("vertical");tnSize=u("compact");tnCollapsed=u(!1);tnBackground=u("transparent");tnBadge=u(!0);tnIcon=u(!0);tnCount=u(3);tnActive=u("overview");TAB_POOL=[{key:"overview",label:"Overview",icon:"grid"},{key:"members",label:"Members",icon:"team",badge:3},{key:"settings",label:"Settings",icon:"settings"},{key:"activity",label:"Activity",icon:"timeline"},{key:"billing",label:"Billing",icon:"contracts",badge:2}];tnTabs=g(()=>this.TAB_POOL.slice(0,this.tnCount()).map(i=>({key:i.key,label:i.label,...this.tnIcon()?{icon:i.icon}:{},badge:this.tnBadge()?i.badge??null:null})));tnActiveKey=g(()=>{const i=this.tnTabs().map(a=>a.key);return i.includes(this.tnActive())?this.tnActive():i[0]??""});tnActiveLabel=g(()=>this.tnTabs().find(i=>i.key===this.tnActiveKey())?.label??"Overview");tabNavCode=g(()=>{const i=this.tnDirection()==="vertical",a=['[items]="items"'];i&&a.push("tabNav",'direction="auto"'),this.tnStyle()!=="underline"&&a.push(`activeStyle="${this.tnStyle()}"`),this.tnSize()!=="compact"&&a.push(`size="${this.tnSize()}"`),this.tnCollapsed()&&a.push("collapsed"),this.tnBackground()!=="transparent"&&a.push(`background="${this.tnBackground()}"`);const o=["<fold-view-nav",...a.map(y=>`  ${y}`),"/>"],s=i&&this.tnCollapsed()?`<fold-nav-layout placement="side"

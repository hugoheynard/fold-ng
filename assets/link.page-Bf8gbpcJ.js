import{s as c,x as m,ɵ as P,c as T,A as L,d as n,e,f as t,g as C,B as s,i as v,u as y,j as o,m as d,C as p,o as w,l as $,k as I,D as f,P as h,E as k}from"./index-CtivJ5eo.js";import{K as F}from"./kind-badge.component-DWEkWp60.js";import{D as S}from"./playground.component-C32-I7yd.js";import{FoldPageSectionComponent as V}from"./page-section.component-C62gJwH_.js";import{FoldLinkComponent as B}from"./link.component-BapO11ls.js";import"./button.component-BhwuDnRP.js";import"./spinner.component-BfoDqze5.js";import"./tokens.catalog-DF_6rd51.js";import"./element-title.component-BSioDnCO.js";function j(g,a){if(g&1&&(n(0,"option",13),e(1),t()),g&2){const l=a.$implicit;d("value",l),o(),I(l)}}function D(g,a){if(g&1&&(n(0,"option",13),e(1),t()),g&2){const l=a.$implicit;d("value",l),o(),I(l)}}class b{demoHref="https://fold.sh3pherd.dev/docs";leadingIcons=["none","arrow-back","company","contracts","download","folder-open","globe","mail"];trailingIcons=["none","chevron-right","arrow-right","globe","download"];label=c("View the organisation");tone=c("accent");mode=c("button");leadingIcon=c("company");trailingIcon=c("chevron-right");disabled=c(!1);leading=m(()=>this.leadingIcon()==="none"?void 0:this.leadingIcon());trailing=m(()=>this.trailingIcon()==="none"?void 0:this.trailingIcon());linkCode=m(()=>{const a=[];this.tone()!=="accent"&&a.push(`tone="${this.tone()}"`),this.leading()&&a.push(`icon="${this.leading()}"`),this.trailing()&&a.push(`trailingIcon="${this.trailing()}"`),this.mode()==="anchor"?a.push(`href="${this.demoHref}"`):(a.push('(clicked)="onClick()"'),this.disabled()&&a.push('[disabled]="true"'));const l=a.length>0?["<fold-link",...a.map(u=>`  ${u}`),">"].join(`

import{af as c,u as e,a0 as i,X as h,ag as v,A as a,s as C,ɵ as O,F as M,d as b,B as f,f as s,w as P,m as r,j as d,L as y,D as g,x as w,ai as L,E as x,g as I,q as _,N as k,O as z}from"./index-CrZoBIgg.js";import{FoldInputBaseComponent as F}from"./input-base.component-CogtTioT.js";import{r as q}from"./input-value-DCGlOvqF.js";import"./info.component-BJ-eY8-0.js";import"./common-labels-CREAgoKZ.js";import"./popover.component-B6t2mHg1.js";import"./auto-update-_srfpL1Q.js";import"./popover-trigger.directive-CERUDwgX.js";import"./label.component-60qdHS7G.js";function B(p,o){if(p&1){const t=x();b(0,"button",4),f("click",function(){k(t);const l=_();return z(l.toggleReveal())}),I(1,"fold-icon",5),s()}if(p&2){const t=_();r("disabled",t.disabled()||t.readOnly()),g("aria-label",t.revealAria())("aria-pressed",t.revealed()),d(),r("name",t.revealed()?"eye-off":"eye")}}class u{value=c("");disabled=e(!1);touched=c(!1);errors=e([]);type=e("text");revealable=e(!1,{transform:i});revealLabel=e("Show password");hideLabel=e("Hide password");size=e("md");align=e("start");variant=e("default");label=e();required=e(!1,{transform:i});optional=e(!1,{transform:i});optionalLabel=e();info=e();infoLabel=e();ariaLabel=e(void 0);hint=e();placeholder=e("");readOnly=e(!1);autofocus=e(!1);autocomplete=e(null);inputId=h(v).next("fold-input");errorMessage=a(()=>{if(!this.touched())return;const o=this.errors()[0];return o?o.message??o.kind:void 0});describedBy=a(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);revealed=C(!1);showReveal=a(()=>this.revealable()&&this.type()==="password");effectiveType=a(()=>this.showReveal()&&this.revealed()?"text":this.type());revealAria=a(()=>this.revealed()?this.hideLabel():this.revealLabel());toggleReveal(){this.revealed.update(o=>!o)}onInputChange(o){this.value.set(q(o))}onBlur(){this.touched.set(!0)}static ɵfac=function(t){return new(t||u)};static ɵcmp=O({type:u,selectors:[["fold-input"]],hostVars:2,hostBindings:function(t,n){t&2&&L(n.size()+" "+n.align()+" "+n.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],type:[1,"type"],revealable:[1,"revealable"],revealLabel:[1,"revealLabel"],hideLabel:[1,"hideLabel"],size:[1,"size"],align:[1,"align"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],info:[1,"info"],infoLabel:[1,"infoLabel"],ariaLabel:[1,"ariaLabel"],hint:[1,"hint"],placeholder:[1,"placeholder"],readOnly:[1,"readOnly"],autofocus:[1,"autofocus"],autocomplete:[1,"autocomplete"]},outputs:{value:"valueChange",touched:"touchedChange"},decls:4,vars:23,consts:[[3,"label","for","required","optional","optionalLabel","info","infoLabel","hint","error"],[1,"in-field"],[3,"input","blur","id","value"],["type","button",1,"in-reveal",3,"disabled"],["type","button",1,"in-reveal",3,"click","disabled"],["size","sm","aria-hidden","true",3,"name"]],template:function(t,n){t&1&&(b(0,"fold-input-base",0)(1,"div",1)(2,"input",2),f("input",function(m){return n.onInputChange(m)})("blur",function(){return n.onBlur()}),s(),P(3,B,2,4,"button",3),s()()),t&2&&(r("label",n.label())("for",n.inputId)("required",n.required())("optional",n.optional())("optionalLabel",n.optionalLabel())("info",n.info())("infoLabel",n.infoLabel())("hint",n.hint())("error",n.errorMessage()),d(2),y("has-reveal",n.showReveal()),r("id",n.inputId)("value",n.value()),g("type",n.effectiveType())("placeholder",n.placeholder())("readonly",n.readOnly()||null)("disabled",n.disabled()||null)("required",n.required()||null)("aria-invalid",n.errorMessage()?!0:null)("aria-describedby",n.describedBy())("aria-label",n.ariaLabel())("autocomplete",n.autocomplete()),d(),w(n.showReveal()?3:-1))},dependencies:[F,M],styles:[`@charset "UTF-8";

import{K as d}from"./kind-badge.component-C3NFGyeE.js";import{C as m}from"./composed-of.component-BSOe-yPe.js";import{FoldBreadcrumbComponent as u}from"./breadcrumb.component-Bn7CsUYd.js";import{ɵ as p,c as h,d as a,e,f as t,g as i,j as r,m as s,U as g,k as b}from"./index-qfVwsMqT.js";import{FoldPageSectionComponent as f}from"./page-section.component-zPSKFEds.js";const k=()=>["icons"];class l{routed=[{label:"Home",routerLink:"/home"},{label:"Navigation",routerLink:"/menu"},{label:"Breadcrumb"}];ancestors=[{label:"Home",routerLink:"/home"},{label:"Navigation",routerLink:"/menu"}];linked=[{label:"example.com",href:"https://example.com"},{label:"Docs",href:"https://example.com/docs"},{label:"Breadcrumb"}];code=`<fold-breadcrumb
  [items]="[

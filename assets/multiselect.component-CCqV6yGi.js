import{ai as h,u as l,X as M,a2 as P,aj as T,at as x,aN as I,aL as k,A as p,a0 as L,a4 as S,ɵ as q,F as j,au as z,E as W,Y as B,d as c,h as E,B as O,w as b,g as $,f as _,m as d,j as s,n as A,T as D,D as w,x as v,aH as Q,ak as K,a7 as N,a8 as y,aw as V,e as C,k as F,q as f,Z as R,M as X,r as Y,N as H,i as U,o as Z,ax as G,ay as J,l as ee}from"./index-CQebbVEP.js";import{FoldPopoverComponent as ne}from"./popover.component-ZFXe3hit.js";import{F as te}from"./popover-trigger.directive-B4OCsel0.js";import{FoldInputBaseComponent as oe}from"./input-base.component-DrRtAKIP.js";import{F as u,a as ie}from"./option.component-BhXTs6Ki.js";import{F as le}from"./listbox-nav-Dz2jXK-v.js";import"./label.component-DBxoIRpX.js";const re=["option"],ae=["list"],se=["*"],de=()=>["top-start","bottom-end","top-end"],ce=o=>({$implicit:o}),pe=(o,e)=>e.value;function ue(o,e){o&1&&(c(0,"span",4),C(1),_()),o&2&&(s(),F(e))}function _e(o,e){if(o&1&&(c(0,"span",5),C(1),_()),o&2){const t=f();s(),F(t.placeholder())}}function me(o,e){if(o&1&&G(0,9),o&2){const t=f().$implicit;d("ngTemplateOutlet",e)("ngTemplateOutletContext",J(2,ce,t))}}function fe(o,e){if(o&1&&C(0),o&2){const t=f().$implicit;ee(" ",t.label," ")}}function he(o,e){if(o&1&&(c(0,"fold-option",8),b(1,me,1,4,"ng-container",9)(2,fe,1,1),_()),o&2){let t;const n=e.$implicit,i=f(2);d("value",n.value)("disabled",n.disabled??!1),s(),v((t=i.optionTemplate())?1:2,t)}}function ge(o,e){o&1&&U(0,he,3,3,"fold-option",8,pe),o&2&&Z(e)}function be(o,e){o&1&&R(0)}const g=3;class m{value=h([]);compareWith=l();options=l();disabled=l(!1);touched=h(!1);errors=l([]);open=h(!1);size=l("md");variant=l("default");label=l();required=l(!1,{transform:M});optional=l(!1,{transform:M});optionalLabel=l("optional");hint=l();placeholder=l();placement=l("bottom-start");inputId=P(T).next("fold-multiselect");listId=`${this.inputId}-list`;optionTemplate=x("option");projectedOptions=I(u);renderedOptions=k(u);allOptions=p(()=>this.options()?this.renderedOptions():this.projectedOptions());list=L("list");eq(e,t){const n=this.compareWith();return n?n(e,t):Object.is(e,t)}nav=new le(()=>this.allOptions(),{select:e=>this.toggle(e),close:()=>this.open.set(!1)});activeId=this.nav.activeId;selectedSet=p(()=>this.compareWith()?null:new Set(this.value()));summaryLabel=p(()=>{if(this.value().length===0)return;const e=this.allOptions().filter(t=>this.isSelected(t.value())).map(t=>t.label);if(e.length!==0)return e.length<=g?e.join(", "):`${e.slice(0,g).join(", ")} +${e.length-g}`});errorMessage=p(()=>{if(!this.touched())return;const e=this.errors()[0];return e?e.message??e.kind:void 0});describedBy=p(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);hasOpened=!1;constructor(){S(()=>{this.open()?(this.hasOpened=!0,queueMicrotask(()=>{this.open()&&(this.list()?.nativeElement.focus(),this.nav.arm(this.firstSelectedIndex()))})):(this.nav.reset(),this.hasOpened&&this.touched.set(!0))})}isSelected(e){const t=this.selectedSet();return t?t.has(e):this.value().some(n=>this.eq(n,e))}onTriggerKeydown(e){this.open()||["ArrowDown","ArrowUp","Enter"," "].includes(e.key)&&(e.preventDefault(),this.open.set(!0))}onListKeydown(e){this.nav.onKeydown(e)}onListClick(e){const t=this.enabledIndexFrom(e.target);t>=0&&this.toggle(t)}onListPointermove(e){const t=this.enabledIndexFrom(e.target);t>=0&&this.nav.point(t)}firstSelectedIndex(){return this.allOptions().findIndex(e=>this.isSelected(e.value())&&!e.disabled())}enabledIndexFrom(e){if(!(e instanceof Element))return-1;const t=e.closest("[role='option']"),n=this.allOptions(),i=n.findIndex(r=>r.id===t?.id);return i>=0&&!n[i]?.disabled()?i:-1}toggle(e){const t=this.allOptions()[e];if(!t||t.disabled())return;const n=t.value(),i=this.value();this.value.set(this.isSelected(n)?i.filter(r=>!this.eq(r,n)):[...i,n]),this.touched.set(!0)}static ɵfac=function(t){return new(t||m)};static ɵcmp=q({type:m,selectors:[["fold-multiselect"]],contentQueries:function(t,n,i){t&1&&V(i,n.optionTemplate,re,5)(i,n.projectedOptions,u,4),t&2&&y(2)},viewQuery:function(t,n){t&1&&N(n.renderedOptions,u,5)(n.list,ae,5),t&2&&y(2)},hostVars:2,hostBindings:function(t,n){t&2&&K(n.size()+" "+n.variant())},inputs:{value:[1,"value"],compareWith:[1,"compareWith"],options:[1,"options"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],open:[1,"open"],size:[1,"size"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],hint:[1,"hint"],placeholder:[1,"placeholder"],placement:[1,"placement"]},outputs:{value:"valueChange",touched:"touchedChange",open:"openChange"},features:[Q([{provide:ie,useExisting:m}])],ngContentSelectors:se,decls:10,vars:22,consts:[["list",""],[3,"label","for","required","optional","optionalLabel","hint","error"],[3,"openChange","open","autoFocus","ariaControls","placement","fallbackPlacements"],["type","button","foldPopoverTrigger","listbox",1,"lb-trigger",3,"keydown","id","disabled"],[1,"lb-value"],[1,"lb-placeholder"],["name","chevron-down","size","sm","aria-hidden","true",1,"lb-caret"],["foldPopoverPanel","","role","listbox","aria-multiselectable","true","tabindex","-1",1,"lb-list",3,"keydown","click","pointermove","id"],[3,"value","disabled"],[3,"ngTemplateOutlet","ngTemplateOutletContext"]],template:function(t,n){if(t&1){const i=W();B(),c(0,"fold-input-base",1)(1,"fold-popover",2),E("openChange",function(a){return X(i),Y(n.open,a)||(n.open=a),H(a)}),c(2,"button",3),O("keydown",function(a){return n.onTriggerKeydown(a)}),b(3,ue,2,1,"span",4)(4,_e,2,1,"span",5),$(5,"fold-icon",6),_(),c(6,"div",7,0),O("keydown",function(a){return n.onListKeydown(a)})("click",function(a){return n.onListClick(a)})("pointermove",function(a){return n.onListPointermove(a)}),b(8,ge,2,0)(9,be,1,0),_()()()}if(t&2){let i,r;d("label",n.label())("for",n.inputId)("required",n.required())("optional",n.optional())("optionalLabel",n.optionalLabel())("hint",n.hint())("error",n.errorMessage()),s(),A("open",n.open),d("autoFocus",!1)("ariaControls",n.listId)("placement",n.placement())("fallbackPlacements",D(21,de)),s(),d("id",n.inputId)("disabled",n.disabled()),w("aria-invalid",n.errorMessage()?!0:null)("aria-describedby",n.describedBy()),s(),v((i=n.summaryLabel())?3:4,i),s(3),d("id",n.listId),w("aria-label",n.label())("aria-activedescendant",n.activeId()),s(2),v((r=n.options())?8:9,r)}},dependencies:[oe,j,u,ne,te,z],styles:[`

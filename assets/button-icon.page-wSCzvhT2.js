import{K as B}from"./kind-badge.component-CUehdKqc.js";import{u as a,v as u,T as M,C as P,ɵ as h,F as O,d as t,H as k,K as x,f as e,m as c,y as g,j as b,L as T,g as d,q as v,_ as w,s as I,c as S,e as i,h as C,n as y,l as q,r as z}from"./index-CheKRm5v.js";import{F}from"./spinner.component-DPVRVwus.js";import"./tokens.catalog-DF_6rd51.js";function G(l,r){if(l&1&&d(0,"fold-spinner",1),l&2){const o=v();c("size",o.iconSize())}}function L(l,r){if(l&1&&d(0,"fold-icon",2),l&2){const o=v();c("name",o.icon())("size",o.iconSize())}}class p{icon=a.required();shape=a("square");size=a("md");tone=a("ghost");disabled=a(!1,{transform:u});loading=a(!1,{transform:u});tooltip=a();type=a("button");clicked=M();iconSize=P(()=>{switch(this.size()){case"xs":return"xs";case"sm":return"sm";case"md":return"sm";case"lg":return"md"}});onClick(r){this.disabled()||this.loading()||this.clicked.emit(r)}static ɵfac=function(o){return new(o||p)};static ɵcmp=h({type:p,selectors:[["fold-button-icon"]],hostVars:4,hostBindings:function(o,n){o&2&&g("data-shape",n.shape())("data-size",n.size())("data-tone",n.tone())("data-loading",n.loading()?"":null)},inputs:{icon:[1,"icon"],shape:[1,"shape"],size:[1,"size"],tone:[1,"tone"],disabled:[1,"disabled"],loading:[1,"loading"],tooltip:[1,"tooltip"],type:[1,"type"]},outputs:{clicked:"clicked"},decls:3,vars:6,consts:[[3,"click","type","disabled"],["aria-hidden","true",3,"size"],[3,"name","size"]],template:function(o,n){o&1&&(t(0,"button",0),k("click",function(s){return n.onClick(s)}),x(1,G,1,1,"fold-spinner",1)(2,L,1,2,"fold-icon",2),e()),o&2&&(c("type",n.type())("disabled",n.disabled()||n.loading()),g("title",n.tooltip()||null)("aria-label",n.tooltip()||null)("aria-busy",n.loading()?"true":null),b(),T(n.loading()?1:2))},dependencies:[O,F],styles:[`[_nghost-%COMP%] {
  display: inline-flex;
}
...
}`]})}function j(l,r){if(l&1&&d(0,"fold-spinner",1),l&2){const o=v();c("size",o.iconSize())}}function H(l,r){if(l&1&&d(0,"fold-icon",2),l&2){const o=v();c("name",o.icon())("size",o.iconSize())}}class f{icon=a.required();shape=a("square");size=a("md");tone=a("ghost");active=w(!1);disabled=a(!1,{transform:u});loading=a(!1,{transform:u});tooltip=a();type=a("button");toggled=M();iconSize=P(()=>{switch(this.size()){case"xs":return"xs";case"sm":return"sm";case"md":return"sm";case"lg":return"md"}});onClick(r){this.disabled()||this.loading()||(this.active.update(o=>!o),this.toggled.emit(r))}static ɵfac=function(o){return new(o||f)};static ɵcmp=h({type:f,selectors:[["fold-toggle-icon"]],hostVars:5,hostBindings:function(o,n){o&2&&g("data-shape",n.shape())("data-size",n.size())("data-tone",n.tone())("data-active",n.active()?"":null)("data-loading",n.loading()?"":null)},inputs:{icon:[1,"icon"],shape:[1,"shape"],size:[1,"size"],tone:[1,"tone"],active:[1,"active"],disabled:[1,"disabled"],loading:[1,"loading"],tooltip:[1,"tooltip"],type:[1,"type"]},outputs:{active:"activeChange",toggled:"toggled"},decls:3,vars:7,consts:[[3,"click","type","disabled"],["aria-hidden","true",3,"size"],[3,"name","size"]],template:function(o,n){o&1&&(t(0,"button",0),k("click",function(s){return n.onClick(s)}),x(1,j,1,1,"fold-spinner",1)(2,H,1,2,"fold-icon",2),e()),o&2&&(c("type",n.type())("disabled",n.disabled()||n.loading()),g("title",n.tooltip()||null)("aria-label",n.tooltip()||null)("aria-pressed",n.active()?"true":"false")("aria-busy",n.loading()?"true":null),b(),T(n.loading()?1:2))},dependencies:[O,F],styles:[`[_nghost-%COMP%] {
  display: inline-flex;
}
[data-size=xs][_nghost-%COMP%] {
  --bi-size: 22px;

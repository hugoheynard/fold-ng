import{ag as a,u as e,a0 as i,X as p,ah as c,A as l,ɵ as m,d as g,B as f,f as _,m as s,j as b,D as C,aj as h}from"./index-DlGy65Dl.js";import{FoldInputBaseComponent as M}from"./input-base.component-BmzJFoMZ.js";import{r as O}from"./input-value-DCGlOvqF.js";import"./info.component-QwSdjwrh.js";import"./popover.component-Bdo5wjLV.js";import"./popover-trigger.directive-bg6WEHxO.js";import"./label.component-BpT-a62l.js";class r{value=a("");disabled=e(!1);touched=a(!1);errors=e([]);min=e(void 0);max=e(void 0);step=e(void 0);size=e("md");variant=e("default");label=e();required=e(!1,{transform:i});optional=e(!1,{transform:i});optionalLabel=e("optional");info=e();infoLabel=e("More information");hint=e();readOnly=e(!1);inputId=p(c).next("fold-time");errorMessage=l(()=>{if(!this.touched())return;const t=this.errors()[0];return t?t.message??t.kind:void 0});describedBy=l(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);onInputChange(t){this.value.set(O(t))}onBlur(){this.touched.set(!0)}static ɵfac=function(o){return new(o||r)};static ɵcmp=m({type:r,selectors:[["fold-time"]],hostVars:2,hostBindings:function(o,n){o&2&&h(n.size()+" "+n.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],min:[1,"min"],max:[1,"max"],step:[1,"step"],size:[1,"size"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],info:[1,"info"],infoLabel:[1,"infoLabel"],hint:[1,"hint"],readOnly:[1,"readOnly"]},outputs:{value:"valueChange",touched:"touchedChange"},decls:2,vars:19,consts:[[3,"label","for","required","optional","optionalLabel","info","infoLabel","hint","error"],["type","time",1,"date",3,"input","blur","id","value"]],template:function(o,n){o&1&&(g(0,"fold-input-base",0)(1,"input",1),f("input",function(u){return n.onInputChange(u)})("blur",function(){return n.onBlur()}),_()()),o&2&&(s("label",n.label())("for",n.inputId)("required",n.required())("optional",n.optional())("optionalLabel",n.optionalLabel())("info",n.info())("infoLabel",n.infoLabel())("hint",n.hint())("error",n.errorMessage()),b(),s("id",n.inputId)("value",n.value()),C("min",n.min())("max",n.max())("step",n.step())("readonly",n.readOnly()||null)("disabled",n.disabled()||null)("required",n.required()||null)("aria-invalid",n.errorMessage()?!0:null)("aria-describedby",n.describedBy()))},dependencies:[M],styles:[`@charset "UTF-8";

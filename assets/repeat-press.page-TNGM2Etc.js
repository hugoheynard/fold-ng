import{s as i,A as c,ɵ as y,c as R,b as C,F as w,d as t,g as f,e as a,f as o,B as h,h as b,j as l,m as p,k as P,n as _,r as v}from"./index-BW3a1hyM.js";import{K as x}from"./kind-badge.component-E45OLO50.js";import{FoldPageSectionComponent as D}from"./page-section.component-BsbOYwS9.js";import{FoldCalloutComponent as k}from"./callout.component-Dwli3pMj.js";import{FoldSliderComponent as T}from"./slider.component-CAiXJ5ZY.js";import{F}from"./repeat-press.directive-C2AyFk_d.js";import"./input-value-DCGlOvqF.js";const u=0,m=50;class g{min=u;max=m;count=i(8);delay=i(350);period=i(60);atMin=c(()=>this.count()<=u);atMax=c(()=>this.count()>=m);step(n){this.count.update(s=>Math.min(m,Math.max(u,s+n)))}usageCode=c(()=>`<button
  foldRepeatPress

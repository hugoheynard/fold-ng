import{K as P}from"./kind-badge.component-DVEsXrPu.js";import{t as d,ɵ as u,d as t,g as l,J as x,f as o,j as s,m as f,K as h,e as n,z as v,k as y,v as w,L as r,w as C,M as p,x as M,s as O,c as F,b,F as z,G as S,l as k}from"./index-xkftXCIA.js";import{F as T}from"./page-section.component-nTfjfGX9.js";import{F as B}from"./button.component-CL6oXVKr.js";import{F as E}from"./spinner.component-DIg8GvKp.js";import"./element-title.component-BHl8g0x4.js";import"./tokens.catalog-DF_6rd51.js";function L(c,i){if(c&1&&(t(0,"span"),n(1),o()),c&2){const e=v();s(),y(e.message())}}class m{message=d("Loading...");size=d("md");static ɵfac=function(e){return new(e||m)};static ɵcmp=u({type:m,selectors:[["fold-loading"]],hostAttrs:["role","status","aria-live","polite"],inputs:{message:[1,"message"],size:[1,"size"]},decls:3,vars:2,consts:[[1,"loading"],["aria-hidden","true",3,"size"]],template:function(e,a){e&1&&(t(0,"div",0),l(1,"fold-spinner",1),x(2,L,2,1,"span"),o()),e&2&&(s(),f("size",a.size()),s(),h(a.message()?2:-1))},dependencies:[E],styles:[`[_nghost-%COMP%] {
  display: flex;
  align-items: center;
...
}`]})}const j=[[["","empty-icon",""]],"*"],I=["[empty-icon]","*"];function K(c,i){if(c&1&&(r(0,"p",3),n(1),p()),c&2){const e=v();s(),y(e.subtitle())}}class g{title=d.required();subtitle=d("");tone=d("neutral");static ɵfac=function(e){return new(e||g)};static ɵcmp=u({type:g,selectors:[["fold-empty-state"]],hostVars:2,hostBindings:function(e,a){e&2&&M("alert",a.tone()==="alert")},inputs:{title:[1,"title"],subtitle:[1,"subtitle"],tone:[1,"tone"]},ngContentSelectors:I,decls:8,vars:2,consts:[[1,"empty"],[1,"empty-icon"],[1,"empty-title"],[1,"empty-sub"],[1,"empty-action"]],template:function(e,a){e&1&&(w(j),r(0,"div",0)(1,"div",1),C(2),p(),r(3,"p",2),n(4),p(),x(5,K,2,1,"p",3),r(6,"div",4),C(7,1),p()()),e&2&&(s(4),y(a.title()),s(),h(a.subtitle()?5:-1))},styles:[`[_nghost-%COMP%] {
  display: flex;
  align-items: center;
  justify-content: center;
  flex: 1;

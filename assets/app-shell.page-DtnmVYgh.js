import{s as h,A as H,ɵ as C,c as L,by as A,bz as N,bA as B,bB as O,F as W,bC as E,E as T,d as l,e as a,f as o,g as m,B as s,h as b,i as P,T as z,w as R,a3 as g,j as t,m as c,U as D,L as _,n as y,o as F,D as I,l as $,x as j,q as S,N as u,O as f,r as k}from"./index-CrYE53GN.js";import{P as q}from"./panel-scope.directive-KclJhA1A.js";import{T as K}from"./tab-panel.component-7dzjwV0a.js";import{K as M}from"./kind-badge.component-R8m_51Uu.js";import{C as V}from"./composed-of.component-DgzLToaH.js";import{D as U}from"./playground.component-BC_kh_RB.js";import{FoldSliderComponent as x}from"./slider.component-BKbc_7rL.js";import"./view-nav.component-CvYu7oi9.js";import"./nav-layout.context-B3-JHDup.js";import"./button.component-CcnJKi6o.js";import"./element-title.component-Cd9_q0XS.js";import"./page-section.component-eckDWTn4.js";import"./input-value-DCGlOvqF.js";const G=()=>["nav-launcher"],J=(v,i)=>i.id;function Q(v,i){if(v&1){const d=T();l(0,"button",32),s("click",function(){const p=u(d).$implicit,r=S();return r.previewNav.set(p.id),f(r.previewNavOpen.set(!1))}),o()}if(v&2){const d=i.$implicit,e=S();c("icon",d.icon)("label",d.label)("active",e.previewNav()===d.id)}}function X(v,i){v&1&&m(0,"div",30)}function Y(v,i){v&1&&(l(0,"div",31),m(1,"fold-icon",33),l(2,"span",34),a(3,"Now playing — Track 03"),o(),l(4,"span",35),a(5,"1:24 / 3:57"),o()())}class w{theme=h("dark");elevatedPrimary=h(!1);elevatedSecondary=h(!1);elevatedHeader=h(!1);shellHeaderLayout=h("inset");shellFooterLayout=h("full");shellFooterBehavior=h("pinned");shellFooter=h(!0);shellRailWidth=h(64);shellHeaderHeight=h(56);setHeaderLayout(i){this.shellHeaderLayout.set(i)}setFooterLayout(i){this.shellFooterLayout.set(i)}setFooterBehavior(i){this.shellFooterBehavior.set(i)}shellCode=H(()=>["<fold-app-shell",`  headerLayout="${this.shellHeaderLayout()}"`,...this.shellFooter()?[`  footerLayout="${this.shellFooterLayout()}"`,`  footerBehavior="${this.shellFooterBehavior()}"`]:[],`  [railWidth]="${this.shellRailWidth()}"`,`  [headerHeight]="${this.shellHeaderHeight()}"`,">",`  <fold-menu railPrimary${this.elevatedPrimary()?" foldElevated":""}>…</fold-menu>`,`  <fold-menu railSecondary${this.elevatedSecondary()?" foldElevated":""}>…</fold-menu>`,`  <header header${this.elevatedHeader()?" foldElevated":""}>…</header>`,"  <!-- untagged content → the main area -->","  <main>…</main>",...this.shellFooter()?["  <app-player footer>…</app-player>"]:["  <!-- no footer → the footer row collapses -->"],"</fold-app-shell>"].join(`

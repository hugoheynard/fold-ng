import{u as r,ag as h,a0 as p,X as f,A as x,ah as k,aL as w,ɵ as F,F as T,a as z,d as s,B as u,i as K,f as d,L as b,D as C,j as l,o as A,a8 as B,a9 as $,E as S,w as m,e as O,q as c,m as g,x as v,k as P,g as M,N as D,O as I}from"./index-CZaKgIRL.js";import{F as j}from"./nav-layout.context-BN2WD1D7.js";const L=["tabBtn"],V=(o,e)=>e.key;function q(o,e){o&1&&M(0,"fold-icon",4),o&2&&g("name",e)}function E(o,e){if(o&1&&(s(0,"span",5),O(1),d()),o&2){const t=c().$implicit;l(),P(t.label.charAt(0))}}function Q(o,e){if(o&1&&M(0,"fold-badge",7),o&2){const t=c().$implicit,n=c();g("content",t.badge+"")("variant",n.activeKey()===t.key?"accent":"neutral")}}function U(o,e){if(o&1){const t=S();s(0,"button",3,0),u("click",function(){const a=D(t).$implicit,i=c();return I(i.select(a.key))}),m(2,q,1,1,"fold-icon",4)(3,E,2,1,"span",5),s(4,"span",6),O(5),d(),m(6,Q,1,2,"fold-badge",7),d()}if(o&2){let t;const n=e.$implicit,a=c();b("is-active",a.activeKey()===n.key),g("id",a.tabId(n.key))("tabindex",a.activeKey()===n.key?0:-1),C("aria-selected",a.activeKey()===n.key)("aria-controls",a.panelId(n.key)),l(2),v((t=n.icon)?2:a.collapsed()?3:-1,t),l(3),P(n.label),l(),v(n.badge!==void 0&&n.badge!==null?6:-1)}}class _{tabs=r.required();activeKey=h.required();activeStyle=r("underline");direction=r("auto");size=r("compact");collapsed=r(!1,{transform:p});background=r("surface");sticky=r(!1,{transform:p});layout=f(j,{optional:!0});resolvedDirection=x(()=>{const e=this.direction();return e!=="auto"?e:this.layout?.stacked()?"horizontal":"vertical"});uid=f(k).next("fold-tabs");tabButtons=w("tabBtn");tabId(e){return`${this.uid}-tab-${e}`}panelId(e){return`${this.uid}-panel-${e}`}select(e){this.commit(e)}commit(e){this.activeKey.set(e)}onKeydown(e){const t=this.tabs().map(y=>y.key);if(t.length===0)return;const n=t.indexOf(this.activeKey());let a;switch(e.key){case"ArrowRight":case"ArrowDown":a=(n+1)%t.length;break;case"ArrowLeft":case"ArrowUp":a=(n-1+t.length)%t.length;break;case"Home":a=0;break;case"End":a=t.length-1;break;default:return}e.preventDefault();const i=t[a];i!==void 0&&(this.commit(i),this.tabButtons()[a]?.nativeElement.focus())}static ɵfac=function(t){return new(t||_)};static ɵcmp=F({type:_,selectors:[["fold-tabs"]],viewQuery:function(t,n){t&1&&B(n.tabButtons,L,5),t&2&&$()},hostVars:2,hostBindings:function(t,n){t&2&&b("is-sticky",n.sticky())},inputs:{tabs:[1,"tabs"],activeKey:[1,"activeKey"],activeStyle:[1,"activeStyle"],direction:[1,"direction"],size:[1,"size"],collapsed:[1,"collapsed"],background:[1,"background"],sticky:[1,"sticky"]},outputs:{activeKey:"activeKeyChange"},exportAs:["foldTabs"],decls:3,vars:13,consts:[["tabBtn",""],["role","tablist",1,"tab-bar",3,"keydown"],["type","button","role","tab",1,"tab-bar-item",3,"id","is-active","tabindex"],["type","button","role","tab",1,"tab-bar-item",3,"click","id","tabindex"],["size","sm",1,"tab-bar-icon",3,"name"],["aria-hidden","true",1,"tab-bar-icon","tab-bar-initial"],[1,"tab-bar-label"],[1,"tab-bar-badge",3,"content","variant"]],template:function(t,n){t&1&&(s(0,"div",1),u("keydown",function(i){return n.onKeydown(i)}),K(1,U,7,9,"button",2,V),d()),t&2&&(b("style-underline",n.activeStyle()==="underline")("style-fill",n.activeStyle()==="fill")("dir-vertical",n.resolvedDirection()==="vertical")("size-comfortable",n.size()==="comfortable")("is-collapsed",n.collapsed())("bg-surface",n.background()==="surface"),C("aria-orientation",n.resolvedDirection()==="vertical"?"vertical":"horizontal"),l(),A(n.tabs()))},dependencies:[T,z],styles:[`@charset "UTF-8";

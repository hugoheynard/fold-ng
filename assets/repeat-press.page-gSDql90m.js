import{s as i,N as c,ɵ as y,c as R,b as C,F as w,d as t,g as f,e as a,f as o,T as h,h as b,j as l,m as p,k as P,n as _,r as v}from"./index-Dx8_Baf4.js";import{K as x}from"./kind-badge.component-C1jCOqgD.js";import{FoldPageSectionComponent as D}from"./page-section.component-Bizl_O7p.js";import{FoldCalloutComponent as T}from"./callout.component-4p84tAGQ.js";import{FoldSliderComponent as k}from"./slider.component-CDqH86sX.js";import{F}from"./repeat-press.directive-BMuon3g6.js";import"./element-title.component-CJp0CQ8G.js";import"./input-value-Co_u-z_8.js";const u=0,m=50;class g{min=u;max=m;count=i(8);delay=i(350);period=i(60);atMin=c(()=>this.count()<=u);atMax=c(()=>this.count()>=m);step(n){this.count.update(s=>Math.min(m,Math.max(u,s+n)))}usageCode=c(()=>`<button
  foldRepeatPress

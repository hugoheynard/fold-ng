import{s as c,A as m,ɵ as T,c as L,E as C,d as n,e,f as t,g as P,B as s,i as v,T as y,j as l,m as r,U as $,L as p,o as w,l as F,k as I,N as _,a3 as h,O as k}from"./index-DQihq4bJ.js";import{K as S}from"./kind-badge.component-BY0qC9OD.js";import{C as V}from"./composed-of.component-KHku3Nb1.js";import{D as B}from"./playground.component-BCg0OD4T.js";import{FoldPageSectionComponent as j}from"./page-section.component-BKuKnsqJ.js";import{FoldLinkComponent as D}from"./link.component-BSsIqRjw.js";import"./button.component-D-b3CVOr.js";import"./element-title.component-BWlcw9mv.js";import"./slider.component-CSrU0Ly6.js";import"./input-value-DCGlOvqF.js";const E=()=>["icons"];function H(g,o){if(g&1&&(n(0,"option",14),e(1),t()),g&2){const a=o.$implicit;r("value",a),l(),I(a)}}function N(g,o){if(g&1&&(n(0,"option",14),e(1),t()),g&2){const a=o.$implicit;r("value",a),l(),I(a)}}class b{demoHref="https://fold.sh3pherd.dev/docs";leadingIcons=["none","arrow-back","company","contracts","download","folder-open","globe","mail"];trailingIcons=["none","chevron-right","arrow-right","globe","download"];label=c("View the organisation");tone=c("accent");mode=c("button");leadingIcon=c("company");trailingIcon=c("chevron-right");disabled=c(!1);leading=m(()=>{const o=this.leadingIcon();return o==="none"?void 0:o});trailing=m(()=>{const o=this.trailingIcon();return o==="none"?void 0:o});linkCode=m(()=>{const o=[];this.tone()!=="accent"&&o.push(`tone="${this.tone()}"`),this.leading()&&o.push(`icon="${this.leading()}"`),this.trailing()&&o.push(`trailingIcon="${this.trailing()}"`),this.mode()==="anchor"?o.push(`href="${this.demoHref}"`):(o.push('(clicked)="onClick()"'),this.disabled()&&o.push('[disabled]="true"'));const a=o.length>0?["<fold-link",...o.map(u=>`  ${u}`),">"].join(`

import{bx as V,s as m,A as S,a4 as q,aB as N,ɵ as Q,c as U,bt as D,bu as K,by as W,F as G,d as r,g as M,B as u,e as s,f as l,w as y,i as h,T as F,j as a,m as g,U as J,L as b,x as w,o as x,k as C,a8 as X,a9 as Y,q as c,E as k,l as P,v as j,D as Z,W as E,N as _,O as f,a3 as L}from"./index-Dm7NIW0i.js";import{K as ee}from"./kind-badge.component-DK33NVyt.js";import{C as oe}from"./composed-of.component-BqGz4Rf1.js";import{FoldContextCardComponent as te}from"./context-card.component-CD7zEoBc.js";import"./element-title.component-C_Vb_0Fj.js";function $(i,t){return{prop:V(i),desc:t,kind:"color"}}function z(i,t){return{prop:`--fold-radius-${i}`,desc:t,kind:"radius"}}function ne(i,t,e){const o={...i},n=e.trim();return n?o[t]=n:delete o[t],o}function ie(i,t){const e=Object.entries(t);if(e.length===0)return"/* adjust a token on the left to see the CSS here */";const o=[`${i} {`];for(const[n,d]of e)o.push(`  ${n}: ${d};`);return o.push("}"),o.join(`

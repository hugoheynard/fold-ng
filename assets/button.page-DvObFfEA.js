import{K as _}from"./kind-badge.component-3bNxV8X6.js";import{C as y}from"./composed-of.component-D6vUKU_Q.js";import{s as v,ɵ as k,c as w,b as B,F as C,d as n,g,e as t,f as e,i as d,u,C as x,j as o,m as s,v as z,o as c,k as p,l as m,q as b,B as T,E as F,H as S}from"./index-Diyiz25h.js";import{FoldPageSectionComponent as P}from"./page-section.component-CnyEv15X.js";import{FoldCalloutComponent as A}from"./callout.component-DckUyBRQ.js";import{FoldButtonComponent as L}from"./button.component-C7Xt9H-5.js";import"./element-title.component-DlB8foFm.js";import"./spinner.component-DCOPJK0f.js";import"./tokens.catalog-DF_6rd51.js";const $=()=>["icons","spinner"],E=(l,r)=>r.title;function N(l,r){if(l&1&&(n(0,"fold-card",7)(1,"span",36),g(2,"fold-icon",37),e(),n(3,"h3",38),t(4),e(),n(5,"p",39),t(6),e()()),l&2){const a=r.$implicit;o(2),s("name",a.icon),o(2),p(a.title),o(2),p(a.body)}}function I(l,r){if(l&1&&(n(0,"div",15),t(1),e()),l&2){const a=r.$implicit;o(),p(a)}}function M(l,r){if(l&1){const a=T();n(0,"div",41)(1,"button",42),x("click",function(){F(a);const f=b(2);return S(f.buttonClicks.set(f.buttonClicks()+1))}),t(2),e()()}if(l&2){const a=r.$implicit,i=b().$implicit;o(),s("emphasis",i)("intent",a),o(),m(" ",i," ")}}function V(l,r){if(l&1&&(n(0,"div",40),t(1),e(),d(2,M,3,3,"div",41,u)),l&2){const a=r.$implicit,i=b();o(),p(a),o(),c(i.intents)}}function q(l,r){if(l&1&&(n(0,"button",22),t(1),e()),l&2){const a=r.$implicit;s("size",a),o(),m("size ",a)}}class h{emphases=["solid","soft","outline"];intents=["primary","neutral","warning","danger"];buttonSizes=["sm","md","lg"];buttonClicks=v(0);busy=v(!1);features=[{icon:"code",title:"Native host",body:"It's an attribute on a real <button> or <a> — so type, disabled, form submit, href and routerLink all come from the platform, not a re-implementation."},{icon:"grid",title:"Two orthogonal axes",body:"emphasis (how loud) × intent (what it means). Every cell is expressible — a quiet outline, a soft warning, a filled destructive CTA — from N+M rules, not N×M."},{icon:"reload",title:"Loading, built in",body:"loading swaps the leading glyph for a spinner, sets aria-busy, and blocks activation — while staying lit, not dimmed. No width jump; the spinner is icon-sized."},{icon:"arrow-right",title:"Link as a button",body:"<a foldButton routerLink> is a real anchor that looks like a button — open-in-new-tab, middle-click, and screen-reader semantics intact. No second component."},{icon:"shield",title:"Accessible by default",body:"focus-visible ring, prefers-reduced-motion, and forced-colors (Windows high-contrast) are all honoured; a disabled anchor gets aria-disabled + a non-interactive surface."},{icon:"palette",title:"Token-only surface",body:"Every colour is a --fold-* role resolved through a --b-* engine, so the whole matrix reskins with the theme — never a hard-coded hex."}];usageCode=`<!-- defaults: soft + primary -->

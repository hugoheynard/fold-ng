import{u as s,ao as h,X as T,A as D,ɵ as W,aq as S,F as $,d as c,i as y,f as r,D as f,j as a,o as x,aS as E,E as b,B as k,e as p,q as i,L as z,k as _,w as u,x as m,at as N,m as w,au as j,g as O,N as M,O as P}from"./index-HUDWVz6A.js";import{a as v}from"./chrome.directive-CP1GR_i3.js";import{f as A,a as L,F as q,b as B}from"./cell-B0T9VNLR.js";import{l as H,d as I}from"./date-Blk--MT7.js";import{a as V}from"./filters-17CrhBAd.js";const C=7;function Y(o,e,n,t,l){const d=L(e,{month:n,today:t.today,weekendDays:B(t.weekendDays),counts:l,hidden:q});return{day:d,events:V(o,d.date)}}function K(o,e){const n=H(I(e.date,e.weekStartsOn??"mon")),t=e.date.slice(0,7),l=A(o,n,n+C-1);return Array.from({length:C},(d,F)=>Y(o,n+F,t,e,l))}const R=o=>({$implicit:o,band:null}),X=(o,e)=>e.day.date,G=(o,e)=>e.id;function J(o,e){if(o&1&&N(0,8),o&2){const n=i().$implicit;w("ngTemplateOutlet",e)("ngTemplateOutletContext",j(2,R,n))}}function Q(o,e){o&1&&O(0,"fold-icon",10),o&2&&w("name",e)}function U(o,e){if(o&1&&(c(0,"span",13),p(1),r()),o&2){const n=i(2).$implicit;a(),_(n.subline)}}function Z(o,e){if(o&1&&(O(0,"span",9),u(1,Q,1,1,"fold-icon",10),c(2,"span",11)(3,"span",12),p(4),r(),u(5,U,2,1,"span",13),r()),o&2){let n;const t=i().$implicit;a(),m((n=t.icon)?1:-1,n),a(3),_(t.label),a(),m(t.subline?5:-1)}}function nn(o,e){if(o&1){const n=b();c(0,"li")(1,"button",7),k("click",function(){const l=M(n).$implicit,d=i(2);return P(d.eventClick.emit(l))}),u(2,J,1,4,"ng-container",8)(3,Z,6,3),r()()}if(o&2){let n;const t=e.$implicit,l=i(2);a(),f("data-tone",t.tone??"neutral"),a(),m((n=l.chrome.eventContent())?2:3,n)}}function en(o,e){if(o&1){const n=b();c(0,"section",2)(1,"button",3),k("click",function(){const l=M(n).$implicit,d=i();return P(d.dayClick.emit(l.day.date))}),c(2,"span",4),p(3),r(),c(4,"span",5),p(5),r()(),c(6,"ul",6),y(7,nn,4,2,"li",null,G),r()()}if(o&2){const n=e.$implicit,t=i();z("is-today",n.day.isToday)("is-weekend",n.day.isWeekend),f("aria-label",t.columnLabel(n)),a(),f("aria-current",n.day.isToday?"date":null),a(2),_(t.weekdayName(n)),a(2),_(n.day.dayOfMonth),a(2),x(n.events)}}class g{date=s.required();events=s([]);today=s();weekStartsOn=s();weekendDays=s();dayClick=h();eventClick=h();chrome=T(v);columns=D(()=>K(this.events(),{date:this.date(),weekStartsOn:this.chrome.anchor(this.weekStartsOn()),weekendDays:this.chrome.weekend(this.weekendDays()),today:this.today()}));weekdayName(e){return this.chrome.format(e.day.date,"weekdayShort")}columnLabel(e){const n=this.chrome.l(),t=[this.chrome.format(e.day.date,"dateFull")];return e.day.isToday&&t.push(n.today),e.day.eventCount>0&&t.push(n.eventCount(e.day.eventCount)),t.join(", ")}static ɵfac=function(n){return new(n||g)};static ɵcmp=W({type:g,selectors:[["fold-calendar-week"]],inputs:{date:[1,"date"],events:[1,"events"],today:[1,"today"],weekStartsOn:[1,"weekStartsOn"],weekendDays:[1,"weekendDays"]},outputs:{dayClick:"dayClick",eventClick:"eventClick"},features:[E([{directive:v,inputs:["locale","locale","labels","labels","formats","formats"]}])],decls:3,vars:1,consts:[["role","group",1,"foldcalw"],[1,"foldcalw-col",3,"is-today","is-weekend"],[1,"foldcalw-col"],["type","button",1,"foldcalw-head",3,"click"],[1,"foldcalw-weekday"],[1,"foldcalw-daynum"],[1,"foldcalw-list"],["type","button",1,"foldcal-chip",3,"click"],[3,"ngTemplateOutlet","ngTemplateOutletContext"],[1,"foldcal-chip-bar"],["size","sm",1,"foldcal-chip-icon",3,"name"],[1,"foldcal-chip-body"],[1,"foldcal-chip-label"],[1,"foldcal-chip-sub"]],template:function(n,t){n&1&&(c(0,"div",0),y(1,en,9,8,"section",1,X),r()),n&2&&(f("aria-label",t.chrome.l().grid),a(),x(t.columns()))},dependencies:[S,$],styles:[`[_nghost-%COMP%] {
  display: block;
}

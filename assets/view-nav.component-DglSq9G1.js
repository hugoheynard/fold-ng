import{u as d,ag as h,X as w,a2 as k,A as O,ɵ as F,as as T,F as z,a as V,R as N,aG as $,d as c,i as K,f as s,H as A,L as _,j as r,o as L,w as m,x as g,e as P,q as o,k as M,av as p,$ as b,m as l,aw as S,D as v,aH as u,E as j,B as D,g as y,t as B,N as R,O as E,Q as H}from"./index-BgsKkR4L.js";import{F as U}from"./nav-layout.context-Bz7d6olN.js";const q=t=>({$implicit:t,active:!1}),C=(t,a)=>({$implicit:t,active:a}),I=(t,a)=>a.key;function X(t,a){if(t&1&&(c(0,"button",3),p(1,7),s()),t&2){const n=o().$implicit;o();const e=b(4);r(),l("ngTemplateOutlet",e)("ngTemplateOutletContext",S(2,q,n))}}function Y(t,a){if(t&1&&(c(0,"a",4,1),p(2,7),s()),t&2){const n=b(1),e=o().$implicit;o();const i=b(4);l("routerLink",e.link),v("aria-current",n.isActive?"page":null),r(2),l("ngTemplateOutlet",i)("ngTemplateOutletContext",u(4,C,e,n.isActive))}}function G(t,a){if(t&1&&(c(0,"a",8),p(1,7),s()),t&2){const n=o().$implicit,e=o(),i=b(4);_("is-active",e.activeKey()===n.key),l("href",n.href,B),v("aria-current",e.activeKey()===n.key?"page":null),r(),l("ngTemplateOutlet",i)("ngTemplateOutletContext",u(6,C,n,e.activeKey()===n.key))}}function Q(t,a){if(t&1){const n=j();c(0,"button",9),D("click",function(){R(n);const i=o().$implicit,x=o();return E(x.activeKey.set(i.key))}),p(1,7),s()}if(t&2){const n=o().$implicit,e=o(),i=b(4);_("is-active",e.activeKey()===n.key),v("aria-current",e.activeKey()===n.key?"page":null),r(),l("ngTemplateOutlet",i)("ngTemplateOutletContext",u(5,C,n,e.activeKey()===n.key))}}function J(t,a){if(t&1&&m(0,X,2,4,"button",3)(1,Y,3,7,"a",4)(2,G,2,9,"a",5)(3,Q,2,8,"button",6),t&2){const n=a.$implicit;g(n.disabled?0:n.link!==void 0?1:n.href!==void 0?2:3)}}function W(t,a){t&1&&y(0,"fold-icon",10),t&2&&l("name",a)}function Z(t,a){if(t&1&&(c(0,"span",11),P(1),s()),t&2){const n=o().$implicit;r(),M(n.label.charAt(0))}}function nn(t,a){if(t&1&&y(0,"fold-badge",13),t&2){const n=o(),e=n.$implicit,i=n.active;l("content",e.badge+"")("variant",i?"accent":"neutral")}}function tn(t,a){if(t&1&&(m(0,W,1,1,"fold-icon",10)(1,Z,2,1,"span",11),c(2,"span",12),P(3),s(),m(4,nn,1,2,"fold-badge",13)),t&2){let n;const e=a.$implicit,i=o();g((n=e.icon)?0:i.collapsed()?1:-1,n),r(3),M(e.label),r(),g(e.badge!==void 0&&e.badge!==null?4:-1)}}class f{items=d.required();activeKey=h("");activeStyle=d("underline");direction=d("auto");size=d("compact");collapsed=d(!1,{transform:w});background=d("transparent");layout=k(U,{optional:!0});isStandalone=O(()=>this.layout===null);resolvedDirection=O(()=>{const a=this.direction();return a!=="auto"?a:this.layout?.stacked()?"horizontal":"vertical"});static ɵfac=function(n){return new(n||f)};static ɵcmp=F({type:f,selectors:[["fold-view-nav"]],hostVars:4,hostBindings:function(n,e){n&2&&_("is-standalone",e.isStandalone())("is-horizontal",e.resolvedDirection()==="horizontal")},inputs:{items:[1,"items"],activeKey:[1,"activeKey"],activeStyle:[1,"activeStyle"],direction:[1,"direction"],size:[1,"size"],collapsed:[1,"collapsed"],background:[1,"background"]},outputs:{activeKey:"activeKeyChange"},decls:5,vars:12,consts:[["body",""],["rla","routerLinkActive"],[1,"tab-bar"],["type","button","disabled","","aria-disabled","true",1,"tab-bar-item","is-disabled"],["routerLinkActive","is-active",1,"tab-bar-item",3,"routerLink"],[1,"tab-bar-item",3,"href","is-active"],["type","button",1,"tab-bar-item",3,"is-active"],[3,"ngTemplateOutlet","ngTemplateOutletContext"],[1,"tab-bar-item",3,"href"],["type","button",1,"tab-bar-item",3,"click"],["size","sm",1,"tab-bar-icon",3,"name"],["aria-hidden","true",1,"tab-bar-icon","tab-bar-initial"],[1,"tab-bar-label"],[1,"tab-bar-badge",3,"content","variant"]],template:function(n,e){n&1&&(c(0,"nav",2),K(1,J,4,1,null,null,I),s(),A(3,tn,5,3,"ng-template",null,0,H)),n&2&&(_("style-underline",e.activeStyle()==="underline")("style-fill",e.activeStyle()==="fill")("dir-vertical",e.resolvedDirection()==="vertical")("size-comfortable",e.size()==="comfortable")("is-collapsed",e.collapsed())("bg-surface",e.background()==="surface"),r(),L(e.items()))},dependencies:[T,z,V,N,$],styles:[`@charset "UTF-8";

import{K as P}from"./kind-badge.component-Cu9CMz4Q.js";import{t as d,ɵ as u,d as t,g as l,L as x,f as o,j as s,m as f,M as h,e as n,z as v,k as y,v as w,P as r,w as C,Q as p,x as M,s as O,c as F,b,F as z,G as S,l as k}from"./index-BKzai8u2.js";import{F as T}from"./page-section.component-B4ZAcQ6m.js";import{F as B}from"./button.component-DRDvbHZW.js";import{F as E}from"./spinner.component-Bzvyc33g.js";import"./element-title.component-Dl54jTSk.js";import"./tokens.catalog-DF_6rd51.js";function L(c,i){if(c&1&&(t(0,"span"),n(1),o()),c&2){const e=v();s(),y(e.message())}}class m{message=d("Loading...");size=d("md");static ɵfac=function(e){return new(e||m)};static ɵcmp=u({type:m,selectors:[["fold-loading"]],hostAttrs:["role","status","aria-live","polite"],inputs:{message:[1,"message"],size:[1,"size"]},decls:3,vars:2,consts:[[1,"loading"],["aria-hidden","true",3,"size"]],template:function(e,a){e&1&&(t(0,"div",0),l(1,"fold-spinner",1),x(2,L,2,1,"span"),o()),e&2&&(s(),f("size",a.size()),s(),h(a.message()?2:-1))},dependencies:[E],styles:[`[_nghost-%COMP%] {
  display: flex;
  align-items: center;

import{s as u,A as k,ɵ as y,c as x,d as o,e,f as a,g as T,B as c,w as O,j as s,m as f,U as F,L as p,k as v,x as M,E as b,h,i as R,a3 as j,q as _,n as P,o as z,N as m,r as C,O as g}from"./index-byaimOHk.js";import{K as N}from"./kind-badge.component-OCRcxQM0.js";import{C as A}from"./composed-of.component-DCKcLdtq.js";import{D as B}from"./playground.component-Dw_lSTU6.js";import{FoldPageSectionComponent as E}from"./page-section.component-BvfrU3-t.js";import{FoldPasswordFieldComponent as S}from"./password-field.component-DL7TIufK.js";import"./button.component-CIePUrQ1.js";import"./element-title.component-DHMx96ih.js";import"./slider.component-BTC_Jusw.js";import"./input-value-DCGlOvqF.js";import"./input.component-zm4apix6.js";import"./input-base.component-CdffjMet.js";import"./info.component-Blxessz8.js";import"./common-labels-DfjtcEOM.js";import"./popover.component-CBaqpe0K.js";import"./auto-update-_srfpL1Q.js";import"./popover-trigger.directive-DIR--ZO_.js";import"./label.component-8tLb7_2S.js";const V=()=>["form","icons"],I=(d,t)=>t.label;function L(d,t){if(d&1&&(o(0,"span",20),e(1),a()),d&2){const n=t.$implicit;p("is-met",n.met),s(),v(n.label)}}function W(d,t){if(d&1){const n=b();o(0,"fold-password-field",17,0),h("valueChange",function(l){m(n);const i=_();return C(i.value,l)||(i.value=l),g(l)}),c("validChange",function(l){m(n);const i=_();return g(i.valid.set(l))}),o(2,"div",18),R(3,L,2,3,"span",19,I),a()()}if(d&2){const n=j(1),r=_();f("revealable",r.revealable()),P("value",r.value),s(3),z(n.checklist())}}function q(d,t){if(d&1){const n=b();o(0,"fold-password-field",21),h("valueChange",function(l){m(n);const i=_();return C(i.value,l)||(i.value=l),g(l)}),c("validChange",function(l){m(n);const i=_();return g(i.valid.set(l))}),a()}if(d&2){const n=_();f("marker",n.design()==="ticks"?"check":"dot")("revealable",n.revealable()),P("value",n.value)}}class w{value=u("");valid=u(!1);revealable=u(!0);design=u("default");rulesExample=["import { foldRegexRule, type FoldPasswordRule } from 'fold-ng';","","rules: FoldPasswordRule[] = [","  { label: 'At least 12 characters', test: (v) => v.length >= 12 },","  foldRegexRule('A symbol', /[^A-Za-z0-9]/),","  // zod (no dependency added by fold-ng):","  { label: 'Valid', test: (v) => schema.safeParse(v).success },","];"].join(`

import{u as i,ag as M,a0 as g,X as _,A as v,ah as w,aL as k,ɵ as T,F,a as z,d as c,B as y,i as K,f as d,L as f,D as h,j as l,o as S,a8 as j,a9 as A,E as D,w as m,e as C,q as s,m as b,x as u,k as O,g as x,N as B,O as $}from"./index-Dm7NIW0i.js";import{F as I}from"./tab-tooltip.directive-exSfc_PJ.js";import{F as L}from"./nav-layout.context-wbXoELsE.js";import"./auto-update-_srfpL1Q.js";const V=["tabBtn"],q=(a,t)=>t.key;function E(a,t){a&1&&x(0,"fold-icon",4),a&2&&b("name",t)}function Q(a,t){if(a&1&&(c(0,"span",5),C(1),d()),a&2){const e=s().$implicit;l(),O(e.label.charAt(0))}}function U(a,t){if(a&1&&x(0,"fold-badge",7),a&2){const e=s().$implicit,n=s();b("content",e.badge+"")("variant",n.activeKey()===e.key?"accent":"neutral")}}function H(a,t){if(a&1){const e=D();c(0,"button",3,0),y("click",function(){const o=B(e).$implicit,r=s();return $(r.select(o.key))}),m(2,E,1,1,"fold-icon",4)(3,Q,2,1,"span",5),c(4,"span",6),C(5),d(),m(6,U,1,2,"fold-badge",7),d()}if(a&2){let e;const n=t.$implicit,o=s();f("is-active",o.activeKey()===n.key),b("id",o.tabId(n.key))("tabindex",o.activeKey()===n.key?0:-1),h("aria-selected",o.activeKey()===n.key)("aria-controls",o.panelId(n.key))("aria-label",o.isTooltip(o.activeKey()===n.key)?n.label:null),l(2),u((e=n.icon)?2:o.collapsed()?3:-1,e),l(2),b("foldTabTooltip",o.isTooltip(o.activeKey()===n.key))("tooltipSide",o.tooltipSide()),l(),O(n.label),l(),u(n.badge!==void 0&&n.badge!==null?6:-1)}}class p{tabs=i.required();activeKey=M.required();activeStyle=i("underline");direction=i("auto");size=i("compact");justify=i("start");collapsed=i(!1,{transform:g});background=i("surface");sticky=i(!1,{transform:g});layout=_(L,{optional:!0});tooltipSide=v(()=>this.resolvedDirection()==="vertical"?"right":"bottom");isTooltip(t){return this.collapsed()&&(this.resolvedDirection()==="vertical"||!t)}resolvedDirection=v(()=>{const t=this.direction();return t!=="auto"?t:this.layout?.stacked()?"horizontal":"vertical"});uid=_(w).next("fold-tabs");tabButtons=k("tabBtn");tabId(t){return`${this.uid}-tab-${t}`}panelId(t){return`${this.uid}-panel-${t}`}select(t){this.commit(t)}commit(t){this.activeKey.set(t)}onKeydown(t){const e=this.tabs().map(P=>P.key);if(e.length===0)return;const n=e.indexOf(this.activeKey());let o;switch(t.key){case"ArrowRight":case"ArrowDown":o=(n+1)%e.length;break;case"ArrowLeft":case"ArrowUp":o=(n-1+e.length)%e.length;break;case"Home":o=0;break;case"End":o=e.length-1;break;default:return}t.preventDefault();const r=e[o];r!==void 0&&(this.commit(r),this.tabButtons()[o]?.nativeElement.focus())}static ɵfac=function(e){return new(e||p)};static ɵcmp=T({type:p,selectors:[["fold-tabs"]],viewQuery:function(e,n){e&1&&j(n.tabButtons,V,5),e&2&&A()},hostVars:4,hostBindings:function(e,n){e&2&&f("is-sticky",n.sticky())("is-horizontal",n.resolvedDirection()==="horizontal")},inputs:{tabs:[1,"tabs"],activeKey:[1,"activeKey"],activeStyle:[1,"activeStyle"],direction:[1,"direction"],size:[1,"size"],justify:[1,"justify"],collapsed:[1,"collapsed"],background:[1,"background"],sticky:[1,"sticky"]},outputs:{activeKey:"activeKeyChange"},exportAs:["foldTabs"],decls:3,vars:15,consts:[["tabBtn",""],["role","tablist",1,"tab-bar",3,"keydown"],["type","button","role","tab",1,"tab-bar-item",3,"id","is-active","tabindex"],["type","button","role","tab",1,"tab-bar-item",3,"click","id","tabindex"],["size","sm",1,"tab-bar-icon",3,"name"],["aria-hidden","true",1,"tab-bar-icon","tab-bar-initial"],[1,"tab-bar-label",3,"foldTabTooltip","tooltipSide"],[1,"tab-bar-badge",3,"content","variant"]],template:function(e,n){e&1&&(c(0,"div",1),y("keydown",function(r){return n.onKeydown(r)}),K(1,H,7,12,"button",2,q),d()),e&2&&(f("style-underline",n.activeStyle()==="underline")("style-fill",n.activeStyle()==="fill")("dir-vertical",n.resolvedDirection()==="vertical")("size-comfortable",n.size()==="comfortable")("justify-stretch",n.justify()==="stretch")("is-collapsed",n.collapsed())("bg-surface",n.background()==="surface"),h("aria-orientation",n.resolvedDirection()==="vertical"?"vertical":"horizontal"),l(),S(n.tabs()))},dependencies:[F,z,I],styles:[`@charset "UTF-8";

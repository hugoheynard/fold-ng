import{a1 as _,aP as k,aQ as w,aR as C,aS as T,aT as I,aU as z,aV as S,s as v,ɵ as F,c as P,b as O,a as R,F as N,d as e,g as d,e as n,f as o,i as p,K as m,T as b,w as j,j as t,l as h,o as g,k as l,m as c,x as B,Q as V,S as M,q as y,H as U,U as A,V as E}from"./index-BDLuCW6u.js";import{K as $}from"./kind-badge.component-DgszwHpo.js";import{FoldPageSectionComponent as L}from"./page-section.component-xiZJXhv0.js";import{FoldCalloutComponent as D}from"./callout.component-C9k__drE.js";import{FoldButtonComponent as G}from"./button.component-D6Atuv3I.js";import"./element-title.component-DIg7RV5N.js";import"./spinner.component-C7SDFdgr.js";import"./tokens.catalog-DF_6rd51.js";const H=(r,i)=>i.title,K=(r,i)=>i.key;function q(r,i){if(r&1&&(e(0,"fold-card",6)(1,"span",30),d(2,"fold-icon",31),o(),e(3,"h3",23),n(4),o(),e(5,"p",24),n(6),o()()),r&2){const a=i.$implicit;t(2),c("name",a.icon),t(2),l(a.title),t(2),l(a.body)}}function Q(r,i){if(r&1&&(e(0,"div",14),d(1,"fold-icon",15),e(2,"span"),n(3),o()()),r&2){const a=i.$implicit;t(),c("size",a),t(2),l(a)}}function W(r,i){if(r&1&&(e(0,"span",32),d(1,"fold-icon",33),o()),r&2){const a=i.$implicit;V("color","var(--fold-color-"+a+")")}}function Y(r,i){r&1&&(d(0,"fold-icon",34),e(1,"code"),n(2,'name="demo-sparkle"'),o()),r&2&&c("size",48)}function X(r,i){r&1&&(e(0,"span",27),n(1,"nothing registered yet"),o())}function J(r,i){if(r&1){const a=M();e(0,"button",41),b("click",function(){const u=A(a).$implicit,x=y(2);return E(x.copyIconName(u))}),d(1,"fold-icon",42),e(2,"span",43),n(3),o()()}if(r&2){const a=i.$implicit,s=y(2);U("is-copied",s.copiedIcon()===a),t(),c("name",a)("title",a),t(2),l(s.copiedIcon()===a?"copied!":a)}}function Z(r,i){if(r&1&&(e(0,"div",29)(1,"div",35)(2,"h3",36),n(3),o(),d(4,"fold-badge",37),e(5,"span",38),n(6),o()(),e(7,"div",39),p(8,J,4,5,"button",40,m),o()()),r&2){const a=i.$implicit;t(3),l(a.label),t(),c("content",a.names.length.toString()),t(2),l(a.desc),t(2),g(a.names)}}const ee='<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l2.5 6.9L21.5 11l-6.9 2.5L12 20l-2.5-6.5L2.5 11l7-2.1z"/></svg>';class f{registry=_(k);iconSizeSteps=["xs","sm","md","lg","xl"];iconColorTokens=["text","text-secondary","primary","info","warning","alert","success"];features=[{icon:"code",title:"Typed names",body:"name autocompletes every built-in and compile-errors on a typo — a missing icon is caught before runtime, not after."},{icon:"copy",title:"Shared sprite",body:"Each icon is one <symbol> in a hidden sprite; every instance is a tiny <use>. 1500 renders cost 3 symbols, not 1500 copies."},{icon:"palette",title:"currentColor",body:"Colour is inherited — set color on any ancestor and the icon follows. No colour prop, no theme fork."},{icon:"sliders",title:"Token sizes",body:"xs…xl map to the --fold-icon-size-* scale (or pass a pixel number). A dense theme can rescale every icon at once."},{icon:"shield",title:"Trust-guarded",body:"The registry rejects <script> and inline on*= handlers at registration — the unsanitised inject can't become an XSS sink."},{icon:"lightning",title:"Self-contained",body:"SVGs are inlined into the package — no HTTP fetch, no .svg loader config, no network on first paint."}];categories=[{key:"ui",label:"UI",desc:"Actions, editing, files, view chrome — the everyday verbs.",names:Object.keys(w)},{key:"nav",label:"Navigation",desc:"The app's destinations — roughly one per rail entry.",names:Object.keys(C)},{key:"music",label:"Music & transport",desc:"Playback, waveforms, the audio domain.",names:Object.keys(T)},{key:"status",label:"Status",desc:"State, severity, achievement.",names:Object.keys(I)},{key:"people",label:"People & roles",desc:"Members, leads, rights, roles.",names:Object.keys(z)},{key:"brands",label:"Brands",desc:"Third-party marks — kept apart from the single-glyph sets.",names:Object.keys(S)}];totalCount=this.categories.reduce((i,a)=>i+a.names.length,0);usageCode=`<fold-icon name="search" />

import{s as i,A as c,ɵ as y,c as R,b as C,F as w,d as t,g as f,e as a,f as o,B as h,h as b,j as l,m as p,k as P,n as _,r as v}from"./index-CrZoBIgg.js";import{K as x}from"./kind-badge.component-BCOpHO-V.js";import{FoldPageSectionComponent as D}from"./page-section.component-D5Z0zfei.js";import{FoldCalloutComponent as k}from"./callout.component-ARXYowsx.js";import{FoldSliderComponent as T}from"./slider.component-CeWitcm7.js";import{F}from"./repeat-press.directive-BKI8UHsI.js";import"./input-value-DCGlOvqF.js";const u=0,m=50;class g{min=u;max=m;count=i(8);delay=i(350);period=i(60);atMin=c(()=>this.count()<=u);atMax=c(()=>this.count()>=m);step(n){this.count.update(s=>Math.min(m,Math.max(u,s+n)))}usageCode=c(()=>`<button
  foldRepeatPress

...
}`]})}function As(e){return e===void 0?null:`${e}px`}class pi{content=w.required();radius=w("pill");variant=w("accent");static ɵfac=function(t){return new(t||pi)};static ɵcmp=ae({type:pi,selectors:[["fold-badge"]],hostVars:2,hostBindings:function(t,o){t&2&&lw(o.variant()+" "+o.radius())},inputs:{content:[1,"content"],radius:[1,"radius"],variant:[1,"variant"]},decls:1,vars:1,template:function(t,o){t&1&&E(0),t&2&&Nn("",o.content(),`
...
.icon-root[_ngcontent-%COMP%] {
  ...
  fill: currentColor;
}`]})}const X4=[[["","cardHeader",""]],"*",[["","cardFooter",""]]],K4=["[cardHeader]","*","[cardFooter]"];class gi{surface=w("card");radius=w("lg");padding=w("md");interactive=w(!1);separators=w(!1,{transform:Je});raisedBands=w(!1,{transform:Je});static ɵfac=function(t){return new(t||gi)};static ɵcmp=ae({type:gi,selectors:[["fold-card"]],hostVars:18,hostBindings:function(t,o){t&2&&ve("s-sunken",o.surface()==="sunken")("r-sm",o.radius()==="sm")("r-md",o.radius()==="md")("p-none",o.padding()==="none")("p-sm",o.padding()==="sm")("p-lg",o.padding()==="lg")("is-interactive",o.interactive())("has-sep",o.separators())("raised-bands",o.raisedBands())},inputs:{surface:[1,"surface"],radius:[1,"radius"],padding:[1,"padding"],interactive:[1,"interactive"],separators:[1,"separators"],raisedBands:[1,"raisedBands"]},ngContentSelectors:K4,decls:6,vars:0,consts:[[1,"card-header"],[1,"card-body"],[1,"card-footer"]],template:function(t,o){t&1&&(Bn(X4),Qn(0,"header",0),oe(1),Yn(),Qn(2,"div",1),oe(3,1),Yn(),Qn(4,"footer",2),oe(5,2),Yn())},styles:[`@charset "UTF-8";
...
.expanded[_nghost-%COMP%]   .menu-foot.foot-has-toggle[_ngcontent-%COMP%]   .menu-toggle[_ngcontent-%COMP%] {
  ...
  bottom: 8px;
  margin: 0;
}`]})}function a5(e,n){if(e&1&&(m(0,"span",3),E(1),v()),e&2){const t=k();ve("mi-dot-count",t.isCount()),b(),Fe(t.dotText())}}function l5(e,n){if(e&1&&(m(0,"span",4),E(1),v()),e&2){const t=k(2);b(),Fe(t.badgeText())}}function c5(e,n){if(e&1&&z(0,"fold-badge",5),e&2){const t=k(2);T("content",t.badgeText())("variant",t.badgeVariant())}}function d5(e,n){if(e&1&&W(0,l5,2,1,"span",4)(1,c5,1,2,"fold-badge",5),e&2){const t=k();Q(t.isFollowTone()?0:1)}}const u5={neutral:"var(--fold-color-text-muted)",accent:"var(--fold-color-primary)",info:"var(--fold-color-info)",warning:"var(--fold-color-warning)",alert:"var(--fold-color-alert)",success:"var(--fold-color-success)"};class Ho{icon=w.required();label=w.required();active=w(!1,{transform:Je});badge=w();badgeTone=w("follow");isCount=q(()=>typeof this.badge()=="number");hasBadge=q(()=>{const n=this.badge();return n!==void 0&&n!==""&&n!==0});isFollowTone=q(()=>this.badgeTone()==="follow");badgeAccent=q(()=>{const n=this.badgeTone();return n==="follow"?"var(--mi-accent)":u5[n]});badgeVariant=q(()=>{const n=this.badgeTone();return n==="follow"?"accent":n});badgeText=q(()=>{const n=this.badge();return n===void 0?"":String(n)});dotText=q(()=>{const n=this.badge();return typeof n!="number"?"":n>99?"99+":String(n)});ariaLabel=q(()=>this.hasBadge()?`${this.label()}, ${this.badgeText()}`:null);static ɵfac=function(t){return new(t||Ho)};static ɵcmp=ae({type:Ho,selectors:[["a","fold-menu-item",""],["button","fold-menu-item",""]],hostVars:5,hostBindings:function(t,o){t&2&&(ue("aria-label",o.ariaLabel()),Pn("--mi-badge-accent",o.badgeAccent()),ve("is-active",o.active()))},inputs:{icon:[1,"icon"],label:[1,"label"],active:[1,"active"],badge:[1,"badge"],badgeTone:[1,"badgeTone"]},decls:5,vars:5,consts:[[1,"mi-icon",3,"name","size"],["aria-hidden","true",1,"mi-dot",3,"mi-dot-count"],[1,"mi-tip"],["aria-hidden","true",1,"mi-dot"],[1,"mi-badge","mi-badge-follow"],[1,"mi-badge",3,"content","variant"]],template:function(t,o){t&1&&(z(0,"fold-icon",0),W(1,a5,2,3,"span",1),m(2,"span",2),E(3),v(),W(4,d5,2,1)),t&2&&(T("name",o.icon())("size",18),b(),Q(o.hasBadge()?1:-1),b(2),Fe(o.label()),b(),Q(o.hasBadge()?4:-1))},dependencies:[$e,pi],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  position: relative;
  width: 40px;
  height: 36px;
...
}`]})}class At{document=p(Ee);locks=0;previousOverflow="";lock(){this.locks===0&&(this.previousOverflow=this.document.body.style.overflow,this.document.body.style.overflow="hidden"),this.locks+=1}unlock(){this.locks!==0&&(this.locks-=1,this.locks===0&&(this.document.body.style.overflow=this.previousOverflow))}get isLocked(){return this.locks>0}static ɵfac=function(t){return new(t||At)};static ɵprov=ne({token:At,factory:At.ɵfac})}class Gt{icon=w.required();label=w.required();variant=w("surface");active=w(!1,{transform:Je});static ɵfac=function(t){return new(t||Gt)};static ɵcmp=ae({type:Gt,selectors:[["a","fold-nav-tile",""],["button","fold-nav-tile",""]],hostAttrs:[1,"fold-nav-tile"],hostVars:5,hostBindings:function(t,o){t&2&&(ue("aria-current",o.active()?"page":null),ve("is-filled",o.variant()==="filled")("is-active",o.active()))},inputs:{icon:[1,"icon"],label:[1,"label"],variant:[1,"variant"],active:[1,"active"]},decls:3,vars:3,consts:[[1,"nt-icon",3,"name","size"],[1,"nt-label"]],template:function(t,o){t&1&&(z(0,"fold-icon",0),m(1,"span",1),E(2),v()),t&2&&(T("name",o.icon())("size",26),b(2),Fe(o.label()))},dependencies:[$e],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
...
}`]})}const v5=["*"];function b5(e,n){if(e&1){const t=Ae();m(0,"div",0),j("click",function(){re(t);const r=k();return ie(r.close())}),v(),m(1,"div",1)(2,"button",2),j("click",function(){re(t);const r=k();return ie(r.close())}),z(3,"fold-icon",3),v(),m(4,"div",4),oe(5),v()()}if(e&2){const t=k();b(),T("foldFocusTrap",t.open()),ue("aria-label",t.label()),b(3),Pn("--nav-cols",t.resolvedCols())}}class yi{open=Qi(!1);label=w("Navigation");columns=w("auto");tiles=$p(Gt);resolvedCols=q(()=>{const n=this.columns();return n!=="auto"?Number(n):this.tiles().length<=4?2:3});scrollLock=p(At);locked=!1;constructor(){bt(()=>{const n=this.open();n&&!this.locked?(this.scrollLock.lock(),this.locked=!0):!n&&this.locked&&(this.scrollLock.unlock(),this.locked=!1)}),p(an).onDestroy(()=>{this.locked&&(this.scrollLock.unlock(),this.locked=!1)})}onEscape(){this.open()&&this.open.set(!1)}close(){this.open.set(!1)}static ɵfac=function(t){return new(t||yi)};static ɵcmp=ae({type:yi,selectors:[["fold-nav-launcher"]],contentQueries:function(t,o,r){t&1&&nc(r,o.tiles,Gt,4),t&2&&tc()},hostBindings:function(t,o){t&1&&j("keydown.escape",function(){return o.onEscape()},bl)},inputs:{open:[1,"open"],label:[1,"label"],columns:[1,"columns"]},outputs:{open:"openChange"},ngContentSelectors:v5,decls:1,vars:1,consts:[["aria-hidden","true",1,"nl-scrim",3,"click"],["role","dialog","aria-modal","true","tabindex","-1",1,"nl-dialog",3,"foldFocusTrap"],["type","button","aria-label","Close navigation",1,"nl-close",3,"click"],["name","close","size","md"],[1,"nl-grid"]],template:function(t,o){t&1&&(Bn(),W(0,b5,6,4)),t&2&&Q(o.open()?0:-1)},dependencies:[$t,$e],styles:[`@charset "UTF-8";
...
}`]})}class wi{foldElevated=w(!0,{transform:Je});static ɵfac=function(t){return new(t||wi)};static ɵdir=jn({type:wi,selectors:[["","foldElevated",""]],hostVars:1,hostBindings:function(t,o){t&2&&ue("data-elevated",o.foldElevated()?"":null)},inputs:{foldElevated:[1,"foldElevated"]}})}const y5=["*",[["p","description",""]],[["","pageActions",""]],[["","titleBadge",""]]],w5=["*","p[description]","[pageActions]","[titleBadge]"];function x5(e,n){e&1&&z(0,"fold-icon",6),e&2&&T("name",n)("size",22)}function _5(e,n){if(e&1&&(m(0,"h1",3),W(1,x5,1,2,"fold-icon",6),m(2,"span"),E(3),v(),m(4,"span",7),oe(5,3),v()()),e&2){let t;const o=k(2);b(),Q((t=o.icon())?1:-1,t),b(2),Fe(o.title())}}function C5(e,n){if(e&1&&(m(0,"header",0)(1,"div",2),W(2,_5,6,2,"h1",3),m(3,"div",4),oe(4,1),v()(),m(5,"div",5),oe(6,2),v()()),e&2){const t=k();b(2),Q(t.title()?2:-1)}}class xi{title=w();icon=w();static ɵfac=function(t){return new(t||xi)};static ɵcmp=ae({type:xi,selectors:[["fold-page-layout"]],inputs:{title:[1,"title"],icon:[1,"icon"]},ngContentSelectors:w5,decls:3,vars:1,consts:[[1,"page-head"],[1,"page-body"],[1,"page-head-text"],[1,"page-title"],[1,"page-desc"],[1,"page-actions"],[1,"page-icon",3,"name","size"],[1,"page-title-badge"]],template:function(t,o){t&1&&(Bn(y5),W(0,C5,7,1,"header",0),m(1,"div",1),oe(2),v()),t&2&&Q(o.title()?0:-1)},dependencies:[$e],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: flex;
  flex-direction: column;
...
.page-body[_ngcontent-%COMP%] {
  ...
  gap: var(--fold-page-gap, 32px);
}`]})}const k5=["*"];function S5(e,n){if(e&1){const t=Ae();m(0,"button",3),j("click",function(){re(t);const r=k();return ie(r.dismiss.emit())}),z(1,"fold-icon",4),v()}e&2&&(b(),T("size",14))}const O5={success:"check-circle",info:"info",warning:"warning",error:"x-circle"};class _i{variant=w("info");dismissible=w(!0,{transform:Je});duration=w(0,{transform:Jw});dismiss=Vp();icon=q(()=>O5[this.variant()]);constructor(){bt(n=>{const t=this.duration();if(t<=0)return;const o=setTimeout(()=>this.dismiss.emit(),t);n(()=>clearTimeout(o))})}static ɵfac=function(t){return new(t||_i)};static ɵcmp=ae({type:_i,selectors:[["fold-toast"]],hostVars:3,hostBindings:function(t,o){t&2&&ue("data-variant",o.variant())("role",o.variant()==="error"?"alert":"status")("aria-live",o.variant()==="error"?"assertive":"polite")},inputs:{variant:[1,"variant"],dismissible:[1,"dismissible"],duration:[1,"duration"]},outputs:{dismiss:"dismiss"},ngContentSelectors:k5,decls:4,vars:3,consts:[["aria-hidden","true",1,"toast-icon",3,"name","size"],[1,"toast-message"],["type","button","aria-label","Dismiss",1,"toast-close"],["type","button","aria-label","Dismiss",1,"toast-close",3,"click"],["name","close","aria-hidden","true",3,"size"]],template:function(t,o){t&1&&(Bn(),z(0,"fold-icon",0),m(1,"span",1),oe(2),v(),W(3,S5,2,1,"button",2)),t&2&&(T("name",o.icon())("size",16),b(3),Q(o.dismissible()?3:-1))},dependencies:[$e],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
...
@media (prefers-reduced-motion: reduce) {
  ...
  gap: 8px;
  pointer-events: none; 
}`]})}class ki{descriptor=w.required({alias:"foldPanelComponentOutlet"});viewContainer=p(ro);constructor(){bt(()=>{const n=this.descriptor();this.viewContainer.clear();const t=this.viewContainer.createComponent(n.component,{injector:n.injector});n.data!==void 0&&t.setInput("data",n.data)})}static ɵfac=function(t){return new(t||ki)};static ɵdir=jn({type:ki,selectors:[["","foldPanelComponentOutlet",""]],inputs:{descriptor:[1,"foldPanelComponentOutlet","descriptor"]}})}class Pa{id;dismiss;closed;resolveClosed;settled=!1;constructor(n,t){this.id=n,this.dismiss=t,this.closed=new Promise(o=>{this.resolveClosed=o})}close(n){this.settled||(this.settled=!0,this.dismiss(n),this.resolveClosed(n))}}const P5=new I("FOLD_PANEL_CLOSE_LABEL",{factory:()=>"Close"});function V0(e){return`fold-panel-title-${e}`}const R5=["*",[["","actions",""]]],L5=["*","[actions]"];function D5(e,n){if(e&1&&z(0,"fold-icon",3),e&2){const t=k();T("name",n)("size",t.iconSize())}}function F5(e,n){if(e&1&&(m(0,"p",5),E(1),v()),e&2){const t=k();b(),Fe(t.subtitle())}}class Bo{title=w.required();subtitle=w("");icon=w(void 0);variant=w("title");closeLabel=w();defaultCloseLabel=p(P5);effectiveCloseLabel=q(()=>this.closeLabel()??this.defaultCloseLabel);closed=Vp();iconSize=q(()=>this.variant()==="eyebrow"?14:18);panelRef=p(Pa,{optional:!0});titleId=q(()=>this.panelRef?V0(this.panelRef.id):null);onClose(){this.closed.emit(),this.panelRef?.close()}static ɵfac=function(t){return new(t||Bo)};static ɵcmp=ae({type:Bo,selectors:[["fold-panel-header"]],inputs:{title:[1,"title"],subtitle:[1,"subtitle"],icon:[1,"icon"],variant:[1,"variant"],closeLabel:[1,"closeLabel"]},outputs:{closed:"closed"},ngContentSelectors:L5,decls:13,vars:7,consts:[[1,"ph"],[1,"ph__titles"],[1,"ph__titleRow"],[1,"ph__icon",3,"name","size"],[1,"ph__title"],[1,"ph__subtitle"],[1,"ph__desc"],[1,"ph__actions"],["type","button",1,"ph__close",3,"click"],["name","close","size","sm"]],template:function(t,o){if(t&1&&(Bn(R5),m(0,"header",0)(1,"div",1)(2,"div",2),W(3,D5,1,2,"fold-icon",3),m(4,"h2",4),E(5),v()(),W(6,F5,2,1,"p",5),m(7,"div",6),oe(8),v()(),m(9,"div",7),oe(10,1),m(11,"button",8),j("click",function(){return o.onClose()}),z(12,"fold-icon",9),v()()()),t&2){let r;ve("ph--eyebrow",o.variant()==="eyebrow"),b(3),Q((r=o.icon())?3:-1,r),b(),ue("id",o.titleId()),b(),Fe(o.title()),b(),Q(o.subtitle()?6:-1),b(5),ue("aria-label",o.effectiveCloseLabel())}},dependencies:[$e],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: block;
  flex: none;
}
...
}`]})}const B5=(e,n)=>n.name;function U5(e,n){if(e&1&&(m(0,"span",9),E(1),v()),e&2){const t=n.$implicit;b(),Fe(t)}}function V5(e,n){if(e&1&&(m(0,"section",3)(1,"h3",5),E(2,"Composes"),v(),m(3,"div",8),lt(4,U5,2,1,"span",9,mp),v()()),e&2){const t=k();b(4),ct(t.data().info.composes)}}function q5(e,n){if(e&1){const t=Ae();m(0,"button",10),j("click",function(){re(t);const r=k();return ie(r.resetAll())}),E(1),v()}if(e&2){const t=k();b(),Nn(" Reset ",t.dirtyCount()," ")}}function $5(e,n){if(e&1&&z(0,"span",17),e&2){const t=k().$implicit,o=k(2);Pn("background",o.valueOf(t))}}function G5(e,n){if(e&1){const t=Ae();m(0,"button",18),j("click",function(){re(t);const r=k().$implicit,i=k(2);return ie(i.resetOne(r.name))}),E(1," ↺ "),v()}}function Z5(e,n){if(e&1){const t=Ae();m(0,"div",11)(1,"div",12),W(2,$5,1,2,"span",13),m(3,"span",14),E(4),v(),W(5,G5,2,0,"button",15),v(),m(6,"input",16,0),j("change",function(){const r=re(t).$implicit,i=Un(7),s=k(2);return ie(s.set(r.name,i.value))}),v()()}if(e&2){const t=n.$implicit,o=k(2);b(2),Q(o.isColorToken(t.name)?2:-1),b(2),Fe(t.name),b(),Q(o.overrides()[t.name]?5:-1),b(),T("value",o.valueOf(t))}}function W5(e,n){if(e&1&&lt(0,Z5,8,4,"div",11,B5),e&2){const t=k();ct(t.rows())}}function Q5(e,n){e&1&&(m(0,"p",7),E(1,"No design tokens referenced."),v())}class Oi{data=w.required();rows=H([]);overrides=H({});dirtyCount=q(()=>Object.keys(this.overrides()).length);constructor(){kl(()=>{const n=getComputedStyle(document.documentElement);this.rows.set(this.data().info.tokens.map(t=>({name:t,base:n.getPropertyValue(t).trim()})))})}valueOf(n){return this.overrides()[n.name]??n.base}set(n,t){this.data().element.style.setProperty(n,t),this.overrides.update(o=>({...o,[n]:t}))}resetOne(n){this.data().element.style.removeProperty(n),this.overrides.update(t=>Object.fromEntries(Object.entries(t).filter(([o])=>o!==n)))}resetAll(){for(const n of Object.keys(this.overrides()))this.data().element.style.removeProperty(n);this.overrides.set({})}isColorToken(n){return n.startsWith("--fold-color-")||n.startsWith("--fold-ref-")}static ɵfac=function(t){return new(t||Oi)};static ɵcmp=ae({type:Oi,selectors:[["app-inspect-panel"]],inputs:{data:[1,"data"]},decls:10,vars:5,consts:[["field",""],["subtitle","tokens & composition — edits apply to this element only",3,"title"],[1,"ins-body"],[1,"ins-block"],[1,"ins-block-top"],[1,"ins-heading"],["type","button",1,"ins-reset-all"],[1,"ins-empty"],[1,"ins-chips"],[1,"ins-chip"],["type","button",1,"ins-reset-all",3,"click"],[1,"ins-row"],[1,"ins-row-head"],[1,"ins-swatch",3,"background"],[1,"ins-name"],["type","button","title","Reset to default",1,"ins-reset-one"],[1,"ins-field",3,"change","value"],[1,"ins-swatch"],["type","button","title","Reset to default",1,"ins-reset-one",3,"click"]],template:function(t,o){t&1&&(z(0,"fold-panel-header",1),m(1,"div",2),W(2,V5,6,0,"section",3),m(3,"section",3)(4,"div",4)(5,"h3",5),E(6),v(),W(7,q5,2,1,"button",6),v(),W(8,W5,2,0)(9,Q5,2,0,"p",7),v()()),t&2&&(T("title",o.data().info.selector),b(2),Q(o.data().info.composes.length?2:-1),b(4),Nn("Tokens · ",o.rows().length),b(),Q(o.dirtyCount()?7:-1),b(),Q(o.rows().length?8:9))},dependencies:[Bo],styles:[`[_nghost-%COMP%] {
  flex: 1 1 auto;
  display: flex;
  flex-direction: column;
  min-height: 0;

import{u as c,W as y,am as h,a1 as w,N as k,ɵ as F,ao as T,F as z,a as V,R as N,aH as $,d as s,i as A,f as d,A as K,H as v,j as r,o as L,w as p,x as g,e as O,q as o,k as P,as as _,$ as b,m as l,at as S,Z as f,aI as C,S as j,T as I,g as M,t as R,U,V as D,I as q}from"./index-BOlWLkpq.js";import{F as E}from"./nav-layout.context-DbVvi5Nx.js";const H=t=>({$implicit:t,active:!1}),u=(t,a)=>({$implicit:t,active:a}),Y=(t,a)=>a.key;function B(t,a){if(t&1&&(s(0,"button",3),_(1,7),d()),t&2){const n=o().$implicit;o();const e=b(4);r(),l("ngTemplateOutlet",e)("ngTemplateOutletContext",S(2,H,n))}}function W(t,a){if(t&1&&(s(0,"a",4,1),_(2,7),d()),t&2){const n=b(1),e=o().$implicit;o();const i=b(4);l("routerLink",e.link),f("aria-current",n.isActive?"page":null),r(2),l("ngTemplateOutlet",i)("ngTemplateOutletContext",C(4,u,e,n.isActive))}}function X(t,a){if(t&1&&(s(0,"a",8),_(1,7),d()),t&2){const n=o().$implicit,e=o(),i=b(4);v("is-active",e.activeKey()===n.key),l("href",n.href,R),f("aria-current",e.activeKey()===n.key?"page":null),r(),l("ngTemplateOutlet",i)("ngTemplateOutletContext",C(6,u,n,e.activeKey()===n.key))}}function Z(t,a){if(t&1){const n=j();s(0,"button",9),I("click",function(){U(n);const i=o().$implicit,x=o();return D(x.activeChange.emit(i.key))}),_(1,7),d()}if(t&2){const n=o().$implicit,e=o(),i=b(4);v("is-active",e.activeKey()===n.key),f("aria-current",e.activeKey()===n.key?"page":null),r(),l("ngTemplateOutlet",i)("ngTemplateOutletContext",C(5,u,n,e.activeKey()===n.key))}}function G(t,a){if(t&1&&p(0,B,2,4,"button",3)(1,W,3,7,"a",4)(2,X,2,9,"a",5)(3,Z,2,8,"button",6),t&2){const n=a.$implicit;g(n.disabled?0:n.link!==void 0?1:n.href!==void 0?2:3)}}function J(t,a){t&1&&M(0,"fold-icon",10),t&2&&l("name",a)}function Q(t,a){if(t&1&&(s(0,"span",11),O(1),d()),t&2){const n=o().$implicit;r(),P(n.label.charAt(0))}}function nn(t,a){if(t&1&&M(0,"fold-badge",13),t&2){const n=o(),e=n.$implicit,i=n.active;l("content",e.badge+"")("variant",i?"accent":"neutral")}}function tn(t,a){if(t&1&&(p(0,J,1,1,"fold-icon",10)(1,Q,2,1,"span",11),s(2,"span",12),O(3),d(),p(4,nn,1,2,"fold-badge",13)),t&2){let n;const e=a.$implicit,i=o();g((n=e.icon)?0:i.collapsed()?1:-1,n),r(3),P(e.label),r(),g(e.badge!==void 0&&e.badge!==null?4:-1)}}class m{items=c.required();activeKey=c("");activeStyle=c("underline");direction=c("auto");size=c("compact");collapsed=c(!1,{transform:y});background=c("transparent");activeChange=h();layout=w(E,{optional:!0});resolvedDirection=k(()=>{const a=this.direction();return a!=="auto"?a:this.layout?.stacked()?"horizontal":"vertical"});static ɵfac=function(n){return new(n||m)};static ɵcmp=F({type:m,selectors:[["fold-view-nav"]],inputs:{items:[1,"items"],activeKey:[1,"activeKey"],activeStyle:[1,"activeStyle"],direction:[1,"direction"],size:[1,"size"],collapsed:[1,"collapsed"],background:[1,"background"]},outputs:{activeChange:"activeChange"},decls:5,vars:12,consts:[["body",""],["rla","routerLinkActive"],[1,"tab-bar"],["type","button","disabled","","aria-disabled","true",1,"tab-bar-item","is-disabled"],["routerLinkActive","is-active",1,"tab-bar-item",3,"routerLink"],[1,"tab-bar-item",3,"href","is-active"],["type","button",1,"tab-bar-item",3,"is-active"],[3,"ngTemplateOutlet","ngTemplateOutletContext"],[1,"tab-bar-item",3,"href"],["type","button",1,"tab-bar-item",3,"click"],["size","sm",1,"tab-bar-icon",3,"name"],["aria-hidden","true",1,"tab-bar-icon","tab-bar-initial"],[1,"tab-bar-label"],[1,"tab-bar-badge",3,"content","variant"]],template:function(n,e){n&1&&(s(0,"nav",2),A(1,G,4,1,null,null,Y),d(),K(3,tn,5,3,"ng-template",null,0,q)),n&2&&(v("style-underline",e.activeStyle()==="underline")("style-fill",e.activeStyle()==="fill")("dir-vertical",e.resolvedDirection()==="vertical")("size-comfortable",e.size()==="comfortable")("is-collapsed",e.collapsed())("bg-surface",e.background()==="surface"),r(),L(e.items()))},dependencies:[T,z,V,N,$],styles:[`@charset "UTF-8";

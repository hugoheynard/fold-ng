import{aj as a,X as o,Y as l,u as r,a0 as d,ag as c,A as i,ɵ as m,a1 as g,a2 as p,an as f,D as h,L as _}from"./index-Bm0v4t0h.js";const u=new a("FOLD_LISTBOX_OWNER"),b=["*"];class n{host=o(l);owner=o(u);value=r.required();disabled=r(!1,{transform:d});id=o(c).next("fold-option");selected=i(()=>this.owner.isSelected(this.value()));active=i(()=>this.owner.activeId()===this.id);get label(){return this.host.nativeElement.textContent?.trim()??""}scrollIntoView(){this.host.nativeElement.scrollIntoView?.({block:"nearest"})}static ɵfac=function(t){return new(t||n)};static ɵcmp=m({type:n,selectors:[["fold-option"]],hostAttrs:["role","option"],hostVars:9,hostBindings:function(t,e){t&2&&(f("id",e.id),h("aria-selected",e.selected())("aria-disabled",e.disabled()||null),_("is-active",e.active())("is-selected",e.selected())("is-disabled",e.disabled()))},inputs:{value:[1,"value"],disabled:[1,"disabled"]},ngContentSelectors:b,decls:1,vars:0,template:function(t,e){t&1&&(g(),p(0))},styles:[`[_nghost-%COMP%] {
  display: flex;
  align-items: center;
  gap: 0.55rem;

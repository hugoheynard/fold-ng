import{s as m,A as x,ɵ as b,c as C,b as k,d as t,e,f as o,g as y,i as w,w as T,B as d,T as F,j as p,m as _,U as D,o as P,x as O,E as v,k as h,q as c,L as M,l as $,N as f,O as g}from"./index-FWo1_vlb.js";import{K as B}from"./kind-badge.component-BqFau3bA.js";import{C as E}from"./composed-of.component-B0DOaQxp.js";import{D as R}from"./playground.component-CBsuzCkn.js";import{FoldButtonComponent as z}from"./button.component-BMWxiYFy.js";import{FoldButtonIconComponent as I}from"./button-icon.component-BDDtwcoc.js";import{FoldPopoverComponent as L}from"./popover.component-DFSB6Mv9.js";import{F as S}from"./popover-trigger.directive-B4eoAED4.js";import{FoldDropdownComponent as j}from"./dropdown.component-BAAogPWX.js";import{FoldDropdownItemComponent as A}from"./dropdown-item.component-gguZI1BJ.js";import"./element-title.component-4wJEF9rV.js";import"./page-section.component-BfJThHUf.js";import"./slider.component-D952b8lh.js";import"./input-value-Co_u-z_8.js";import"./spinner.component--s3PE8iH.js";import"./tokens.catalog-DF_6rd51.js";const V=()=>["button","button-icon","icons"],G=(l,a)=>a.id;function K(l,a){if(l&1){const i=v();t(0,"li",9)(1,"span"),e(2),o(),t(3,"fold-dropdown",31),y(4,"fold-button-icon",32),t(5,"fold-dropdown-item",27),d("selected",function(){const r=f(i).$implicit,s=c();return g(s.act("Rename",r))}),e(6," Rename "),o(),t(7,"fold-dropdown-item",28),d("selected",function(){const r=f(i).$implicit,s=c();return g(s.act("Duplicate",r))}),e(8," Duplicate "),o(),t(9,"fold-dropdown-item",30),d("selected",function(){const r=f(i).$implicit,s=c();return g(s.act("Delete",r))}),e(10," Delete "),o()()()}if(l&2){const i=a.$implicit;p(2),h(i.name)}}function N(l,a){if(l&1){const i=v();t(0,"li",10)(1,"button",33),d("click",function(){f(i);const r=c();return g(r.resetRows())}),e(2," Reset list "),o()()}}function q(l,a){l&1&&(t(0,"span",11),e(1),o()),l&2&&(p(),h(a))}function H(l,a){if(l&1){const i=v();t(0,"button",34),d("click",function(){const r=f(i).$implicit,s=c();return g(s.pgPlacement.set(r))}),e(1),o()}if(l&2){const i=a.$implicit,n=c();M("is-on",n.pgPlacement()===i),p(),$(" ",i," ")}}class u{rows=m([{id:"r1",name:"Spring tour"},{id:"r2",name:"Summer festival"},{id:"r3",name:"Gala"}]);log=m(null);act(a,i){this.log.set(`${a} · ${i.name}`),a==="Delete"&&this.rows.update(n=>n.filter(r=>r.id!==i.id))}resetRows(){this.rows.set([{id:"r1",name:"Spring tour"},{id:"r2",name:"Summer festival"},{id:"r3",name:"Gala"}]),this.log.set(null)}notify=m(!0);digest=m(!1);placements=["bottom-start","bottom","bottom-end","top-start","top-end","right","left"];pgPlacement=m("bottom-start");playgroundCode=x(()=>`<fold-dropdown placement="${this.pgPlacement()}" ariaLabel="Actions">

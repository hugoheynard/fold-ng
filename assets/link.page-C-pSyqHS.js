import{s as c,y as _,ɵ as C,c as P,B as T,d as n,e,f as t,g as L,C as s,i as v,u as y,j as i,m as r,v as $,D as p,o as w,l as F,k as I,E as f,Q as h,H as k}from"./index-Ci6yhgBI.js";import{K as S}from"./kind-badge.component-kkE1GCNe.js";import{C as V}from"./composed-of.component-BFYwCvH7.js";import{D as B}from"./playground.component-Cexjr9Cf.js";import{FoldPageSectionComponent as j}from"./page-section.component-BArtEj3s.js";import{FoldLinkComponent as D}from"./link.component-DbDlqu6D.js";import"./button.component-DMBE20VB.js";import"./spinner.component-kdzKoVrH.js";import"./tokens.catalog-DF_6rd51.js";import"./element-title.component-CGnuUH0f.js";import"./slider.component-CcQuXEuq.js";import"./input-value-Co_u-z_8.js";const H=()=>["icons"];function E(g,a){if(g&1&&(n(0,"option",14),e(1),t()),g&2){const l=a.$implicit;r("value",l),i(),I(l)}}function z(g,a){if(g&1&&(n(0,"option",14),e(1),t()),g&2){const l=a.$implicit;r("value",l),i(),I(l)}}class b{demoHref="https://fold.sh3pherd.dev/docs";leadingIcons=["none","arrow-back","company","contracts","download","folder-open","globe","mail"];trailingIcons=["none","chevron-right","arrow-right","globe","download"];label=c("View the organisation");tone=c("accent");mode=c("button");leadingIcon=c("company");trailingIcon=c("chevron-right");disabled=c(!1);leading=_(()=>this.leadingIcon()==="none"?void 0:this.leadingIcon());trailing=_(()=>this.trailingIcon()==="none"?void 0:this.trailingIcon());linkCode=_(()=>{const a=[];this.tone()!=="accent"&&a.push(`tone="${this.tone()}"`),this.leading()&&a.push(`icon="${this.leading()}"`),this.trailing()&&a.push(`trailingIcon="${this.trailing()}"`),this.mode()==="anchor"?a.push(`href="${this.demoHref}"`):(a.push('(clicked)="onClick()"'),this.disabled()&&a.push('[disabled]="true"'));const l=a.length>0?["<fold-link",...a.map(u=>`  ${u}`),">"].join(`

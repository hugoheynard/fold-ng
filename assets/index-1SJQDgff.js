const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/home.page-BrkPMxj4.js","assets/aside-layout.component-BffwySlS.js","assets/avatar-detail.component-CdZ5vkqI.js","assets/disclosure.component-D0dAZ_JR.js","assets/button.component-D5e90GMa.js","assets/spinner.component-CdDGG8SV.js","assets/tokens.catalog-DF_6rd51.js","assets/callout.component-CXrvp05S.js","assets/hero-section.component-DnxghHDs.js","assets/page-section.component-DjGia3bw.js","assets/element-title.component-DKl8d2Fn.js","assets/hero-card.page-P_nZ0re6.js","assets/kind-badge.component-DDuAk4WD.js","assets/sticky-column.page-DSnFdKtE.js","assets/playground.component-De8BL-of.js","assets/slider.component-DFYxZkht.js","assets/input-value-Co_u-z_8.js","assets/aside-layout.page-DRzTGZFz.js","assets/tab-layout.page-Dv_lvfIn.js","assets/tab-layout.component-A3S0-X6K.js","assets/tab-nav.component-BiTK2tjW.js","assets/page-layout.page-BWR8fCD5.js","assets/tab-nav.page-DrZ0vBCu.js","assets/tab-panel.component-CCHbxAW4.js","assets/page-section.page-BbiHfSnJ.js","assets/hero-section.page-Bnw9z7bi.js","assets/card.page-CxhwVA9H.js","assets/button.page-CP5zezcl.js","assets/button-icon.page-BsCSVHZl.js","assets/link.page-CK0emP88.js","assets/link.component-CQi2bC9N.js","assets/element-title.page-HHAIWXja.js","assets/context-card.page-Bje000Hc.js","assets/context-card.component-Dak_1jm1.js","assets/badges.page-Ceqm-eUD.js","assets/status-badge.component-CQe9y9kE.js","assets/field.page-CGMf3_Bi.js","assets/timeline.page-HRP9nrZG.js","assets/form-layout.page-C72uQOL5.js","assets/input.component-GJXkBgmr.js","assets/choice-row.component-CPFEgb3f.js","assets/dropzone.page-Bxjgnvmu.js","assets/toast.page-Baoql1ZD.js","assets/callout.page-DaDqGOP8.js","assets/disclosure.page-MOQs2wzs.js","assets/state.page-DW3X673a.js","assets/icons.page-BV3cQDft.js","assets/spinner.page-BKHXfbLX.js","assets/repeat-press.page-ClN0r2Ug.js","assets/repeat-press.directive-Dt7yYXNo.js","assets/themes.page-B_X3aG3B.js","assets/form.page-C1DkrIXB.js","assets/avatar.page-Dw5qKPxs.js","assets/app-shell.page-COKJXIrr.js","assets/menu.page-mgl3QA6Y.js","assets/nav-launcher.page-DJ1MiBKX.js"])))=>i.map(i=>d[i]);
...
}`]})}const v5=["*"];function b5(e,n){if(e&1){const t=Ae();m(0,"div",0),j("click",function(){re(t);const r=k();return ie(r.close())}),v(),m(1,"div",1)(2,"button",2),j("click",function(){re(t);const r=k();return ie(r.close())}),z(3,"fold-icon",3),v(),m(4,"div",4),oe(5),v()()}if(e&2){const t=k();b(),T("foldFocusTrap",t.open()),ue("aria-label",t.label()),b(3),Pn("--nav-cols",t.resolvedCols())}}class yi{open=Qi(!1);label=w("Navigation");columns=w("auto");tiles=$p(Gt);resolvedCols=q(()=>{const n=this.columns();return n!=="auto"?n:this.tiles().length<=4?2:3});scrollLock=p(At);locked=!1;constructor(){bt(()=>{const n=this.open();n&&!this.locked?(this.scrollLock.lock(),this.locked=!0):!n&&this.locked&&(this.scrollLock.unlock(),this.locked=!1)}),p(an).onDestroy(()=>{this.locked&&(this.scrollLock.unlock(),this.locked=!1)})}onEscape(){this.open()&&this.open.set(!1)}close(){this.open.set(!1)}static ɵfac=function(t){return new(t||yi)};static ɵcmp=ae({type:yi,selectors:[["fold-nav-launcher"]],contentQueries:function(t,o,r){t&1&&nc(r,o.tiles,Gt,4),t&2&&tc()},hostBindings:function(t,o){t&1&&j("keydown.escape",function(){return o.onEscape()},bl)},inputs:{open:[1,"open"],label:[1,"label"],columns:[1,"columns"]},outputs:{open:"openChange"},ngContentSelectors:v5,decls:1,vars:1,consts:[["aria-hidden","true",1,"nl-scrim",3,"click"],["role","dialog","aria-modal","true","tabindex","-1",1,"nl-dialog",3,"foldFocusTrap"],["type","button","aria-label","Close navigation",1,"nl-close",3,"click"],["name","close","size","md"],[1,"nl-grid"]],template:function(t,o){t&1&&(Bn(),W(0,b5,6,4)),t&2&&Q(o.open()?0:-1)},dependencies:[$t,$e],styles:[`@charset "UTF-8";

import{s as i,x as c,ɵ as y,c as R,b as C,F as x,d as t,g as f,e as a,f as o,B as h,h as b,j as l,m as p,k as P,n as _,r as v}from"./index-Dbcb4g4H.js";import{K as w}from"./kind-badge.component-C_75qMgM.js";import{FoldPageSectionComponent as D}from"./page-section.component-DiQZzl3P.js";import{FoldCalloutComponent as T}from"./callout.component-BTYnxCAg.js";import{FoldSliderComponent as k}from"./slider.component-6bFMN-Ml.js";import{F}from"./repeat-press.directive-L5d6Jn-q.js";import"./element-title.component-BLUhFK5N.js";import"./input-value-Co_u-z_8.js";const u=0,m=50;class g{min=u;max=m;count=i(8);delay=i(350);period=i(60);atMin=c(()=>this.count()<=u);atMax=c(()=>this.count()>=m);step(n){this.count.update(s=>Math.min(m,Math.max(u,s+n)))}usageCode=c(()=>`<button
  foldRepeatPress

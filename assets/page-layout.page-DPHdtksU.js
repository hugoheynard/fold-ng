import{s as d,x as v,ɵ as P,R as k,c as x,Q as C,b as T,a as B,d as t,g as _,e,f as n,B as p,H as u,h as A,j as a,m as f,C as c,I as g,n as L,z as b,l as w,A as F,q as y,D as I,E as z,r as D}from"./index-Dbcb4g4H.js";import{D as M}from"./playground.component-BWYu6A1d.js";import{K as R}from"./kind-badge.component-C_75qMgM.js";import{FoldPageSectionComponent as j}from"./page-section.component-DiQZzl3P.js";import{F as S}from"./avatar.component-JLPOjmVK.js";import{FoldButtonComponent as E}from"./button.component-BGInLuyE.js";import{FoldCalloutComponent as W}from"./callout.component-BTYnxCAg.js";import{FoldSliderComponent as N}from"./slider.component-6bFMN-Ml.js";import"./element-title.component-BLUhFK5N.js";import"./spinner.component-DXgfbeTy.js";import"./tokens.catalog-DF_6rd51.js";import"./input-value-Co_u-z_8.js";function V(l,i){if(l&1){const s=F();t(0,"button",11),p("click",function(){I(s);const r=y();return z(r.showIcon.set(!r.showIcon()))}),e(1," icon "),n()}if(l&2){const s=y();c("is-on",s.showIcon())}}function H(l,i){l&1&&(t(0,"span",20),_(1,"fold-avatar",29),t(2,"span",30),e(3,"Acme Records "),t(4,"span",31),e(5,"· Workspace"),n()()())}function K(l,i){l&1&&_(0,"fold-badge",21)}function Y(l,i){l&1&&(t(0,"p",2),e(1,"Your company subscription and payment methods."),n())}function q(l,i){l&1&&(t(0,"button",22),e(1,"Export"),n())}function G(l,i){l&1&&(t(0,"fold-page-section",25)(1,"fold-card",32)(2,"p",24),e(3," Bleed band — spans the layout edge-to-edge. It cancels "),t(4,"code"),e(5,"--fold-page-gutter"),n(),e(6," exactly (the same token the page pads with), so it stays flush against the dashed guides as you drag the slider. "),n()()())}class m{headerMode=d("title");showIcon=d(!0);showBadge=d(!1);showDesc=d(!0);showActions=d(!0);showBleed=d(!0);gutter=d(32);code=v(()=>{const i=[];if(this.headerMode()==="custom")i.push("<fold-page-layout>",'  <span pageTitle><fold-avatar name="Acme Records" size="sm" /> Acme Records</span>');else{const s=this.showIcon()?' icon="grid"':"";i.push(`<fold-page-layout${s} title="Billing">`)}return this.showBadge()&&i.push('  <fold-badge titleBadge content="Pro" variant="accent" />'),this.showDesc()&&i.push("  <p description>Your company subscription and payments.</p>"),this.showActions()&&i.push("  <button pageActions>Export</button>"),i.push('  <fold-page-section title="Payment methods">…</fold-page-section>'),this.showBleed()&&i.push("  <fold-page-section bleed>… edge-to-edge band …</fold-page-section>"),i.push('  <fold-page-section title="Invoices">…</fold-page-section>',"</fold-page-layout>"),i.join(`

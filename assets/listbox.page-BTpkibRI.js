import{u as R,A as z,ɵ as E,y as _,i as y,e,z as x,L,j as l,o as w,k as u,w as W,x as D,W as $,aN as N,q as C,s as m,aq as B,c as K,E as V,d as a,f as o,g as P,H as U,h as b,at as T,a3 as I,m as d,U as q,n as g,T as M,B as j,l as A,N as f,O as v,Q as G,r as h}from"./index-BqoA3odo.js";import{K as J}from"./kind-badge.component-isEfmB6Q.js";import{C as X}from"./composed-of.component-GtFtU5Nq.js";import{D as Y}from"./playground.component-MSqyRpCn.js";import{FoldPageSectionComponent as H}from"./page-section.component-DU6eOFo0.js";import{FoldTabsComponent as Q}from"./tabs.component-DjhfuRLE.js";import{FoldTabPanelComponent as Z}from"./tab-panel.component-DBwzXCeN.js";import{FoldListboxComponent as ee}from"./listbox.component-Caj1awSd.js";import{FoldMultiselectComponent as oe}from"./multiselect.component-GpwHFJJg.js";import{FoldOptgroupComponent as ae}from"./optgroup.component-Dv7q9nsY.js";import{F as te}from"./option.component-Z5Oe0b4L.js";import{FoldSelectComponent as le}from"./select.component-tvccGs5t.js";import"./button.component-LHfkJxSf.js";import"./element-title.component-BsM9pNw2.js";import"./slider.component-t_yIc4Ps.js";import"./input-value-DCGlOvqF.js";import"./tab-tooltip.directive-B7Ge75CU.js";import"./auto-update-_srfpL1Q.js";import"./nav-layout.context-vfjLzBJJ.js";import"./common-labels-CZQOwANu.js";import"./popover.component-Dfg-euh4.js";import"./popover-trigger.directive-CVwZekL0.js";import"./input-base.component-CwIhzYI9.js";import"./info.component-V_B8UyRt.js";import"./label.component-SGdJ9c9o.js";import"./listbox-nav-BkSv-wOH.js";const ne=(s,i)=>i.box;function ie(s,i){if(s&1&&(_(0,"div",2),N(1,"span",8),_(2,"span",9),e(3),x(),_(4,"span",10),e(5,"↓"),x()()),s&2){const n=C().$implicit;l(3),u(n.flow)}}function se(s,i){if(s&1&&(W(0,ie,6,1,"div",2),_(1,"div",3)(2,"span",4),e(3),x(),_(4,"div",5)(5,"code",6),e(6),x(),_(7,"span",7),e(8),x()()()),s&2){const n=i.$implicit,t=i.$index,c=i.$index;D(c!==0?0:-1),l(),$("--i",t),l(2),u(t+1),l(3),u(n.box),l(2),u(n.note)}}const re=s=>({kind:"popover",layers:[{box:"<button> trigger",note:s?'aria-haspopup="listbox" · aria-expanded · summarises the picks':'aria-haspopup="listbox" · aria-expanded · shows the selected label',flow:""},{box:"fold-popover — native top layer",note:"escapes overflow + z-index · flip → size → shift · publishes --fold-popover-anchor-width",flow:"click / ↓ opens"},{box:s?'role="listbox" + aria-multiselectable — holds focus':'role="listbox" — holds focus',note:"aria-activedescendant → the active option's id (focus never leaves)",flow:"renders the panel"},{box:"fold-option × N",note:"each derives its own selected / active from the owner (a computed reading the FOLD_LISTBOX_OWNER token — nothing pushed in during change detection)",flow:"projects rows"}],footer:s?"↑/↓ move active · Enter/Space toggles membership · panel stays open · value = readonly string[]":"↑/↓ move active · Enter commits + closes · returns focus to the trigger · value = string"}),de={kind:"native",layers:[{box:"fold-select",note:"a thin wrapper — styled box + custom caret over the real control",flow:""},{box:"native <select>",note:"[value] / (change) · Signal Forms · the browser owns keyboard + focus",flow:"wraps"},{box:"OS popup (browser / operating system)",note:"NOT in your DOM · not styleable · a native mobile wheel for free",flow:"opens"},{box:"<option> × N",note:"real projected option elements — plain text only",flow:"lists"}],footer:"styleable panel / custom rows?  ✗    ·    accessible + mobile-native out of the box?  ✓"};class O{kind=R.required();schema=z(()=>{const i=this.kind();return i==="select"?de:re(i==="multi")});static ɵfac=function(n){return new(n||O)};static ɵcmp=E({type:O,selectors:[["gal-select-schema"]],inputs:{kind:[1,"kind"]},decls:5,vars:3,consts:[[1,"sc"],[1,"sc-footer"],["aria-hidden","true",1,"sc-flow"],[1,"sc-layer"],[1,"sc-num"],[1,"sc-body"],[1,"sc-box"],[1,"sc-note"],[1,"sc-flow-line"],[1,"sc-flow-label"],[1,"sc-flow-arrow"]],template:function(n,t){n&1&&(_(0,"div",0),y(1,se,9,6,null,null,ne),_(3,"p",1),e(4),x()()),n&2&&(L("sc-native",t.schema().kind==="native"),l(),w(t.schema().layers),l(3),u(t.schema().footer))},styles:[`[_nghost-%COMP%] {
  display: block;
}
...
.sc-footer[_ngcontent-%COMP%] {
  ...
  color: var(--fold-color-text-secondary);
  line-height: var(--fold-leading-normal);
}`]})}const ce=()=>["popover","icons"],F=(s,i)=>i.value,pe=(s,i)=>i.id;function ue(s,i){if(s&1){const n=V();a(0,"button",44),j("click",function(){const c=f(n).$implicit,p=C(2);return v(p.size.set(c))}),e(1),o()}if(s&2){const n=i.$implicit,t=C(2);L("is-on",t.size()===n),l(),A(" ",n," ")}}function me(s,i){if(s&1){const n=V();a(0,"button",44),j("click",function(){const c=f(n).$implicit,p=C(2);return v(p.variant.set(c))}),e(1),o()}if(s&2){const n=i.$implicit,t=C(2);L("is-on",t.variant()===n),l(),A(" ",n," ")}}function fe(s,i){if(s&1&&(a(0,"div",40)(1,"span",41),e(2,"size"),o(),a(3,"div",42),y(4,ue,2,3,"button",43,M),o()(),a(6,"div",40)(7,"span",41),e(8,"variant"),o(),a(9,"div",42),y(10,me,2,3,"button",43,M),o()()),s&2){const n=C();l(4),w(n.sizes),l(6),w(n.variants)}}function ve(s,i){if(s&1&&(a(0,"fold-option",15),e(1),o()),s&2){const n=i.$implicit;d("value",n.value),l(),u(n.label)}}function be(s,i){if(s&1&&(a(0,"fold-option",15),e(1),o()),s&2){const n=i.$implicit;d("value",n.value),l(),u(n.label)}}function ge(s,i){if(s&1&&(a(0,"option",15),e(1),o()),s&2){const n=i.$implicit;d("value",n.value),l(),u(n.label)}}function he(s,i){if(s&1&&(a(0,"fold-option",15),e(1),o()),s&2){const n=i.$implicit;d("value",n),l(),u(n.name)}}class S{tab=m("listbox");tabs=[{key:"listbox",label:"listbox",icon:"list"},{key:"grouped",label:"grouped",icon:"folder-open"},{key:"multi",label:"multiselect",icon:"check-circle"},{key:"select",label:"select · native",icon:"chevron-down"},{key:"typed",label:"typed value",icon:"code"}];cityValue=m(null);cityArrayValue=m(null);cityGroups=[{label:"France",options:[{value:"paris",label:"Paris"},{value:"lyon",label:"Lyon"}]},{label:"Italia",options:[{value:"roma",label:"Roma"},{value:"milano",label:"Milano"}]}];groupedCode=`<!-- projected: <fold-optgroup> around <fold-option>s -->
...
<fold-listbox label="Ville" [(value)]="city" [options]="groups" />`;plans=[{value:1,label:"Starter"},{value:2,label:"Pro"},{value:3,label:"Enterprise",disabled:!0}];planId=m(2);teams=[{id:10,name:"Design"},{id:20,name:"Engineering"}];team=m(null);sameId=(i,n)=>i.id===n.id;typedCode=`<!-- number ids via the [options] array API -->

import{K as b}from"./kind-badge.component-CUehdKqc.js";import{ɵ as _,w as h,M as c,x as y,N as p,u as m,v as x,e as n,K as C,j as a,k as v,L as F,q as w,c as k,a as T,F as M,d as t,g as d,f as l,m as g}from"./index-CheKRm5v.js";import{F as P}from"./status-badge.component-B5s_33SL.js";import{F as S}from"./link.component-mRXPCymW.js";const O=["*"];class r{static ɵfac=function(e){return new(e||r)};static ɵcmp=_({type:r,selectors:[["fold-field-list"]],ngContentSelectors:O,decls:2,vars:0,consts:[[1,"fl"]],template:function(e,s){e&1&&(h(),c(0,"dl",0),y(1),p())},styles:[`@charset "UTF-8";
...
.fl[_ngcontent-%COMP%] {
  ...
  min-width: 0;
}`]})}const E=["*"];function z(i,o){if(i&1&&(c(0,"dd",1),n(1),p()),i&2){const e=w();a(),v(e.placeholder())}}function B(i,o){i&1&&(c(0,"dd",2),y(1),p())}class f{label=m.required();empty=m(!1,{transform:x});placeholder=m("—");static ɵfac=function(e){return new(e||f)};static ɵcmp=_({type:f,selectors:[["fold-field"]],inputs:{label:[1,"label"],empty:[1,"empty"],placeholder:[1,"placeholder"]},ngContentSelectors:E,decls:4,vars:2,consts:[[1,"fl-key"],[1,"fl-val","fl-empty"],[1,"fl-val"]],template:function(e,s){e&1&&(h(),c(0,"dt",0),n(1),p(),C(2,z,2,1,"dd",1)(3,B,2,0,"dd",2)),e&2&&(a(),v(s.label()),a(),F(s.empty()?2:3))},styles:[`@charset "UTF-8";

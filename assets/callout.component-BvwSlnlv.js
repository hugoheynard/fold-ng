import{u as a,a0 as i,A as r,ɵ as d,F as f,a1 as u,g as v,d as l,a2 as s,f as c,m as _,D as p,L as g}from"./index-4XDcEdxi.js";const m=["*",[["","actions",""]]],h=["*","[actions]"],b={neutral:"info",accent:"lightning",info:"info",success:"completed",warning:"warning",alert:"warning"};class e{variant=a("neutral");appearance=a("inset");icon=a();announce=a(!1,{transform:i});iconName=r(()=>this.icon()??b[this.variant()]);role=r(()=>this.announce()?this.variant()==="alert"?"alert":"status":"note");ariaLive=r(()=>this.announce()?this.variant()==="alert"?"assertive":"polite":null);static ɵfac=function(o){return new(o||e)};static ɵcmp=d({type:e,selectors:[["fold-callout"]],hostVars:16,hostBindings:function(o,n){o&2&&(p("role",n.role())("aria-live",n.ariaLive()),g("v-neutral",n.variant()==="neutral")("v-accent",n.variant()==="accent")("v-info",n.variant()==="info")("v-success",n.variant()==="success")("v-warning",n.variant()==="warning")("v-alert",n.variant()==="alert")("is-flat",n.appearance()==="flat"))},inputs:{variant:[1,"variant"],appearance:[1,"appearance"],icon:[1,"icon"],announce:[1,"announce"]},exportAs:["foldCallout"],ngContentSelectors:h,decls:5,vars:2,consts:[[1,"callout-icon",3,"name","size"],[1,"callout-body"],[1,"callout-actions"]],template:function(o,n){o&1&&(u(m),v(0,"fold-icon",0),l(1,"span",1),s(2),c(),l(3,"span",2),s(4,1),c()),o&2&&_("name",n.iconName())("size",15)},dependencies:[f],styles:[`@charset "UTF-8";

...
.expanded[_nghost-%COMP%]   .menu-foot.foot-has-toggle[_ngcontent-%COMP%]   .menu-toggle[_ngcontent-%COMP%] {
  ...
  bottom: 8px;
  margin: 0;
}`]})}function d5(e,n){if(e&1&&(m(0,"span",3),E(1),v()),e&2){const t=k();ve("mi-dot-count",t.isCount()),b(),Fe(t.dotText())}}function u5(e,n){if(e&1&&(m(0,"span",4),E(1),v()),e&2){const t=k(2);b(),Fe(t.badgeText())}}function f5(e,n){if(e&1&&z(0,"fold-badge",5),e&2){const t=k(2);I("content",t.badgeText())("variant",t.badgeVariant())}}function h5(e,n){if(e&1&&W(0,u5,2,1,"span",4)(1,f5,1,2,"fold-badge",5),e&2){const t=k();Q(t.isFollowTone()?0:1)}}const p5={neutral:"var(--fold-color-text-muted)",accent:"var(--fold-color-primary)",info:"var(--fold-color-info)",warning:"var(--fold-color-warning)",alert:"var(--fold-color-alert)",success:"var(--fold-color-success)"};class Ho{icon=w.required();label=w.required();active=w(!1,{transform:dn});badge=w();badgeTone=w("follow");isCount=q(()=>typeof this.badge()=="number");hasBadge=q(()=>{const n=this.badge();return n!==void 0&&n!==""&&n!==0});isFollowTone=q(()=>this.badgeTone()==="follow");badgeAccent=q(()=>{const n=this.badgeTone();return n==="follow"?"var(--mi-accent)":p5[n]});badgeVariant=q(()=>{const n=this.badgeTone();return n==="follow"?"accent":n});badgeText=q(()=>{const n=this.badge();return n===void 0?"":String(n)});dotText=q(()=>{const n=this.badge();return typeof n!="number"?"":n>99?"99+":String(n)});ariaLabel=q(()=>this.hasBadge()?`${this.label()}, ${this.badgeText()}`:null);static ɵfac=function(t){return new(t||Ho)};static ɵcmp=le({type:Ho,selectors:[["a","fold-menu-item",""],["button","fold-menu-item",""]],hostVars:5,hostBindings:function(t,o){t&2&&(J("aria-label",o.ariaLabel()),Rn("--mi-badge-accent",o.badgeAccent()),ve("is-active",o.active()))},inputs:{icon:[1,"icon"],label:[1,"label"],active:[1,"active"],badge:[1,"badge"],badgeTone:[1,"badgeTone"]},decls:5,vars:5,consts:[[1,"mi-icon",3,"name","size"],["aria-hidden","true",1,"mi-dot",3,"mi-dot-count"],[1,"mi-tip"],["aria-hidden","true",1,"mi-dot"],[1,"mi-badge","mi-badge-follow"],[1,"mi-badge",3,"content","variant"]],template:function(t,o){t&1&&(z(0,"fold-icon",0),W(1,d5,2,3,"span",1),m(2,"span",2),E(3),v(),W(4,h5,2,1)),t&2&&(I("name",o.icon())("size",18),b(),Q(o.hasBadge()?1:-1),b(2),Fe(o.label()),b(),Q(o.hasBadge()?4:-1))},dependencies:[$e,gi],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  position: relative;
  width: 40px;
  height: 36px;
...
}`]})}const q5=(e,n)=>n.name;function $5(e,n){if(e&1&&(m(0,"span",9),E(1),v()),e&2){const t=n.$implicit;b(),Fe(t)}}function G5(e,n){if(e&1&&(m(0,"section",3)(1,"h3",5),E(2,"Composes"),v(),m(3,"div",8),lt(4,$5,2,1,"span",9,yp),v()()),e&2){const t=k();b(4),ct(t.data().info.composes)}}function Z5(e,n){if(e&1){const t=Ae();m(0,"button",10),N("click",function(){ie(t);const r=k();return se(r.resetAll())}),E(1),v()}if(e&2){const t=k();b(),jn(" Reset ",t.dirtyCount()," ")}}function W5(e,n){if(e&1&&z(0,"span",17),e&2){const t=k().$implicit,o=k(2);Rn("background",o.valueOf(t))}}function Q5(e,n){if(e&1){const t=Ae();m(0,"button",18),N("click",function(){ie(t);const r=k().$implicit,i=k(2);return se(i.resetOne(r.name))}),E(1," ↺ "),v()}}function Y5(e,n){if(e&1){const t=Ae();m(0,"div",11)(1,"div",12),W(2,W5,1,2,"span",13),m(3,"span",14),E(4),v(),W(5,Q5,2,0,"button",15),v(),m(6,"input",16,0),N("change",function(){const r=ie(t).$implicit,i=Un(7),s=k(2);return se(s.set(r.name,i.value))}),v()()}if(e&2){const t=n.$implicit,o=k(2);b(2),Q(o.isColorToken(t.name)?2:-1),b(2),Fe(t.name),b(),Q(o.overrides()[t.name]?5:-1),b(),I("value",o.valueOf(t))}}function K5(e,n){if(e&1&&lt(0,Y5,8,4,"div",11,q5),e&2){const t=k();ct(t.rows())}}function X5(e,n){e&1&&(m(0,"p",7),E(1,"No design tokens referenced."),v())}class Ti{data=w.required();rows=H([]);overrides=H({});dirtyCount=q(()=>Object.keys(this.overrides()).length);constructor(){Tl(()=>{const n=getComputedStyle(document.documentElement);this.rows.set(this.data().info.tokens.map(t=>({name:t,base:n.getPropertyValue(t).trim()})))})}valueOf(n){return this.overrides()[n.name]??n.base}set(n,t){this.data().element.style.setProperty(n,t),this.overrides.update(o=>({...o,[n]:t}))}resetOne(n){this.data().element.style.removeProperty(n),this.overrides.update(t=>Object.fromEntries(Object.entries(t).filter(([o])=>o!==n)))}resetAll(){for(const n of Object.keys(this.overrides()))this.data().element.style.removeProperty(n);this.overrides.set({})}isColorToken(n){return n.startsWith("--fold-color-")||n.startsWith("--fold-ref-")}static ɵfac=function(t){return new(t||Ti)};static ɵcmp=le({type:Ti,selectors:[["app-inspect-panel"]],inputs:{data:[1,"data"]},decls:10,vars:5,consts:[["field",""],["subtitle","tokens & composition — edits apply to this element only",3,"title"],[1,"ins-body"],[1,"ins-block"],[1,"ins-block-top"],[1,"ins-heading"],["type","button",1,"ins-reset-all"],[1,"ins-empty"],[1,"ins-chips"],[1,"ins-chip"],["type","button",1,"ins-reset-all",3,"click"],[1,"ins-row"],[1,"ins-row-head"],[1,"ins-swatch",3,"background"],[1,"ins-name"],["type","button","title","Reset to default",1,"ins-reset-one"],[1,"ins-field",3,"change","value"],[1,"ins-swatch"],["type","button","title","Reset to default",1,"ins-reset-one",3,"click"]],template:function(t,o){t&1&&(z(0,"fold-panel-header",1),m(1,"div",2),W(2,G5,6,0,"section",3),m(3,"section",3)(4,"div",4)(5,"h3",5),E(6),v(),W(7,Z5,2,1,"button",6),v(),W(8,K5,2,0)(9,X5,2,0,"p",7),v()()),t&2&&(I("title",o.data().info.selector),b(2),Q(o.data().info.composes.length?2:-1),b(4),jn("Tokens · ",o.rows().length),b(),Q(o.dirtyCount()?7:-1),b(),Q(o.rows().length?8:9))},dependencies:[Uo],styles:[`[_nghost-%COMP%] {
  flex: 1 1 auto;
  display: flex;
  flex-direction: column;
  min-height: 0;
...
`,IC=`// fold-number-input renders the same box as fold-input (see input-shell.scss)

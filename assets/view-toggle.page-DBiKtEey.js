import{s as d,A as O,ɵ as P,c as h,d as t,e,f as n,g as k,i as v,T as f,B as _,h as z,j as s,m as u,U as V,o as b,L as p,k as x,n as F,E as y,q as g,l as w,N as C,O as T,r as L}from"./index-9YeDDZTb.js";import{K as M}from"./kind-badge.component-CqigNCAO.js";import{C as S}from"./composed-of.component-YZCuaBpL.js";import{D as B}from"./playground.component-CPOUF4wz.js";import{FoldViewToggleComponent as $}from"./view-toggle.component-jgpwzPGl.js";import"./button.component-j-gHmsM1.js";import"./spinner.component-Ba4I5VZA.js";import"./tokens.catalog-DF_6rd51.js";import"./element-title.component-BMl-YnCE.js";import"./page-section.component-B-6rzTV5.js";import"./slider.component-CJCfMc9r.js";import"./input-value-Co_u-z_8.js";const I=()=>["icons"];function E(c,a){if(c&1){const i=y();t(0,"button",10),_("click",function(){const l=C(i).$implicit,r=g();return T(r.size.set(l))}),e(1),n()}if(c&2){const i=a.$implicit,o=g();p("is-on",o.size()===i),s(),w(" ",i," ")}}function W(c,a){if(c&1){const i=y();t(0,"button",10),_("click",function(){const l=C(i).$implicit,r=g();return T(r.active.set(l))}),e(1),n()}if(c&2){const i=a.$implicit,o=g();p("is-on",o.active()===i),s(),w(" ",i," ")}}class m{view=d("cards");size=d("md");iconOnly=d(!1);active=d("raised");sizes=["sm","md"];actives=["raised","accent"];options=[{value:"cards",label:"Cards",icon:"grid",ariaLabel:"Cards"},{value:"table",label:"Table",icon:"list",ariaLabel:"Table"}];code=O(()=>{const a=['ariaLabel="View"','[options]="options"'];return this.size()!=="md"&&a.push(`size="${this.size()}"`),this.active()!=="raised"&&a.push(`activeStyle="${this.active()}"`),this.iconOnly()&&a.push("iconOnly"),a.push('[(value)]="view"'),["<fold-view-toggle",...a.map(i=>`  ${i}`),"/>"].join(`

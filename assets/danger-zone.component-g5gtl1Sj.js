import{X as f,ah as g,u as t,ap as C,ɵ as u,F as v,a1 as h,d as a,g as b,e as _,f as d,a2 as P,w as x,j as o,m as s,k as z,x as O,D as M,E as y,B as w,q as p,l as F,N as I,O as k}from"./index-DBdQCP3z.js";import{FoldButtonComponent as D}from"./button.component-Pr_PsLhE.js";import{FoldInlineConfirmComponent as j}from"./inline-confirm.component-BWnUZz9o.js";import"./input.component-D6vH52TP.js";import"./input-base.component-Db9cnxkc.js";import"./info.component-BH4ZJ7cC.js";import"./popover.component-BTjj0mJD.js";import"./popover-trigger.directive-wtZkAKad.js";import"./label.component-AYajecbO.js";import"./input-value-DCGlOvqF.js";const B=["*"];function T(c,r){if(c&1){const n=y();a(0,"div",4)(1,"fold-inline-confirm",5),w("confirmed",function(i){I(n);const m=p();return k(m.confirmed.emit(i))}),a(2,"button",6),_(3),d()()()}if(c&2){const n=p();o(),s("match",n.confirmPhrase()??"")("message",n.message()??"")("intent",n.intent()),o(),s("intent",n.intent()),o(),F(" ",r," ")}}class l{ids=f(g);title=t.required();appearance=t("filled");actionLabel=t();confirmPhrase=t();message=t();intent=t("danger");confirmed=C();titleId=this.ids.next("fold-danger-zone");static ɵfac=function(n){return new(n||l)};static ɵcmp=u({type:l,selectors:[["fold-danger-zone"]],hostAttrs:["role","group"],hostVars:2,hostBindings:function(n,e){n&2&&M("data-appearance",e.appearance())("aria-labelledby",e.titleId)},inputs:{title:[1,"title"],appearance:[1,"appearance"],actionLabel:[1,"actionLabel"],confirmPhrase:[1,"confirmPhrase"],message:[1,"message"],intent:[1,"intent"]},outputs:{confirmed:"confirmed"},ngContentSelectors:B,decls:7,vars:3,consts:[[1,"dz-head"],["name","warning","size","sm","aria-hidden","true",1,"dz-icon"],[1,"dz-title",3,"id"],[1,"dz-body"],[1,"dz-actions"],[3,"confirmed","match","message","intent"],["foldButton","","emphasis","solid",3,"intent"]],template:function(n,e){if(n&1&&(h(),a(0,"div",0),b(1,"fold-icon",1),a(2,"h3",2),_(3),d()(),a(4,"div",3),P(5),d(),x(6,T,4,5,"div",4)),n&2){let i;o(2),s("id",e.titleId),o(),z(e.title()),o(3),O((i=e.actionLabel())?6:-1,i)}},dependencies:[v,D,j],styles:[`[_nghost-%COMP%] {
  display: block;

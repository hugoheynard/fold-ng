import{t as d,u as $,X as I,V as w,B as v,Y as S,Z as K,ɵ as M,F as B,a as z,d as i,G as g,i as m,f as a,x as f,S as O,j as r,o as u,N as j,O as D,E,L as k,e as t,z as _,m as c,M as T,k as b,g as x,H as L,I as R,v as V,w as U,_ as q,s as h,R as H,c as N,T as Q,l as Y}from"./index-SxNeY3lN.js";import{K as X}from"./kind-badge.component-zeG66IfW.js";import{D as G}from"./playground.component-D1YK4L8A.js";import{F as W}from"./callout.component-8Es_fX5a.js";import{F as Z}from"./nav-layout.component-U6AKtzPj.js";import{F as J}from"./nav-layout.context--h8MOz-v.js";import"./button.component-Duqv0Z-n.js";import"./spinner.component-CrxWhUXX.js";import"./tokens.catalog-DF_6rd51.js";import"./element-title.component-9Tsav4pt.js";import"./page-section.component-C9h3raWe.js";const nn=["tabBtn"],tn=(s,o)=>o.key;function en(s,o){s&1&&x(0,"fold-icon",4),s&2&&c("name",o)}function an(s,o){if(s&1&&(i(0,"span",5),t(1),a()),s&2){const e=_().$implicit;r(),b(e.label.charAt(0))}}function on(s,o){if(s&1&&x(0,"fold-badge",7),s&2){const e=_().$implicit,n=_();c("content",e.badge+"")("variant",n.activeKey()===e.key?"accent":"neutral")}}function rn(s,o){if(s&1){const e=E();i(0,"button",3,0),g("click",function(){const l=L(e).$implicit,p=_();return R(p.select(l.key))}),k(2,en,1,1,"fold-icon",4)(3,an,2,1,"span",5),i(4,"span",6),t(5),a(),k(6,on,1,2,"fold-badge",7),a()}if(s&2){let e;const n=o.$implicit,l=_();f("is-active",l.activeKey()===n.key),c("id",l.tabId(n.key))("tabindex",l.activeKey()===n.key?0:-1),O("aria-selected",l.activeKey()===n.key)("aria-controls",l.panelId(n.key)),r(2),T((e=n.icon)?2:l.collapsed()?3:-1,e),r(3),b(n.label),r(),T(n.badge!==void 0&&n.badge!==null?6:-1)}}class y{tabs=d.required();activeKey=d.required();activeStyle=d("underline");direction=d("auto");size=d("compact");collapsed=d(!1,{transform:$});background=d("surface");tabChange=I();layout=w(J,{optional:!0});resolvedDirection=v(()=>{const o=this.direction();return o!=="auto"?o:this.layout?.stacked()?"horizontal":"vertical"});uid=w(S).next("fold-tabs");tabButtons=K("tabBtn");tabId(o){return`${this.uid}-tab-${o}`}panelId(o){return`${this.uid}-panel-${o}`}select(o){this.tabChange.emit(o)}onKeydown(o){const e=this.tabs().map(A=>A.key);if(e.length===0)return;const n=e.indexOf(this.activeKey());let l;switch(o.key){case"ArrowRight":case"ArrowDown":l=(n+1)%e.length;break;case"ArrowLeft":case"ArrowUp":l=(n-1+e.length)%e.length;break;case"Home":l=0;break;case"End":l=e.length-1;break;default:return}o.preventDefault();const p=e[l];p!==void 0&&(this.tabChange.emit(p),this.tabButtons()[l]?.nativeElement.focus())}static ɵfac=function(e){return new(e||y)};static ɵcmp=M({type:y,selectors:[["fold-tabs"]],viewQuery:function(e,n){e&1&&j(n.tabButtons,nn,5),e&2&&D()},inputs:{tabs:[1,"tabs"],activeKey:[1,"activeKey"],activeStyle:[1,"activeStyle"],direction:[1,"direction"],size:[1,"size"],collapsed:[1,"collapsed"],background:[1,"background"]},outputs:{tabChange:"tabChange"},exportAs:["foldTabs"],decls:3,vars:13,consts:[["tabBtn",""],["role","tablist",1,"tab-bar",3,"keydown"],["type","button","role","tab",1,"tab-bar-item",3,"id","is-active","tabindex"],["type","button","role","tab",1,"tab-bar-item",3,"click","id","tabindex"],["size","sm",1,"tab-bar-icon",3,"name"],["aria-hidden","true",1,"tab-bar-icon","tab-bar-initial"],[1,"tab-bar-label"],[1,"tab-bar-badge",3,"content","variant"]],template:function(e,n){e&1&&(i(0,"div",1),g("keydown",function(p){return n.onKeydown(p)}),m(1,rn,7,9,"button",2,tn),a()),e&2&&(f("style-underline",n.activeStyle()==="underline")("style-fill",n.activeStyle()==="fill")("dir-vertical",n.resolvedDirection()==="vertical")("size-comfortable",n.size()==="comfortable")("is-collapsed",n.collapsed())("bg-surface",n.background()==="surface"),O("aria-orientation",n.resolvedDirection()==="vertical"?"vertical":"horizontal"),r(),u(n.tabs()))},dependencies:[B,z],styles:[`@charset "UTF-8";

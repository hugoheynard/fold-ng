import{x as B,y as C,ɵ as D,M as m,i as _,e,O as v,D as L,j as l,o as g,k as u,I as N,J as A,A as I,al as W,q as b,s as f,aA as j,c as U,B as $,d as t,f as o,g as w,W as K,C as M,aC as P,h as O,Q as E,m as r,v as J,n as T,u as V,l as R,E as h,H as y,Z as q,r as z}from"./index-pWDKkeGF.js";import{K as G}from"./kind-badge.component-Du4ZOBVi.js";import{C as X}from"./composed-of.component-Bi4JoRkR.js";import{D as Y}from"./playground.component-DXUu29dy.js";import{FoldPageSectionComponent as H}from"./page-section.component-B3J79WzZ.js";import{FoldTabsComponent as Q}from"./tabs.component-BXRSkoWI.js";import{FoldTabPanelComponent as Z}from"./tab-panel.component-Dz2Y_CxR.js";import{FoldListboxComponent as ee}from"./listbox.component-CgBXjxA3.js";import{FoldMultiselectComponent as oe}from"./multiselect.component-BXp-bTqn.js";import{F as te}from"./option.component-By56KtFO.js";import{FoldSelectComponent as ne}from"./select.component-5SS8WYC9.js";import"./button.component-9Pw38SHj.js";import"./spinner.component-DWYJFD-f.js";import"./tokens.catalog-DF_6rd51.js";import"./element-title.component-xpyJ_iBj.js";import"./slider.component-CpaoAgo1.js";import"./input-value-Co_u-z_8.js";import"./nav-layout.context-6e9PKqbm.js";import"./popover.component-BJzU2CvQ.js";import"./popover-trigger.directive-CI5gggkA.js";import"./input-base.component-BbgOikUX.js";import"./label.component-D1qKDRUp.js";import"./listbox-nav-BGeeFAKj.js";const ae=(s,i)=>i.box;function le(s,i){if(s&1&&(m(0,"div",2),W(1,"span",8),m(2,"span",9),e(3),v(),m(4,"span",10),e(5,"↓"),v()()),s&2){const a=b().$implicit;l(3),u(a.flow)}}function se(s,i){if(s&1&&(N(0,le,6,1,"div",2),m(1,"div",3)(2,"span",4),e(3),v(),m(4,"div",5)(5,"code",6),e(6),v(),m(7,"span",7),e(8),v()()()),s&2){const a=i.$implicit,n=i.$index,c=i.$index;A(c!==0?0:-1),l(),I("--i",n),l(2),u(n+1),l(3),u(a.box),l(2),u(a.note)}}const ie=s=>({kind:"popover",layers:[{box:"<button> trigger",note:s?'aria-haspopup="listbox" · aria-expanded · summarises the picks':'aria-haspopup="listbox" · aria-expanded · shows the selected label',flow:""},{box:"fold-popover — native top layer",note:"escapes overflow + z-index · flip → size → shift · publishes --fold-popover-anchor-width",flow:"click / ↓ opens"},{box:s?'role="listbox" + aria-multiselectable — holds focus':'role="listbox" — holds focus',note:"aria-activedescendant → the active option's id (focus never leaves)",flow:"renders the panel"},{box:"fold-option × N",note:"each derives its own selected / active from the owner (a computed reading the FOLD_LISTBOX_OWNER token — nothing pushed in during change detection)",flow:"projects rows"}],footer:s?"↑/↓ move active · Enter/Space toggles membership · panel stays open · value = readonly string[]":"↑/↓ move active · Enter commits + closes · returns focus to the trigger · value = string"}),re={kind:"native",layers:[{box:"fold-select",note:"a thin wrapper — styled box + custom caret over the real control",flow:""},{box:"native <select>",note:"[value] / (change) · Signal Forms · the browser owns keyboard + focus",flow:"wraps"},{box:"OS popup (browser / operating system)",note:"NOT in your DOM · not styleable · a native mobile wheel for free",flow:"opens"},{box:"<option> × N",note:"real projected option elements — plain text only",flow:"lists"}],footer:"styleable panel / custom rows?  ✗    ·    accessible + mobile-native out of the box?  ✓"};class k{kind=B.required();schema=C(()=>{const i=this.kind();return i==="select"?re:ie(i==="multi")});static ɵfac=function(a){return new(a||k)};static ɵcmp=D({type:k,selectors:[["gal-select-schema"]],inputs:{kind:[1,"kind"]},decls:5,vars:3,consts:[[1,"sc"],[1,"sc-footer"],["aria-hidden","true",1,"sc-flow"],[1,"sc-layer"],[1,"sc-num"],[1,"sc-body"],[1,"sc-box"],[1,"sc-note"],[1,"sc-flow-line"],[1,"sc-flow-label"],[1,"sc-flow-arrow"]],template:function(a,n){a&1&&(m(0,"div",0),_(1,se,9,6,null,null,ae),m(3,"p",1),e(4),v()()),a&2&&(L("sc-native",n.schema().kind==="native"),l(),g(n.schema().layers),l(3),u(n.schema().footer))},styles:[`[_nghost-%COMP%] {
  display: block;
}

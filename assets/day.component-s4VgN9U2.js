import{u as m,ap as x,X as O,A as i,ɵ as M,ar as P,F as k,a1 as w,d,e as r,f as l,w as f,a2 as v,D as u,j as a,k as s,L as F,x as p,aR as T,q as c,i as D,o as $,E as z,B as N,au as E,m as C,av as j,g as y,N as L,O as V}from"./index-F5cuq_px.js";import{a as h}from"./chrome.directive-C7bm2f4P.js";import{a as q}from"./filters-17CrhBAd.js";import"./date-Blk--MT7.js";const H=["*",[["button","empty",""],["a","empty",""],["div","empty",""]]],I=["*","button[empty], a[empty], div[empty]"],S=n=>({$implicit:n,band:null}),A=(n,e)=>e.id;function B(n,e){if(n&1&&(d(0,"div",5)(1,"p"),r(2),l(),v(3,1),l()),n&2){const o=c();a(2),s(o.chrome.l().emptyDay)}}function R(n,e){if(n&1&&E(0,8),n&2){const o=c().$implicit;C("ngTemplateOutlet",e)("ngTemplateOutletContext",j(2,S,o))}}function U(n,e){n&1&&y(0,"fold-icon",10),n&2&&C("name",e)}function X(n,e){if(n&1&&(d(0,"span",13),r(1),l()),n&2){const o=c(2).$implicit;a(),s(o.subline)}}function G(n,e){if(n&1&&(y(0,"span",9),f(1,U,1,1,"fold-icon",10),d(2,"span",11)(3,"span",12),r(4),l(),f(5,X,2,1,"span",13),l()),n&2){let o;const t=c().$implicit;a(),p((o=t.icon)?1:-1,o),a(3),s(t.label),a(),p(t.subline?5:-1)}}function J(n,e){if(n&1){const o=z();d(0,"li")(1,"button",7),N("click",function(){const _=L(o).$implicit,b=c(2);return V(b.eventClick.emit(_))}),f(2,R,1,4,"ng-container",8)(3,G,6,3),l()()}if(n&2){let o;const t=e.$implicit,_=c(2);a(),u("data-tone",t.tone??"neutral"),a(),p((o=_.chrome.eventContent())?2:3,o)}}function K(n,e){if(n&1&&(d(0,"ul",6),D(1,J,4,2,"li",null,A),l()),n&2){const o=c();a(),$(o.dayEvents())}}class g{date=m.required();events=m([]);today=m();eventClick=x();chrome=O(h);dayEvents=i(()=>q(this.events(),this.date()));isToday=i(()=>this.date()===this.today());weekdayName=i(()=>this.chrome.format(this.date(),"weekdayLong"));monthName=i(()=>this.chrome.format(this.date(),"monthLong"));dayOfMonth=i(()=>Number(this.date().slice(8,10)));headerLabel=i(()=>{const e=this.chrome.format(this.date(),"dateFull");return this.isToday()?`${e}, ${this.chrome.l().today}`:e});static ɵfac=function(o){return new(o||g)};static ɵcmp=M({type:g,selectors:[["fold-calendar-day"]],inputs:{date:[1,"date"],events:[1,"events"],today:[1,"today"]},outputs:{eventClick:"eventClick"},features:[T([{directive:h,inputs:["locale","locale","labels","labels","formats","formats"]}])],ngContentSelectors:I,decls:11,vars:8,consts:[[1,"foldcald"],[1,"foldcald-head"],[1,"foldcald-weekday"],[1,"foldcald-daynum"],[1,"foldcald-month"],[1,"foldcald-empty"],[1,"foldcald-list"],["type","button",1,"foldcal-chip","foldcald-chip",3,"click"],[3,"ngTemplateOutlet","ngTemplateOutletContext"],[1,"foldcal-chip-bar"],["size","md",1,"foldcal-chip-icon",3,"name"],[1,"foldcal-chip-body"],[1,"foldcal-chip-label"],[1,"foldcal-chip-sub"]],template:function(o,t){o&1&&(w(H),d(0,"section",0)(1,"header",1)(2,"span",2),r(3),l(),d(4,"span",3),r(5),l(),d(6,"span",4),r(7),l()(),f(8,B,4,1,"div",5)(9,K,3,0,"ul",6),v(10),l()),o&2&&(u("aria-label",t.headerLabel()),a(3),s(t.weekdayName()),a(),F("is-today",t.isToday()),u("aria-current",t.isToday()?"date":null),a(),s(t.dayOfMonth()),a(2),s(t.monthName()),a(),p(t.dayEvents().length===0?8:9))},dependencies:[P,k],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: block;
}

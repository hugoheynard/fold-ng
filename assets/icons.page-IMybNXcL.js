import{X as x,aX as z,aY as F,s as u,aZ as P,ɵ as S,c as R,b as N,a as B,F as E,d as e,g as c,f as o,e as n,B as v,w as b,j as r,l as w,m as p,x as k,i as m,q as g,o as f,T as _,k as d,E as C,W as O,L,N as T,O as I}from"./index-BpnHZqq2.js";import{K as V}from"./kind-badge.component-plE_QRie.js";import{FoldPageSectionComponent as $}from"./page-section.component-BM1z6GqB.js";import{FoldHeroSectionComponent as j}from"./hero-section.component-Dn_TLfHU.js";import{FoldNavLayoutComponent as A}from"./nav-layout.component-EijQE0bI.js";import{FoldViewNavComponent as D}from"./view-nav.component-ZonvsW6v.js";import{FoldCalloutComponent as K}from"./callout.component-Cpgainrj.js";import{FoldButtonComponent as M}from"./button.component-uG6n0sWz.js";import"./nav-layout.context-CA1APb_V.js";const G=(t,i)=>i.key,U=(t,i)=>i.title;function H(t,i){if(t&1){const a=C();e(0,"button",22),v("click",function(){const s=T(a).$implicit,h=g(3);return I(h.copyIconName(s))}),c(1,"fold-icon",23),e(2,"span",24),n(3),o()()}if(t&2){const a=i.$implicit,l=g(3);L("is-copied",l.copiedIcon()===a),r(),p("name",a)("title",a),r(2),d(l.copiedIcon()===a?"copied!":a)}}function W(t,i){if(t&1&&(e(0,"div",15)(1,"div",16)(2,"h3",17),n(3),o(),c(4,"fold-badge",18),e(5,"span",19),n(6),o()(),e(7,"div",20),m(8,H,4,5,"button",21,_),o()()),t&2){const a=i.$implicit;r(3),d(a.label),r(),p("content",a.names.length.toString()),r(2),d(a.desc),r(2),f(a.names)}}function Y(t,i){if(t&1&&(e(0,"fold-page-section",11),m(1,W,10,3,"div",15,G),o()),t&2){const a=g();p("description",a.totalCount+" glyphs across "+a.categories.length+" categories — click a tile to copy its name."),r(),f(a.categories)}}function X(t,i){if(t&1&&(e(0,"div",31),c(1,"fold-icon",32),e(2,"span"),n(3),o()()),t&2){const a=i.$implicit;r(),p("size",a),r(2),d(a)}}function q(t,i){if(t&1&&(e(0,"span",35),c(1,"fold-icon",36),o()),t&2){const a=i.$implicit;O("color","var(--fold-color-"+a+")")}}function Z(t,i){if(t&1&&(e(0,"fold-page-section",12)(1,"fold-card",25)(2,"pre",26)(3,"code"),n(4),o()()(),e(5,"div",27)(6,"div",28)(7,"span",29),n(8,"size · xs / sm / md / lg / xl · or a pixel number"),o(),e(9,"div",30),m(10,X,4,2,"div",31,_),e(12,"div",31),c(13,"fold-icon",32),e(14,"span"),n(15,"40px"),o()()()(),e(16,"div",28)(17,"span",29),n(18,"color · inherits currentColor"),o(),e(19,"div",33),m(20,q,2,2,"span",34,_),o()()()()),t&2){const a=g();r(4),d(a.usageCode),r(6),f(a.iconSizeSteps),r(3),p("size",40),r(7),f(a.iconColorTokens)}}function J(t,i){t&1&&(c(0,"fold-icon",46),e(1,"code"),n(2,'name="demo-sparkle"'),o()),t&2&&p("size",48)}function Q(t,i){t&1&&(e(0,"span",45),n(1,"nothing registered yet"),o())}function ee(t,i){if(t&1){const a=C();e(0,"fold-page-section",13)(1,"div",37)(2,"fold-card",25)(3,"span",29),n(4,"at bootstrap — idiomatic, like provideRouter"),o(),e(5,"pre",26)(6,"code"),n(7),o()()(),e(8,"fold-card",25)(9,"span",29),n(10,"at runtime — resolves reactively"),o(),e(11,"pre",26)(12,"code"),n(13),o()()()(),e(14,"fold-callout",38)(15,"strong"),n(16,"Trust contract:"),o(),n(17," icon markup is injected unsanitised, so every registered value must be a static, authored "),e(18,"code"),n(19,"<svg>"),o(),n(20," string — never user input. The registry throws on a non-"),e(21,"code"),n(22,"<svg>"),o(),n(23," root or a "),e(24,"code"),n(25,"<script>"),o(),n(26," / "),e(27,"code"),n(28,"on*="),o(),n(29," handler. "),o(),e(30,"fold-card",39)(31,"div",40)(32,"h3",41),n(33,"See it resolve, live"),o(),e(34,"p",42),n(35," Registering an icon updates the sprite reactively — no reload. Click to register "),e(36,"code"),n(37,"demo-sparkle"),o(),n(38,", then it renders on the right. "),o(),e(39,"button",43),v("click",function(){T(a);const s=g();return I(s.registerDemoIcon())}),n(40),o()(),e(41,"div",44),b(42,J,3,1)(43,Q,2,0,"span",45),o()()()}if(t&2){const a=g();r(7),d(a.provideCode),r(6),d(a.runtimeCode),r(26),p("disabled",a.demoRegistered()),r(),w(" ",a.demoRegistered()?"Registered ✓":"Register demo-sparkle"," "),r(2),k(a.demoRegistered()?42:43)}}function ne(t,i){if(t&1&&(e(0,"fold-card",49)(1,"span",50),c(2,"fold-icon",51),o(),e(3,"h3",41),n(4),o(),e(5,"p",42),n(6),o()()),t&2){const a=i.$implicit;r(2),p("name",a.icon),r(2),d(a.title),r(2),d(a.body)}}function oe(t,i){if(t&1&&(e(0,"fold-page-section",14)(1,"fold-callout",47),n(2," Every icon renders through a "),e(3,"strong"),n(4,"shared SVG sprite"),o(),n(5," — one "),e(6,"code"),n(7,"<symbol>"),o(),n(8," per icon, a lightweight "),e(9,"code"),n(10,"<use>"),o(),n(11," per instance — so a 500-row table with three icons each is 1500 tiny references over 3 symbols, not 1500 copies of the markup. "),o(),e(12,"div",48),m(13,ne,7,3,"fold-card",49,U),o()()),t&2){const a=g();r(13),f(a.features)}}const ae='<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l2.5 6.9L21.5 11l-6.9 2.5L12 20l-2.5-6.5L2.5 11l7-2.1z"/></svg>';class y{registry=x(z);devtools=x(F);tabs=[{key:"catalog",label:"Catalogue",icon:"grid"},{key:"usage",label:"Usage",icon:"code"},{key:"extend",label:"Registry",icon:"plus"},{key:"why",label:"Why it holds up",icon:"lightning"}];tab=u("catalog");iconSizeSteps=["xs","sm","md","lg","xl"];iconColorTokens=["text","text-secondary","primary","info","warning","alert","success"];features=[{icon:"code",title:"Typed names",body:"name autocompletes every built-in and compile-errors on a typo — a missing icon is caught before runtime, not after."},{icon:"copy",title:"Shared sprite",body:"Each icon is one <symbol> in a hidden sprite; every instance is a tiny <use>. 1500 renders cost 3 symbols, not 1500 copies."},{icon:"palette",title:"currentColor",body:"Colour is inherited — set color on any ancestor and the icon follows. No colour prop, no theme fork."},{icon:"sliders",title:"Token sizes",body:"xs…xl map to the --fold-icon-size-* scale (or pass a pixel number). A dense theme can rescale every icon at once."},{icon:"shield",title:"Trust-guarded",body:"The registry rejects <script> and inline on*= handlers at registration — the unsanitised inject can't become an XSS sink."},{icon:"lightning",title:"Self-contained",body:"SVGs are inlined into the package — no HTTP fetch, no .svg loader config, no network on first paint."}];descriptions={ui:"Actions, editing, files, view chrome — the everyday verbs.",nav:"The app's destinations — roughly one per rail entry.",commerce:"Cart, catalogue, payment, fulfilment — the e-commerce domain.",music:"Playback, waveforms, the audio domain.",status:"State, severity, achievement.",people:"Members, leads, rights, roles.",brands:"Third-party marks — kept apart from the single-glyph sets."};categories=P.map(i=>({key:i.id,label:i.label,desc:this.descriptions[i.id],names:i.names}));totalCount=this.categories.reduce((i,a)=>i+a.names.length,0);usageCode=`<fold-icon name="search" />

import{T as h,ad as I,x as r,K as v,a5 as P,y as a,ɵ as O,L as k,N as M,aj as A,P as y,D as T,a4 as g,aN as B,as as z,s as D,aG as q,F as E,B as S,d as p,h as j,C as w,I as K,g as V,f as m,m as f,j as l,n as Q,v as H,J as W,ae as J,at as N,au as x,aJ as R,e as F,k as L,q as U,E as $,r as G,H as X}from"./index-D5P_54_N.js";import{FoldPopoverComponent as Y}from"./popover.component-DXJg1Vet.js";import{F as Z}from"./popover-trigger.directive-DDlNAnv5.js";import{FoldInputBaseComponent as ee}from"./input-base.component-BaLQNbbR.js";const te=["*"];class d{host=h(I);listbox=h(u);value=r.required();disabled=r(!1,{transform:v});id=h(P).next("fold-option");selected=a(()=>this.listbox.value()===this.value());active=a(()=>this.listbox.activeId()===this.id);get label(){return this.host.nativeElement.textContent?.trim()??""}scrollIntoView(){this.host.nativeElement.scrollIntoView?.({block:"nearest"})}static ɵfac=function(n){return new(n||d)};static ɵcmp=O({type:d,selectors:[["fold-option"]],hostAttrs:["role","option"],hostVars:9,hostBindings:function(n,t){n&2&&(A("id",t.id),y("aria-selected",t.selected())("aria-disabled",t.disabled()||null),T("is-active",t.active())("is-selected",t.selected())("is-disabled",t.disabled()))},inputs:{value:[1,"value"],disabled:[1,"disabled"]},ngContentSelectors:te,decls:1,vars:0,template:function(n,t){n&1&&(k(),M(0))},styles:[`[_nghost-%COMP%] {
  display: flex;
  align-items: center;
  gap: 0.55rem;

import{s as m,x as S,am as q,an as V,ɵ as Q,c as D,bi as K,bj as N,bm as U,F as G,d as r,g as M,B as d,e as s,f as l,H as y,i as h,u as F,j as a,C as b,m as v,I as w,o as k,k as C,ap as J,aq as W,q as c,A as x,l as P,bg as j,O as X,z as E,D as _,E as f,P as L}from"./index-DN9xIx5X.js";import{a as Y}from"./tokens.catalog-DF_6rd51.js";import{K as Z}from"./kind-badge.component-DDGyQ473.js";import{FoldContextCardComponent as ee}from"./context-card.component-BRAY4btL.js";import"./element-title.component-BkTWaakb.js";function $(i,n){return{prop:Y(i),desc:n,kind:"color"}}function z(i,n){return{prop:`--fold-radius-${i}`,desc:n,kind:"radius"}}function oe(i,n,e){const o={...i},t=e.trim();return t?o[n]=t:delete o[n],o}function ne(i,n){const e=Object.entries(n);if(e.length===0)return"/* adjust a token on the left to see the CSS here */";const o=[`${i} {`];for(const[t,u]of e)o.push(`  ${t}: ${u};`);return o.push("}"),o.join(`

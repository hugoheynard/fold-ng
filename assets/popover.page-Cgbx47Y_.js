import{T as b,ad as C,x as T,z as k,P as D,s as m,y as F,ɵ as O,c as B,b as E,d as t,e,f as o,g as y,i as P,I as M,C as d,u as R,j as l,m as _,v as $,o as h,J as z,B as w,k as x,q as c,D as I,l as j,E as f,H as g}from"./index-BUJ3msiF.js";import{K as S}from"./kind-badge.component-DykZ94cz.js";import{C as L}from"./composed-of.component-BOewZ5lK.js";import{D as V}from"./playground.component-C3NX2NcQ.js";import{FoldButtonComponent as A}from"./button.component-u4WQKQNL.js";import{FoldButtonIconComponent as H}from"./button-icon.component-NKrYO4zj.js";import{FoldPopoverComponent as G}from"./popover.component-B3GkvvuU.js";import{FoldDropdownComponent as K}from"./dropdown.component-d3B9-ppq.js";import{FoldDropdownItemComponent as q}from"./dropdown-item.component-3L-PlXXo.js";import"./element-title.component-5gouKVeM.js";import"./page-section.component-6XAkWf_u.js";import"./slider.component-oq9bsKTC.js";import"./input-value-Co_u-z_8.js";import"./spinner.component-WHetuvpQ.js";import"./tokens.catalog-DF_6rd51.js";class u{el=b(C);haspopup=T("dialog",{alias:"foldPopoverTrigger",transform:r=>r==="menu"||r==="listbox"||r==="true"?r:"dialog"});static ɵfac=function(i){return new(i||u)};static ɵdir=k({type:u,selectors:[["","foldPopoverTrigger",""]],hostVars:1,hostBindings:function(i,n){i&2&&D("foldpopovertrigger",n.haspopup())},inputs:{haspopup:[1,"foldPopoverTrigger","haspopup"]}})}const J=()=>["button","button-icon","icons"],N=(p,r)=>r.id;function Q(p,r){if(p&1){const i=w();t(0,"li",9)(1,"span"),e(2),o(),t(3,"fold-dropdown",31),y(4,"fold-button-icon",32),t(5,"fold-dropdown-item",27),d("selected",function(){const a=f(i).$implicit,s=c();return g(s.act("Rename",a))}),e(6," Rename "),o(),t(7,"fold-dropdown-item",28),d("selected",function(){const a=f(i).$implicit,s=c();return g(s.act("Duplicate",a))}),e(8," Duplicate "),o(),t(9,"fold-dropdown-item",30),d("selected",function(){const a=f(i).$implicit,s=c();return g(s.act("Delete",a))}),e(10," Delete "),o()()()}if(p&2){const i=r.$implicit;l(2),x(i.name)}}function U(p,r){if(p&1){const i=w();t(0,"li",10)(1,"button",33),d("click",function(){f(i);const a=c();return g(a.resetRows())}),e(2," Reset list "),o()()}}function W(p,r){p&1&&(t(0,"span",11),e(1),o()),p&2&&(l(),x(r))}function X(p,r){if(p&1){const i=w();t(0,"button",34),d("click",function(){const a=f(i).$implicit,s=c();return g(s.pgPlacement.set(a))}),e(1),o()}if(p&2){const i=r.$implicit,n=c();I("is-on",n.pgPlacement()===i),l(),j(" ",i," ")}}class v{rows=m([{id:"r1",name:"Spring tour"},{id:"r2",name:"Summer festival"},{id:"r3",name:"Gala"}]);log=m(null);act(r,i){this.log.set(`${r} · ${i.name}`),r==="Delete"&&this.rows.update(n=>n.filter(a=>a.id!==i.id))}resetRows(){this.rows.set([{id:"r1",name:"Spring tour"},{id:"r2",name:"Summer festival"},{id:"r3",name:"Gala"}]),this.log.set(null)}notify=m(!0);digest=m(!1);placements=["bottom-start","bottom","bottom-end","top-start","top-end","right","left"];pgPlacement=m("bottom-start");playgroundCode=F(()=>`<fold-dropdown placement="${this.pgPlacement()}" ariaLabel="Actions">

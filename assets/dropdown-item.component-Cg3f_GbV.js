import{u as i,W as s,am as c,aB as f,ɵ as p,F as m,X as _,d,T as u,w as b,Y as g,f as C,H as v,m as l,j as P,x as w,aC as x,ar as y,g as M}from"./index-BDLuCW6u.js";const O=["btn"],h=["*"];function k(r,t){r&1&&M(0,"fold-icon",2),r&2&&l("name",t)}class a{disabled=i(!1,{transform:s});tone=i("default");icon=i();selected=c();btn=f("btn");get button(){return this.btn()?.nativeElement}focus(){this.btn()?.nativeElement.focus()}onClick(){this.disabled()||this.selected.emit()}static ɵfac=function(n){return new(n||a)};static ɵcmp=p({type:a,selectors:[["fold-dropdown-item"]],viewQuery:function(n,e){n&1&&x(e.btn,O,5),n&2&&y()},inputs:{disabled:[1,"disabled"],tone:[1,"tone"],icon:[1,"icon"]},outputs:{selected:"selected"},ngContentSelectors:h,decls:5,vars:4,consts:[["btn",""],["type","button","role","menuitem","tabindex","-1",1,"fdrop-item",3,"click","disabled"],["size","sm",1,"fdrop-item-icon",3,"name"],[1,"fdrop-item-label"]],template:function(n,e){if(n&1&&(_(),d(0,"button",1,0),u("click",function(){return e.onClick()}),b(2,k,1,1,"fold-icon",2),d(3,"span",3),g(4),C()()),n&2){let o;v("is-danger",e.tone()==="danger"),l("disabled",e.disabled()),P(2),w((o=e.icon())?2:-1,o)}},dependencies:[m],styles:[`[_nghost-%COMP%] {
  display: contents;
}

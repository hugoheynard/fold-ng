import{ai as d,u as t,X as c,a2 as b,aj as f,A as u,ɵ as m,F as h,Y as C,d as _,B as M,w as v,Z as O,f as a,g as P,m as p,j as l,D as y,x as w,ak as k,e as z,k as F}from"./index-CQebbVEP.js";import{FoldInputBaseComponent as I}from"./input-base.component-DrRtAKIP.js";import{r as q}from"./input-value-Co_u-z_8.js";import"./label.component-DBxoIRpX.js";const B=["*"];function S(s,e){s&1&&(_(0,"option",3),z(1),a()),s&2&&(l(),F(e))}class i{value=d("");disabled=t(!1);touched=d(!1);errors=t([]);size=t("md");variant=t("default");label=t();required=t(!1,{transform:c});optional=t(!1,{transform:c});optionalLabel=t("optional");hint=t();placeholder=t();inputId=b(f).next("fold-select");errorMessage=u(()=>{if(!this.touched())return;const e=this.errors()[0];return e?e.message??e.kind:void 0});describedBy=u(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);onChange(e){this.value.set(q(e))}onBlur(){this.touched.set(!0)}static ɵfac=function(o){return new(o||i)};static ɵcmp=m({type:i,selectors:[["fold-select"]],hostVars:2,hostBindings:function(o,n){o&2&&k(n.size()+" "+n.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],size:[1,"size"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],hint:[1,"hint"],placeholder:[1,"placeholder"]},outputs:{value:"valueChange",touched:"touchedChange"},ngContentSelectors:B,decls:6,vars:14,consts:[[3,"label","for","required","optional","optionalLabel","hint","error"],[1,"sel-wrap"],[1,"sel",3,"change","blur","id","disabled","value"],["value","","disabled","","hidden",""],["name","chevron-down","size","sm","aria-hidden","true",1,"sel-caret"]],template:function(o,n){if(o&1&&(C(),_(0,"fold-input-base",0)(1,"div",1)(2,"select",2),M("change",function(g){return n.onChange(g)})("blur",function(){return n.onBlur()}),v(3,S,2,1,"option",3),O(4),a(),P(5,"fold-icon",4),a()()),o&2){let r;p("label",n.label())("for",n.inputId)("required",n.required())("optional",n.optional())("optionalLabel",n.optionalLabel())("hint",n.hint())("error",n.errorMessage()),l(2),p("id",n.inputId)("disabled",n.disabled())("value",n.value()),y("required",n.required()||null)("aria-invalid",n.errorMessage()?!0:null)("aria-describedby",n.describedBy()),l(),w((r=n.placeholder())?3:-1,r)}},dependencies:[I,h],styles:[`

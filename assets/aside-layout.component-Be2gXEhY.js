...
[_nghost-%COMP%]:has([asideleft])   .al-grid[_ngcontent-%COMP%] {
  grid-template-columns: var(--fold-aside-layout-rail-width, 220px) var(--fold-aside-layout-center-width, minmax(0, 1fr));
}

[_nghost-%COMP%]:has([asideleft]):has([asideright])   .al-grid[_ngcontent-%COMP%] {
  grid-template-columns: var(--fold-aside-layout-rail-width, 220px) var(--fold-aside-layout-center-width, minmax(0, 1fr)) var(--fold-aside-layout-side-width, 300px);
}

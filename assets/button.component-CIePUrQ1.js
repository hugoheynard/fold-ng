import{X as p,Y as m,u as t,a0 as s,A as f,ɵ as v,F as _,ah as h,a1 as C,w as u,a2 as x,x as g,j as P,B as y,D as M,ai as O,L as k,g as d,q as c,m as b}from"./index-byaimOHk.js";const B=["*"];function w(e,r){if(e&1&&d(0,"fold-spinner",0),e&2){const o=c();b("size",o.iconSize())}}function z(e,r){if(e&1&&d(0,"fold-icon",1),e&2){const o=c();b("name",r)("size",o.iconSize())}}function T(e,r){if(e&1&&d(0,"fold-icon",1),e&2){const o=c();b("name",r)("size",o.iconSize())}}const F={sm:14,md:16,lg:18};class l{host=p(m);isButton=this.host.nativeElement.tagName.toLowerCase()==="button";emphasis=t("solid");intent=t("primary");size=t("md");shape=t("rounded");block=t(!1,{transform:s});icon=t();iconTrailing=t();iconSize=f(()=>F[this.size()]);type=t("button");disabled=t(!1,{transform:s});loading=t(!1,{transform:s});blocked=f(()=>this.disabled()||this.loading());onClick(r){this.blocked()&&(r.preventDefault(),r.stopImmediatePropagation())}static ɵfac=function(o){return new(o||l)};static ɵcmp=v({type:l,selectors:[["button","foldButton",""],["a","foldButton",""]],hostVars:13,hostBindings:function(o,n){o&1&&y("click",function(a){return n.onClick(a)}),o&2&&(M("disabled",n.isButton&&n.blocked()?!0:null)("type",n.isButton?n.type():null)("aria-disabled",!n.isButton&&n.blocked()?!0:null)("aria-busy",n.loading()?!0:null)("tabindex",!n.isButton&&n.blocked()?-1:null),O("fold-button "+n.emphasis()+" "+n.intent()+" "+n.size()+" "+n.shape()),k("block",n.block())("is-disabled",n.disabled())("is-loading",n.loading()))},inputs:{emphasis:[1,"emphasis"],intent:[1,"intent"],size:[1,"size"],shape:[1,"shape"],block:[1,"block"],icon:[1,"icon"],iconTrailing:[1,"iconTrailing"],type:[1,"type"],disabled:[1,"disabled"],loading:[1,"loading"]},ngContentSelectors:B,decls:4,vars:2,consts:[["aria-hidden","true",3,"size"],["aria-hidden","true",3,"name","size"]],template:function(o,n){if(o&1&&(C(),u(0,w,1,1,"fold-spinner",0)(1,z,1,2,"fold-icon",1),x(2),u(3,T,1,2,"fold-icon",1)),o&2){let i,a;g(n.loading()?0:(i=n.icon())?1:-1,i),P(3),g((a=n.iconTrailing())?3:-1,a)}},dependencies:[_,h],styles:[`[_nghost-%COMP%] {
  all: unset;
  ...
  gap: 0.4em;
  white-space: nowrap;
  min-height: var(--fold-button-min-height, auto);
  font-family: var(--fold-button-font, inherit);
  font-weight: var(--fold-button-weight, var(--fold-weight-semibold));
  letter-spacing: var(--fold-button-tracking, inherit);
  text-transform: var(--fold-button-transform, none);
...
.sm[_nghost-%COMP%] {
  ...
  border-radius: var(--fold-button-radius, var(--fold-radius-xs));
}

.md[_nghost-%COMP%] {
  font-size: var(--fold-text-base);
  padding: 0.45rem 1rem;
  border-radius: var(--fold-button-radius, var(--fold-radius-sm));
}

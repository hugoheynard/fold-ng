import{s as m,A as P,a0 as V,ae as q,ɵ as N,c as Q,bu as U,bv as D,by as K,F as W,d as r,g as M,B as d,e as a,f as l,w as y,i as h,T as F,j as s,m as v,U as G,L as b,x as w,o as k,k as C,a7 as J,a8 as X,q as c,E as x,l as S,v as j,D as Y,W as E,N as _,O as f,$ as L}from"./index-B6Le7PBg.js";import{a as Z}from"./tokens.catalog-DF_6rd51.js";import{K as ee}from"./kind-badge.component-BPMSgAGj.js";import{C as oe}from"./composed-of.component-BmG-w9Mp.js";import{FoldContextCardComponent as ne}from"./context-card.component-D7tQK7L_.js";import"./element-title.component-hlpzZfFT.js";function $(i,n){return{prop:Z(i),desc:n,kind:"color"}}function z(i,n){return{prop:`--fold-radius-${i}`,desc:n,kind:"radius"}}function te(i,n,e){const o={...i},t=e.trim();return t?o[n]=t:delete o[n],o}function ie(i,n){const e=Object.entries(n);if(e.length===0)return"/* adjust a token on the left to see the CSS here */";const o=[`${i} {`];for(const[t,u]of e)o.push(`  ${t}: ${u};`);return o.push("}"),o.join(`

import{s as i,y as c,ɵ as y,c as R,b as C,F as w,d as t,g as f,e as a,f as o,C as h,h as b,j as l,m as p,k as P,n as _,r as v}from"./index-89CG8o_m.js";import{K as x}from"./kind-badge.component-DdN5h_fA.js";import{FoldPageSectionComponent as D}from"./page-section.component-CKCWTDnz.js";import{FoldCalloutComponent as T}from"./callout.component-xQlThN-5.js";import{FoldSliderComponent as k}from"./slider.component-DLsPY18s.js";import{F}from"./repeat-press.directive-xonobIa2.js";import"./element-title.component-DIKeRLwd.js";import"./input-value-Co_u-z_8.js";const u=0,m=50;class g{min=u;max=m;count=i(8);delay=i(350);period=i(60);atMin=c(()=>this.count()<=u);atMax=c(()=>this.count()>=m);step(n){this.count.update(s=>Math.min(m,Math.max(u,s+n)))}usageCode=c(()=>`<button
  foldRepeatPress

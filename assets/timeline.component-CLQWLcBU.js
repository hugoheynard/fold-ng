import{u as c,X as y,as as w,at as k,A as m,ɵ as F,au as q,F as $,av as z,H as L,Q as T,w as s,j as i,x as _,aw as N,a8 as A,d as a,f as r,q as l,i as D,o as H,ax as f,$ as u,L as C,D as v,m as p,g as M,ay as b,e as h,k as P,W as Q,E as j,B as E,N as V,O as B,az as I,aA as S}from"./index-FWo1_vlb.js";const R=["node"],O=e=>({$implicit:e}),U=(e,t)=>t.key;function W(e,t){e&1&&M(0,"fold-icon",5),e&2&&p("name",t)("size",11)}function X(e,t){e&1&&(a(0,"span",9),h(1),r()),e&2&&(i(),P(t))}function G(e,t){e&1&&(a(0,"span",9),h(1),I(2,"date"),r()),e&2&&(i(),P(S(2,1,t,"mediumDate")))}function J(e,t){if(e&1&&s(0,X,2,1,"span",9)(1,G,3,4,"span",9),e&2){let n;const o=l().$implicit;_((n=o.displayDate)?0:(n=o.date)?1:-1,n)}}function K(e,t){if(e&1&&f(0,7),e&2){const n=l().$implicit;p("ngTemplateOutlet",t)("ngTemplateOutletContext",b(2,O,n))}}function Y(e,t){if(e&1&&(a(0,"span",8),h(1),r()),e&2){const n=l().$implicit;i(),P(n.label)}}function Z(e,t){if(e&1&&(a(0,"span",4),s(1,W,1,2,"fold-icon",5),r(),a(2,"span",6),s(3,J,2,1),s(4,K,1,4,"ng-container",7)(5,Y,2,1,"span",8),r()),e&2){let n,o;const d=t.$implicit,g=l();i(),_((n=d.icon)?1:-1,n),i(2),_(g.datePlacement()!=="hidden"?3:-1),i(),_((o=g.nodeTemplate())?4:5,o)}}function nn(e,t){if(e&1&&(a(0,"span",10),M(1,"span",11),r()),e&2){const n=l(2);v("aria-valuenow",n.fillNow())("aria-valuetext",n.stepText())("aria-label",n.ariaLabel()),i(),Q("width",n.fillPct(),"%")}}function tn(e,t){if(e&1){const n=j();a(0,"button",14),E("click",function(){V(n);const d=l().$implicit,g=l(2);return B(g.onNode(d))}),f(1,7),r()}if(e&2){const n=l().$implicit,o=l(2),d=u(1);C("filled",o.isFilled(n))("hollow",o.isHollow(n)),p("title",o.nodeTitle()),i(),p("ngTemplateOutlet",d)("ngTemplateOutletContext",b(7,O,n))}}function en(e,t){if(e&1&&(a(0,"div",15),f(1,7),r()),e&2){const n=l().$implicit,o=l(2),d=u(1);C("filled",o.isFilled(n))("hollow",o.isHollow(n)),i(),p("ngTemplateOutlet",d)("ngTemplateOutletContext",b(6,O,n))}}function on(e,t){if(e&1&&s(0,tn,2,9,"button",12)(1,en,2,8,"div",13),e&2){const n=t.$implicit,o=l(2);_(o.isClickable(n)?0:1)}}function ln(e,t){if(e&1&&(s(0,nn,2,5,"span",10),D(1,on,2,1,null,null,U)),e&2){const n=l();_(n.orientation()==="horizontal"?0:-1),i(),H(n.nodes())}}function an(e,t){if(e&1&&(a(0,"nav",16),f(1,17),r()),e&2){const n=l(),o=u(3);C("h",n.orientation()==="horizontal")("square",n.square())("date-above",n.datePlacement()==="above")("date-inline",n.datePlacement()==="inline"),v("aria-label",n.ariaLabel()),i(),p("ngTemplateOutlet",o)}}function rn(e,t){if(e&1&&(a(0,"div",18),f(1,17),r()),e&2){const n=l(),o=u(3);C("h",n.orientation()==="horizontal")("square",n.square())("date-above",n.datePlacement()==="above")("date-inline",n.datePlacement()==="inline"),v("aria-label",n.ariaLabel()),i(),p("ngTemplateOutlet",o)}}class x{nodes=c.required();orientation=c("vertical");progress=c(null);ariaLabel=c();nodeTitle=c("");square=c(!1,{transform:y});variant=c("plain");datePlacement=c("below");nodeClick=w();nodeTemplate=k("node");isClickable(t){return t.clickable??t.id!==null}interactive=m(()=>this.nodes().some(t=>this.isClickable(t)));doneCount=m(()=>this.nodes().filter(t=>t.done).length);fillPct=m(()=>{const t=this.progress();if(t!==null)return t;const n=this.nodes().length,o=this.doneCount();return n>1&&o>0?(o-1)/(n-1)*100:0});fillNow=m(()=>Math.round(this.fillPct()));stepText=m(()=>{const t=this.doneCount();return t>0?`${t} / ${this.nodes().length}`:null});isFilled(t){return t.done??t.id===null}isHollow(t){return(t.variant??this.variant())==="hollow"}onNode(t){this.isClickable(t)&&this.nodeClick.emit(t.id??t.key)}static ɵfac=function(n){return new(n||x)};static ɵcmp=F({type:x,selectors:[["fold-timeline"]],contentQueries:function(n,o,d){n&1&&N(d,o.nodeTemplate,R,5),n&2&&A()},inputs:{nodes:[1,"nodes"],orientation:[1,"orientation"],progress:[1,"progress"],ariaLabel:[1,"ariaLabel"],nodeTitle:[1,"nodeTitle"],square:[1,"square"],variant:[1,"variant"],datePlacement:[1,"datePlacement"]},outputs:{nodeClick:"nodeClick"},decls:6,vars:1,consts:[["dot",""],["body",""],[1,"tlv",3,"h","square","date-above","date-inline"],["role","group",1,"tlv",3,"h","square","date-above","date-inline"],[1,"dot"],[3,"name","size"],[1,"txt"],[3,"ngTemplateOutlet","ngTemplateOutletContext"],[1,"nlabel"],[1,"date"],["role","progressbar","aria-valuemin","0","aria-valuemax","100",1,"rail"],[1,"rail-fill"],["type","button",1,"node",3,"filled","hollow","title"],[1,"node","inert",3,"filled","hollow"],["type","button",1,"node",3,"click","title"],[1,"node","inert"],[1,"tlv"],[3,"ngTemplateOutlet"],["role","group",1,"tlv"]],template:function(n,o){n&1&&(L(0,Z,6,3,"ng-template",null,0,T)(2,ln,3,1,"ng-template",null,1,T),s(4,an,2,10,"nav",2)(5,rn,2,10,"div",3)),n&2&&(i(4),_(o.interactive()?4:5))},dependencies:[q,$,z],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: block;
  user-select: none;
}

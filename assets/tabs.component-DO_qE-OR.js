import{u as i,ag as y,X as x,a2 as p,A as h,ah as w,aJ as k,ɵ as F,F as T,a as z,d as s,B as m,i as K,f as d,L as v,D as u,j as l,o as A,a7 as $,a8 as B,E as S,w as g,e as C,q as c,m as _,x as f,k as O,g as P,N as D,O as I}from"./index-BgsKkR4L.js";import{F as j}from"./nav-layout.context-Bz7d6olN.js";const q=["tabBtn"],E=(o,e)=>e.key;function L(o,e){o&1&&P(0,"fold-icon",4),o&2&&_("name",e)}function V(o,e){if(o&1&&(s(0,"span",5),C(1),d()),o&2){const t=c().$implicit;l(),O(t.label.charAt(0))}}function Q(o,e){if(o&1&&P(0,"fold-badge",7),o&2){const t=c().$implicit,n=c();_("content",t.badge+"")("variant",n.activeKey()===t.key?"accent":"neutral")}}function U(o,e){if(o&1){const t=S();s(0,"button",3,0),m("click",function(){const a=D(t).$implicit,r=c();return I(r.select(a.key))}),g(2,L,1,1,"fold-icon",4)(3,V,2,1,"span",5),s(4,"span",6),C(5),d(),g(6,Q,1,2,"fold-badge",7),d()}if(o&2){let t;const n=e.$implicit,a=c();v("is-active",a.activeKey()===n.key),_("id",a.tabId(n.key))("tabindex",a.activeKey()===n.key?0:-1),u("aria-selected",a.activeKey()===n.key)("aria-controls",a.panelId(n.key)),l(2),f((t=n.icon)?2:a.collapsed()?3:-1,t),l(3),O(n.label),l(),f(n.badge!==void 0&&n.badge!==null?6:-1)}}class b{tabs=i.required();activeKey=y.required();activeStyle=i("underline");direction=i("auto");size=i("compact");collapsed=i(!1,{transform:x});background=i("surface");layout=p(j,{optional:!0});resolvedDirection=h(()=>{const e=this.direction();return e!=="auto"?e:this.layout?.stacked()?"horizontal":"vertical"});uid=p(w).next("fold-tabs");tabButtons=k("tabBtn");tabId(e){return`${this.uid}-tab-${e}`}panelId(e){return`${this.uid}-panel-${e}`}select(e){this.commit(e)}commit(e){this.activeKey.set(e)}onKeydown(e){const t=this.tabs().map(M=>M.key);if(t.length===0)return;const n=t.indexOf(this.activeKey());let a;switch(e.key){case"ArrowRight":case"ArrowDown":a=(n+1)%t.length;break;case"ArrowLeft":case"ArrowUp":a=(n-1+t.length)%t.length;break;case"Home":a=0;break;case"End":a=t.length-1;break;default:return}e.preventDefault();const r=t[a];r!==void 0&&(this.commit(r),this.tabButtons()[a]?.nativeElement.focus())}static ɵfac=function(t){return new(t||b)};static ɵcmp=F({type:b,selectors:[["fold-tabs"]],viewQuery:function(t,n){t&1&&$(n.tabButtons,q,5),t&2&&B()},inputs:{tabs:[1,"tabs"],activeKey:[1,"activeKey"],activeStyle:[1,"activeStyle"],direction:[1,"direction"],size:[1,"size"],collapsed:[1,"collapsed"],background:[1,"background"]},outputs:{activeKey:"activeKeyChange"},exportAs:["foldTabs"],decls:3,vars:13,consts:[["tabBtn",""],["role","tablist",1,"tab-bar",3,"keydown"],["type","button","role","tab",1,"tab-bar-item",3,"id","is-active","tabindex"],["type","button","role","tab",1,"tab-bar-item",3,"click","id","tabindex"],["size","sm",1,"tab-bar-icon",3,"name"],["aria-hidden","true",1,"tab-bar-icon","tab-bar-initial"],[1,"tab-bar-label"],[1,"tab-bar-badge",3,"content","variant"]],template:function(t,n){t&1&&(s(0,"div",1),m("keydown",function(r){return n.onKeydown(r)}),K(1,U,7,9,"button",2,E),d()),t&2&&(v("style-underline",n.activeStyle()==="underline")("style-fill",n.activeStyle()==="fill")("dir-vertical",n.resolvedDirection()==="vertical")("size-comfortable",n.size()==="comfortable")("is-collapsed",n.collapsed())("bg-surface",n.background()==="surface"),u("aria-orientation",n.resolvedDirection()==="vertical"?"vertical":"horizontal"),l(),A(n.tabs()))},dependencies:[T,z],styles:[`@charset "UTF-8";

import{u as a,a1 as P,aM as K,O as B,af as H,W as b,am as L,s as E,az as Q,N as _,a7 as U,aN as V,an as W,ɵ as X,aO as Y,ao as Z,F as G,X as J,d as s,Y as nn,f as i,w as u,i as y,H as g,j as d,Z as C,x as m,o as k,aq as tn,ar as on,e as M,l as en,S as T,T as F,q as r,m as p,Q as ln,U as h,V as w,g as I,k as D,as as $,aI as A}from"./index-6ImbagPn.js";import{FoldSpinnerComponent as rn}from"./spinner.component-Dg9QvMfh.js";import{FoldCheckboxComponent as cn}from"./checkbox.component-DRNONH5c.js";class O{foldCell=a.required();template=P(K);static ɵfac=function(n){return new(n||O)};static ɵdir=B({type:O,selectors:[["ng-template","foldCell",""]],inputs:{foldCell:[1,"foldCell"]}})}class x{template=P(K);static ɵfac=function(n){return new(n||x)};static ɵdir=B({type:x,selectors:[["ng-template","foldRowCard",""]]})}function z(e,t){if(!(e instanceof Element))return;const n=e[t];n instanceof HTMLElement&&n.focus()}function j(e,t){if(!(e instanceof Element))return;const n=e.parentElement?.[t];n instanceof HTMLElement&&n.focus()}const dn={selectAll:"Select all rows",selectRow:"Select row",sortBy:e=>`Sort by ${e}`,loading:"Loading…"},an=new H("FOLD_DATA_TABLE_LABELS",{factory:()=>dn}),sn=[[["","foldToolbar",""]]],fn=["[foldToolbar]"],R=(e,t)=>({$implicit:e,index:t}),N=(e,t)=>t.key;function q(e,t){return this.keyOf(t,e)}function _n(e,t){e&1&&(s(0,"caption",4),M(1),i()),e&2&&(d(),en(" ",t," "))}function gn(e,t){if(e&1){const n=T();s(0,"th",5)(1,"fold-checkbox",11),F("checkedChange",function(){h(n);const l=r();return w(l.toggleAll())}),i()()}if(e&2){const n=r();d(),p("ariaLabel",n.l().selectAll)("checked",n.allSelected())("indeterminate",n.someSelected())}}function pn(e,t){if(e&1){const n=T();s(0,"button",15),F("click",function(){h(n);const l=r().$implicit,c=r();return w(c.sortChange.emit(l.key))}),s(1,"span"),M(2),i(),I(3,"fold-icon",16),i()}if(e&2){const n=r().$implicit,o=r();g("right",n.align==="right")("center",n.align==="center"),C("aria-label",o.l().sortBy(n.label)),d(2),D(n.label),d(),g("on",o.isSorted(n.key)),p("name",o.sortIcon(n.key))("size",14)}}function un(e,t){if(e&1&&(s(0,"span",17),M(1),i()),e&2){const n=r().$implicit;g("right",n.align==="right")("center",n.align==="center"),d(),D(n.label)}}function mn(e,t){if(e&1&&(s(0,"th",12),u(1,pn,4,10,"button",13)(2,un,2,5,"span",14),i()),e&2){const n=t.$implicit,o=r();ln("width",n.width||null),g("is-primary-h",n.key===o.primaryKey()),C("aria-sort",n.sortable?o.ariaSort(n.key):null),d(),m(n.sortable?1:2)}}function Cn(e,t){if(e&1){const n=T();s(0,"td",19)(1,"fold-checkbox",20),F("click",function(l){return l.stopPropagation()})("checkedChange",function(){h(n);const l=r(),c=l.$implicit,f=l.$index,S=r();return w(S.toggleRow(c,f))}),i()()}if(e&2){const n=r(),o=n.$implicit,l=n.$index,c=r();d(),p("ariaLabel",c.labelFor(o))("checked",c.isRowSelected(o,l))}}function bn(e,t){if(e&1&&(s(0,"th",23),$(1,24),i()),e&2){const n=r().$implicit,o=r(),l=o.$implicit,c=o.$index,f=r();g("right",n.align==="right")("center",n.align==="center")("truncate",n.truncate),p("ngClass",n.cellClass||""),C("data-label",n.label),d(),p("ngTemplateOutlet",f.cellTemplate(n.key))("ngTemplateOutletContext",A(10,R,l,c))}}function hn(e,t){if(e&1&&(s(0,"td",25),$(1,24),i()),e&2){const n=r().$implicit,o=r(),l=o.$implicit,c=o.$index,f=r();g("right",n.align==="right")("center",n.align==="center")("truncate",n.truncate),p("ngClass",n.cellClass||""),C("data-label",n.label),d(),p("ngTemplateOutlet",f.cellTemplate(n.key))("ngTemplateOutletContext",A(10,R,l,c))}}function wn(e,t){if(e&1&&u(0,bn,2,13,"th",21)(1,hn,2,13,"td",22),e&2){const n=t.$implicit,o=r(2);m(n.key===o.primaryKey()?0:1)}}function On(e,t){if(e&1){const n=T();s(0,"tr",18),F("click",function(){const l=h(n).$implicit,c=r();return w(c.onRowActivate(l))})("focus",function(){const l=h(n),c=l.$implicit,f=l.$index,S=r();return w(S.onRowFocus(c,f))})("keydown",function(l){const c=h(n).$implicit,f=r();return w(f.onRowKeydown(l,c))}),u(1,Cn,2,2,"td",19),y(2,wn,2,1,null,null,N),i()}if(e&2){const n=t.$implicit,o=t.$index,l=r(),c=l.toneOf(n);g("tone-warning",c==="warning")("tone-alert",c==="alert")("tone-success",c==="success")("clickable",l.clickable())("is-selected",l.selectable()&&l.isRowSelected(n,o)),C("tabindex",l.rowTabIndex(n,o))("aria-selected",l.selectable()?l.isRowSelected(n,o):null),d(),m(l.selectable()?1:-1),d(),k(l.columns())}}function xn(e,t){if(e&1&&(s(0,"div",26),$(1,24),i()),e&2){const n=t.$implicit,o=t.$index,l=r();d(),p("ngTemplateOutlet",l)("ngTemplateOutletContext",A(2,R,n,o))}}function Mn(e,t){if(e&1&&(s(0,"div",8),y(1,xn,2,5,"div",26,q,!0),i()),e&2){const n=r();d(),k(n.rows())}}function Pn(e,t){if(e&1&&(s(0,"div",9),I(1,"fold-spinner",27),i()),e&2){const n=r();d(),p("label",n.l().loading)}}function yn(e,t){if(e&1&&(s(0,"div",29),M(1),i()),e&2){const n=r();d(),D(n.subtitle)}}function kn(e,t){if(e&1&&(s(0,"div",10)(1,"div",28),M(2),i(),u(3,yn,2,1,"div",29),i()),e&2){const n=t;d(2),D(n.title),d(),m(n.subtitle?3:-1)}}class v{columns=a.required();rows=a.required();rowKey=a();rowTone=a();sort=a(null);empty=a();loading=a(!1,{transform:b});caption=a();clickable=a(!1,{transform:b});zebra=a(!1,{transform:b});hover=a(!0,{transform:b});mobileLayout=a("scroll");density=a("comfortable");stickyFirst=a(!1,{transform:b});selectable=a(!1,{transform:b});selected=a(new Set);selectionLabel=a();labels=a();selectionChange=L();sortChange=L();rowClick=L();focusedKey=E(null);isNarrow=E(!1);destroyRef=P(Q);injectedLabels=P(an);l=_(()=>({...this.injectedLabels,...this.labels()}));constructor(){if(typeof window<"u"&&typeof window.matchMedia=="function"){const t=window.matchMedia("(max-width: 700px)");this.isNarrow.set(t.matches);const n=o=>{this.isNarrow.set(o.matches)};t.addEventListener("change",n),this.destroyRef.onDestroy(()=>{t.removeEventListener("change",n)})}U(()=>{})}cells=V(O);cellMap=_(()=>{const t=new Map;for(const n of this.cells())t.set(n.foldCell(),n.template);return t});rowCard=W(x);rowCardTemplate=_(()=>this.mobileLayout()==="custom"?this.rowCard()?.template??null:null);toolbarSurface=a("default");primaryKey=_(()=>this.columns()[0]?.key??"");colCount=_(()=>this.columns().length+(this.selectable()?1:0));rowKeys=_(()=>this.rows().map((t,n)=>this.keyOf(t,n)));activeRowKey=_(()=>{const t=this.focusedKey(),n=this.rowKeys();return t!==null&&n.includes(t)?t:n[0]??null});cellTemplate(t){return this.cellMap().get(t)??null}keyOf(t,n){return this.rowKey()?.(t,n)??n}toneOf(t){return this.rowTone()?.(t)??null}isSorted(t){return this.sort()?.key===t}sortIcon(t){const n=this.sort();return n?.key!==t?"expand-all":n.dir==="asc"?"chevron-up":"chevron-down"}ariaSort(t){const n=this.sort();return n?.key!==t?"none":n.dir==="asc"?"ascending":"descending"}onRowActivate(t){this.clickable()&&this.rowClick.emit(t)}isRowSelected(t,n){return this.selected().has(this.keyOf(t,n))}allSelected=_(()=>this.rows().length>0&&this.rows().every((t,n)=>this.selected().has(this.keyOf(t,n))));someSelected=_(()=>!this.allSelected()&&this.rows().some((t,n)=>this.selected().has(this.keyOf(t,n))));toggleRow(t,n){const o=new Set(this.selected()),l=this.keyOf(t,n);o.has(l)?o.delete(l):o.add(l),this.selectionChange.emit(o)}toggleAll(){const t=new Set(this.selected()),n=!this.allSelected();this.rows().forEach((o,l)=>{const c=this.keyOf(o,l);n?t.add(c):t.delete(c)}),this.selectionChange.emit(t)}labelFor(t){return this.selectionLabel()?.(t)??this.l().selectRow}rowTabIndex(t,n){if(!this.clickable())return null;const o=this.activeRowKey();return o!==null&&this.keyOf(t,n)===o?0:-1}onRowFocus(t,n){this.focusedKey.set(this.keyOf(t,n))}onRowKeydown(t,n){if(t.target===t.currentTarget)switch(t.key){case"Enter":this.onRowActivate(n);break;case" ":this.onRowActivate(n),t.preventDefault();break;case"ArrowDown":z(t.currentTarget,"nextElementSibling"),t.preventDefault();break;case"ArrowUp":z(t.currentTarget,"previousElementSibling"),t.preventDefault();break;case"Home":j(t.currentTarget,"firstElementChild"),t.preventDefault();break;case"End":j(t.currentTarget,"lastElementChild"),t.preventDefault();break}}static ɵfac=function(n){return new(n||v)};static ɵcmp=X({type:v,selectors:[["fold-data-table"]],contentQueries:function(n,o,l){n&1&&tn(l,o.cells,O,4)(l,o.rowCard,x,5),n&2&&on(2)},inputs:{columns:[1,"columns"],rows:[1,"rows"],rowKey:[1,"rowKey"],rowTone:[1,"rowTone"],sort:[1,"sort"],empty:[1,"empty"],loading:[1,"loading"],caption:[1,"caption"],clickable:[1,"clickable"],zebra:[1,"zebra"],hover:[1,"hover"],mobileLayout:[1,"mobileLayout"],density:[1,"density"],stickyFirst:[1,"stickyFirst"],selectable:[1,"selectable"],selected:[1,"selected"],selectionLabel:[1,"selectionLabel"],labels:[1,"labels"],toolbarSurface:[1,"toolbarSurface"]},outputs:{selectionChange:"selectionChange",sortChange:"sortChange",rowClick:"rowClick"},ngContentSelectors:fn,decls:17,vars:26,consts:[[1,"folddt-wrap"],[1,"folddt-toolbar"],[1,"folddt-scroll"],[1,"folddt"],[1,"folddt-caption"],["scope","col",1,"folddt-select-h"],["scope","col",3,"is-primary-h","width"],[1,"folddt-row",3,"tone-warning","tone-alert","tone-success","clickable","is-selected"],["role","list",1,"folddt-cardlist"],[1,"folddt-loading"],[1,"folddt-empty"],["size","sm",3,"checkedChange","ariaLabel","checked","indeterminate"],["scope","col"],["type","button",1,"folddt-th-sort",3,"right","center"],[1,"folddt-th-plain",3,"right","center"],["type","button",1,"folddt-th-sort",3,"click"],[1,"folddt-arrow",3,"name","size"],[1,"folddt-th-plain"],[1,"folddt-row",3,"click","focus","keydown"],[1,"folddt-cell","folddt-cell--select"],["size","sm",3,"click","checkedChange","ariaLabel","checked"],["scope","row",1,"folddt-cell","is-primary",3,"right","center","truncate","ngClass"],[1,"folddt-cell",3,"right","center","truncate","ngClass"],["scope","row",1,"folddt-cell","is-primary",3,"ngClass"],[3,"ngTemplateOutlet","ngTemplateOutletContext"],[1,"folddt-cell",3,"ngClass"],["role","listitem",1,"folddt-cardlist-item"],[3,"label"],[1,"folddt-empty-t"],[1,"folddt-empty-s"]],template:function(n,o){if(n&1&&(J(sn),s(0,"div",0)(1,"div",1),nn(2),i(),s(3,"div",2)(4,"table",3),u(5,_n,2,1,"caption",4),s(6,"thead")(7,"tr"),u(8,gn,2,3,"th",5),y(9,mn,3,6,"th",6,N),i()(),s(11,"tbody"),y(12,On,4,13,"tr",7,q,!0),i()()(),u(14,Mn,3,0,"div",8),u(15,Pn,2,1,"div",9)(16,kn,4,2,"div",10),i()),n&2){let l,c,f;g("folddt--zebra",o.zebra())("folddt--hover",o.hover())("folddt--cards",o.mobileLayout()==="auto-cards")("folddt--custom",o.mobileLayout()==="custom")("folddt--compact",o.density()==="compact")("folddt--sticky-first",o.stickyFirst())("folddt--select",o.selectable()),d(),g("folddt-toolbar--sunken",o.toolbarSurface()==="sunken")("folddt-toolbar--raised",o.toolbarSurface()==="raised")("folddt-toolbar--accent",o.toolbarSurface()==="accent"),C("data-surface",o.toolbarSurface()==="accent"?"accent":null),d(3),C("aria-colcount",o.colCount()),d(),m((l=o.caption())?5:-1,l),d(3),m(o.selectable()?8:-1),d(),k(o.columns()),d(3),k(o.rows()),d(2),m((c=o.isNarrow()&&o.rowCardTemplate())?14:-1,c),d(),m(o.loading()?15:(f=o.rows().length===0&&o.empty())?16:-1,f)}},dependencies:[Y,Z,G,rn,cn],styles:[`@charset "UTF-8";
...
}`]})}const Dn=Object.freeze(Object.defineProperty({__proto__:null,FoldDataTableComponent:v},Symbol.toStringTag,{value:"Module"}));export{v as F,O as a,x as b,Dn as d};

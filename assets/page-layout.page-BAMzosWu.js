import{s as d,y as v,ɵ as P,R as k,c as C,S as x,b as T,a as B,d as t,g as _,e,f as n,C as p,I as u,h as A,j as a,m as h,v as L,D as c,J as g,n as F,A as b,l as w,B as I,q as y,E as z,H as D,r as M}from"./index-C-AW9i1K.js";import{D as R}from"./playground.component-Bg6g2QlT.js";import{K as S}from"./kind-badge.component-0JAYSc5K.js";import{C as j}from"./composed-of.component-xmzjE3-q.js";import{FoldPageSectionComponent as E}from"./page-section.component-BtI8kLxo.js";import{F as W}from"./avatar.component-DRl1rY1s.js";import{FoldButtonComponent as N}from"./button.component-DK5QjPM_.js";import{FoldCalloutComponent as V}from"./callout.component-7WvlJ6Y4.js";import{FoldSliderComponent as H}from"./slider.component-DFitqe-2.js";import"./element-title.component-C1dhOIwk.js";import"./spinner.component-B8KHXxmh.js";import"./tokens.catalog-DF_6rd51.js";import"./input-value-Co_u-z_8.js";const K=()=>["icons"];function O(l,i){if(l&1){const s=I();t(0,"button",12),p("click",function(){z(s);const r=y();return D(r.showIcon.set(!r.showIcon()))}),e(1," icon "),n()}if(l&2){const s=y();c("is-on",s.showIcon())}}function Y(l,i){l&1&&(t(0,"span",21),_(1,"fold-avatar",30),t(2,"span",31),e(3,"Acme Records "),t(4,"span",32),e(5,"· Workspace"),n()()())}function q(l,i){l&1&&_(0,"fold-badge",22)}function G(l,i){l&1&&(t(0,"p",3),e(1,"Your company subscription and payment methods."),n())}function J(l,i){l&1&&(t(0,"button",23),e(1,"Export"),n())}function U(l,i){l&1&&(t(0,"fold-page-section",26)(1,"fold-card",33)(2,"p",25),e(3," Bleed band — spans the layout edge-to-edge. It cancels "),t(4,"code"),e(5,"--fold-page-gutter"),n(),e(6," exactly (the same token the page pads with), so it stays flush against the dashed guides as you drag the slider. "),n()()())}class m{headerMode=d("title");showIcon=d(!0);showBadge=d(!1);showDesc=d(!0);showActions=d(!0);showBleed=d(!0);gutter=d(32);code=v(()=>{const i=[];if(this.headerMode()==="custom")i.push("<fold-page-layout>",'  <span pageTitle><fold-avatar name="Acme Records" size="sm" /> Acme Records</span>');else{const s=this.showIcon()?' icon="grid"':"";i.push(`<fold-page-layout${s} title="Billing">`)}return this.showBadge()&&i.push('  <fold-badge titleBadge content="Pro" variant="accent" />'),this.showDesc()&&i.push("  <p description>Your company subscription and payments.</p>"),this.showActions()&&i.push("  <button pageActions>Export</button>"),i.push('  <fold-page-section title="Payment methods">…</fold-page-section>'),this.showBleed()&&i.push("  <fold-page-section bleed>… edge-to-edge band …</fold-page-section>"),i.push('  <fold-page-section title="Invoices">…</fold-page-section>',"</fold-page-layout>"),i.join(`

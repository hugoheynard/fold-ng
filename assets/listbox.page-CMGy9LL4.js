import{x as R,y as w,ɵ as V,M as m,i as _,e,O as v,D as S,j as l,o as g,k as u,I as B,J as N,A,al as I,q as b,s as f,aA as W,c as j,B as L,d as t,f as o,g as x,W as U,C as $,aC as k,h as P,Q as M,m as d,v as K,n as O,u as E,l as D,E as h,H as y,Z as J,r as T}from"./index-C3MwVWJJ.js";import{K as q}from"./kind-badge.component-DIQZXI7M.js";import{C as G}from"./composed-of.component-JYuapm0F.js";import{D as X}from"./playground.component-CcDJ0VuE.js";import{FoldPageSectionComponent as Y}from"./page-section.component-DPPmDHKY.js";import{FoldTabsComponent as H}from"./tabs.component-Gpc5iznc.js";import{FoldTabPanelComponent as Q}from"./tab-panel.component-BnN_x26b.js";import{FoldListboxComponent as Z}from"./listbox.component-saLs2p1a.js";import{FoldMultiselectComponent as ee}from"./multiselect.component-Ho4vEdeU.js";import{F as oe}from"./option.component-Bs7TL91e.js";import{FoldSelectComponent as te}from"./select.component-_9rEYbKa.js";import"./button.component-AED5PJTt.js";import"./spinner.component-CqSQudUU.js";import"./tokens.catalog-DF_6rd51.js";import"./element-title.component-Can7x_G8.js";import"./slider.component-Bak-fowa.js";import"./input-value-Co_u-z_8.js";import"./nav-layout.context-jBSlgYTS.js";import"./popover.component-BQOV6tU7.js";import"./popover-trigger.directive-B5f7tn-g.js";import"./input-base.component-h-v4pXpQ.js";import"./label.component-qYN18y2X.js";import"./listbox-nav-BYjZLSm5.js";const ne=(s,i)=>i.box;function ae(s,i){if(s&1&&(m(0,"div",2),I(1,"span",8),m(2,"span",9),e(3),v(),m(4,"span",10),e(5,"↓"),v()()),s&2){const a=b().$implicit;l(3),u(a.flow)}}function le(s,i){if(s&1&&(B(0,ae,6,1,"div",2),m(1,"div",3)(2,"span",4),e(3),v(),m(4,"div",5)(5,"code",6),e(6),v(),m(7,"span",7),e(8),v()()()),s&2){const a=i.$implicit,n=i.$index,c=i.$index;N(c!==0?0:-1),l(),A("--i",n),l(2),u(n+1),l(3),u(a.box),l(2),u(a.note)}}const se=s=>({kind:"popover",layers:[{box:"<button> trigger",note:s?'aria-haspopup="listbox" · aria-expanded · summarises the picks':'aria-haspopup="listbox" · aria-expanded · shows the selected label',flow:""},{box:"fold-popover — native top layer",note:"escapes overflow + z-index · flip → size → shift · publishes --fold-popover-anchor-width",flow:"click / ↓ opens"},{box:s?'role="listbox" + aria-multiselectable — holds focus':'role="listbox" — holds focus',note:"aria-activedescendant → the active option's id (focus never leaves)",flow:"renders the panel"},{box:"fold-option × N",note:"each derives its own selected / active from the owner (a computed reading the FOLD_LISTBOX_OWNER token — nothing pushed in during change detection)",flow:"projects rows"}],footer:s?"↑/↓ move active · Enter/Space toggles membership · panel stays open · value = readonly string[]":"↑/↓ move active · Enter commits + closes · returns focus to the trigger · value = string"}),ie={kind:"native",layers:[{box:"fold-select",note:"a thin wrapper — styled box + custom caret over the real control",flow:""},{box:"native <select>",note:"[value] / (change) · Signal Forms · the browser owns keyboard + focus",flow:"wraps"},{box:"OS popup (browser / operating system)",note:"NOT in your DOM · not styleable · a native mobile wheel for free",flow:"opens"},{box:"<option> × N",note:"real projected option elements — plain text only",flow:"lists"}],footer:"styleable panel / custom rows?  ✗    ·    accessible + mobile-native out of the box?  ✓"};class C{kind=R.required();schema=w(()=>{const i=this.kind();return i==="select"?ie:se(i==="multi")});static ɵfac=function(a){return new(a||C)};static ɵcmp=V({type:C,selectors:[["gal-select-schema"]],inputs:{kind:[1,"kind"]},decls:5,vars:3,consts:[[1,"sc"],[1,"sc-footer"],["aria-hidden","true",1,"sc-flow"],[1,"sc-layer"],[1,"sc-num"],[1,"sc-body"],[1,"sc-box"],[1,"sc-note"],[1,"sc-flow-line"],[1,"sc-flow-label"],[1,"sc-flow-arrow"]],template:function(a,n){a&1&&(m(0,"div",0),_(1,le,9,6,null,null,ne),m(3,"p",1),e(4),v()()),a&2&&(S("sc-native",n.schema().kind==="native"),l(),g(n.schema().layers),l(3),u(n.schema().footer))},styles:[`[_nghost-%COMP%] {
  display: block;
}

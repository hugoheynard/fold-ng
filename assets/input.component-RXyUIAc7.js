import{ag as c,u as n,X as i,a2 as v,ah as m,A as a,s as C,ɵ as O,F as M,d as b,B as f,f as s,w as P,m as r,j as d,L as y,D as g,x as w,ai as I,E as L,g as k,q as _,N as F,O as z}from"./index-_ZvulUZ_.js";import{FoldInputBaseComponent as q}from"./input-base.component-DH1ffJG_.js";import{r as x}from"./input-value-Co_u-z_8.js";import"./label.component-WLyNOFjj.js";function B(p,o){if(p&1){const t=L();b(0,"button",4),f("click",function(){F(t);const l=_();return z(l.toggleReveal())}),k(1,"fold-icon",5),s()}if(p&2){const t=_();r("disabled",t.disabled()||t.readOnly()),g("aria-label",t.revealAria())("aria-pressed",t.revealed()),d(),r("name",t.revealed()?"eye-off":"eye")}}class u{value=c("");disabled=n(!1);touched=c(!1);errors=n([]);type=n("text");revealable=n(!1,{transform:i});revealLabel=n("Show password");hideLabel=n("Hide password");size=n("md");align=n("start");variant=n("default");label=n();required=n(!1,{transform:i});optional=n(!1,{transform:i});optionalLabel=n("optional");hint=n();placeholder=n("");readOnly=n(!1);autofocus=n(!1);autocomplete=n(null);inputId=v(m).next("fold-input");errorMessage=a(()=>{if(!this.touched())return;const o=this.errors()[0];return o?o.message??o.kind:void 0});describedBy=a(()=>this.errorMessage()?`${this.inputId}-error`:this.hint()?`${this.inputId}-hint`:null);revealed=C(!1);showReveal=a(()=>this.revealable()&&this.type()==="password");effectiveType=a(()=>this.showReveal()&&this.revealed()?"text":this.type());revealAria=a(()=>this.revealed()?this.hideLabel():this.revealLabel());toggleReveal(){this.revealed.update(o=>!o)}onInputChange(o){this.value.set(x(o))}onBlur(){this.touched.set(!0)}static ɵfac=function(t){return new(t||u)};static ɵcmp=O({type:u,selectors:[["fold-input"]],hostVars:2,hostBindings:function(t,e){t&2&&I(e.size()+" "+e.align()+" "+e.variant())},inputs:{value:[1,"value"],disabled:[1,"disabled"],touched:[1,"touched"],errors:[1,"errors"],type:[1,"type"],revealable:[1,"revealable"],revealLabel:[1,"revealLabel"],hideLabel:[1,"hideLabel"],size:[1,"size"],align:[1,"align"],variant:[1,"variant"],label:[1,"label"],required:[1,"required"],optional:[1,"optional"],optionalLabel:[1,"optionalLabel"],hint:[1,"hint"],placeholder:[1,"placeholder"],readOnly:[1,"readOnly"],autofocus:[1,"autofocus"],autocomplete:[1,"autocomplete"]},outputs:{value:"valueChange",touched:"touchedChange"},decls:4,vars:20,consts:[[3,"label","for","required","optional","optionalLabel","hint","error"],[1,"in-field"],[3,"input","blur","id","value"],["type","button",1,"in-reveal",3,"disabled"],["type","button",1,"in-reveal",3,"click","disabled"],["size","sm","aria-hidden","true",3,"name"]],template:function(t,e){t&1&&(b(0,"fold-input-base",0)(1,"div",1)(2,"input",2),f("input",function(h){return e.onInputChange(h)})("blur",function(){return e.onBlur()}),s(),P(3,B,2,4,"button",3),s()()),t&2&&(r("label",e.label())("for",e.inputId)("required",e.required())("optional",e.optional())("optionalLabel",e.optionalLabel())("hint",e.hint())("error",e.errorMessage()),d(2),y("has-reveal",e.showReveal()),r("id",e.inputId)("value",e.value()),g("type",e.effectiveType())("placeholder",e.placeholder())("readonly",e.readOnly()||null)("disabled",e.disabled()||null)("required",e.required()||null)("aria-invalid",e.errorMessage()?!0:null)("aria-describedby",e.describedBy())("autocomplete",e.autocomplete()),d(),w(e.showReveal()?3:-1))},dependencies:[q,M],styles:[`

 ...
 * Pages deploys override it via `PAGES_BASE` — `main` builds under `/fold-ng/`
 * (the demo), the `dev` preview under `/fold-ng/dev/`. Hash-routing means the
 * routes need no server rewrite; only the asset prefix has to match.
 */

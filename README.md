...
| `FoldPageLayoutComponent` / `…Section`                   | `fold-page-layout`   | Settings/admin page scaffold (title + sections).                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `FoldHeroComponent`                                      | `fold-hero`          | Prominent header card (tone ladder + optional accent bar).                                                                                                                                                                                                                                                                                                                                                                                         |
...
| `FoldIconComponent`                                      | `fold-icon`          | SVG icon (102-icon built-in set + `FoldIconRegistry`).                                                                                                                                                                                                                                                                                                                                                                                             |
...
`fold-icon` ships a **built-in set of ~100 single-colour SVGs** (102 today, across

...
| `Sh3InputComponent`                                     | `sh3-input`         | Text-input control — Signal Forms (`[formField]`) or standalone `[(value)]`; size × align × variant, optional label. The _edit_ half of a record (`sh3-field` reads). |

...
| `FoldPopoverComponent`                                   | `fold-popover`                         | Anchored floating layer — projected content in the native top layer (escapes `overflow`/`z-index`), positioned against a `[foldPopoverTrigger]` by a dependency-free flip/shift engine (`computePlacement`). `[(open)]`; built-in outside-click + `Escape` dismissal, focus-return, and auto-wired `aria-haspopup`/`expanded`/`controls`.                                                                                                                                                                                                                                                                                                                                                                                                                   |

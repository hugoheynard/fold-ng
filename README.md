...
| `FoldViewNavComponent`                                   | `fold-view-nav`                        | Navigation bar styled as tabs — a `<nav>` of buttons that switch views, `aria-current="page"` on the active one (horizontal / vertical sidebar). For in-page panel switching use `fold-tabs` instead.                                                                                                                                                                                                                                              |
